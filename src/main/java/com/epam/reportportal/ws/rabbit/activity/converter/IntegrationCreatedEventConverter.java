...
import com.epam.reportportal.ws.rabbit.activity.util.IntegrationActivityPriorityResolver;
...
/**
 * Converter for IntegrationCreatedEvent to Activity.
 */
@Component
public class IntegrationCreatedEventConverter implements
    EventToActivityConverter<IntegrationCreatedEvent> {
  ...
  public Activity convert(IntegrationCreatedEvent event) {
    return new ActivityBuilder()
        ...
        .addHistoryField(Optional.of(
            HistoryField.of(NAME, null, event.getIntegrationActivityResource().getName())))
        .get();
  }

  @Override
  public Class<IntegrationCreatedEvent> getEventClass() {
    return IntegrationCreatedEvent.class;
  }
}
