...
import static com.epam.reportportal.base.auth.permissions.Permissions.INVITATION_ALLOWED;
...
import com.epam.reportportal.base.core.user.impl.UserInvitationHandler;
...
/**
 * Controller for managing user invitations. This controller handles the creation, retrieval, and activation of user
 * invitations. It provides endpoints for sending invitations to users and activating them.
 *
