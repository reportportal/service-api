 ...
 */
@Component
public class ProjectRenamedEventConverter implements EventToActivityConverter<ProjectRenamedEvent> {

  @Override
  public Activity convert(ProjectRenamedEvent event) {
  ...
  @Override
  public Class<ProjectRenamedEvent> getEventClass() {
    return ProjectRenamedEvent.class;
  }
}
