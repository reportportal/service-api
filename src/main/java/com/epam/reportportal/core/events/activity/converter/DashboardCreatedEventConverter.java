...
/**
 * Converter for DashboardCreatedEvent to Activity.
 */
@Component
public class DashboardCreatedEventConverter implements
    EventToActivityConverter<DashboardCreatedEvent> {
  ...
  public Activity convert(DashboardCreatedEvent event) {
    return new ActivityBuilder()
        ...
        .addObjectId(event.getDashboardActivityResource().getId())
        .addObjectName(event.getDashboardActivityResource().getName())
        .addObjectType(EventObject.DASHBOARD)
        .addProjectId(event.getDashboardActivityResource().getProjectId())
  ...
  @Override
  public Class<DashboardCreatedEvent> getEventClass() {
    return DashboardCreatedEvent.class;
  }
}
