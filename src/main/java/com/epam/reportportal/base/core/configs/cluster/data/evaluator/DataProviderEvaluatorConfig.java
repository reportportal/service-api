...
package com.epam.reportportal.base.core.configs.cluster.data.evaluator;

import com.epam.reportportal.base.core.launch.cluster.config.GenerateClustersConfig;
import com.epam.reportportal.base.core.launch.cluster.pipeline.data.AnalyzerItemClusterDataProvider;
import com.epam.reportportal.base.core.launch.cluster.pipeline.data.AnalyzerLaunchClusterDataProvider;
import com.epam.reportportal.base.core.launch.cluster.pipeline.data.resolver.evaluator.ClusterDataProviderEvaluator;
...
/**
 * Binds cluster data provider evaluators for the resolver.
 *
