...
package com.epam.reportportal.exception.rest;

import com.epam.reportportal.exception.message.ExceptionMessageBuilder;
...
public class RestErrorDefinition<T extends Exception> {
  ...
  @Getter
  private final com.epam.reportportal.infrastructure.rules.exception.ErrorType error;
   ...
   * @param exceptionMessageBuilder Builder for constructing error messages from exceptions
   */
  public RestErrorDefinition(int httpStatus, com.epam.reportportal.infrastructure.rules.exception.ErrorType error,
      ExceptionMessageBuilder<T> exceptionMessageBuilder) {
