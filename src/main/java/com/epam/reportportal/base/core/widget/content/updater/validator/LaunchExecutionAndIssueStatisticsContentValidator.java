...
import static com.epam.reportportal.base.core.widget.util.ContentFieldPatternConstants.COMBINED_CONTENT_FIELDS_REGEX;
import static com.epam.reportportal.base.infrastructure.persistence.commons.Predicates.equalTo;

import com.epam.reportportal.base.core.widget.util.ContentFieldMatcherUtil;
...
/**
 * Validates content fields and filter mappings for the Launch Execution and Issue Statistics widget.
 *
...
public class LaunchExecutionAndIssueStatisticsContentValidator implements WidgetValidatorStrategy {
   ...
   *
   * @param filterSortMapping Map of ${@link Filter} for query building as key and ${@link Sort} as value for each
   *                          filter
   */
  ...
  /**
   * Validate provided content fields. The value of content field should not be empty All content fields should match
   * the pattern
   * {@link com.epam.reportportal.base.core.widget.util.ContentFieldPatternConstants#COMBINED_CONTENT_FIELDS_REGEX}
   *
