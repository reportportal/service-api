...
/**
 * Converter for NotificationRuleDeletedEvent to Activity.
 */
@Component
public class NotificationRuleDeletedEventConverter implements
    EventToActivityConverter<NotificationRuleDeletedEvent> {
  ...
  @Override
  public Class<NotificationRuleDeletedEvent> getEventClass() {
    return NotificationRuleDeletedEvent.class;
  }
}
