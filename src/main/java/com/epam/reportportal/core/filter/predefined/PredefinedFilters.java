...
package com.epam.reportportal.core.filter.predefined;

import static com.epam.reportportal.core.filter.predefined.PredefinedFilterType.ACTIVITIES;
import static com.epam.reportportal.core.filter.predefined.PredefinedFilterType.COLLAPSED;
import static com.epam.reportportal.core.filter.predefined.PredefinedFilterType.PROJECTS;
import static com.epam.reportportal.core.filter.predefined.PredefinedFilterType.USERS;
      ...
      .put(COLLAPSED, new PredefinedFilterBuilder() {
        ...
        public Queryable build(String[] params) {
          return Filter.builder()
              ...
              .withCondition(new FilterCondition(Operator.OR, Condition.EQUALS, false,
                  StatusEnum.FAILED.name(), CRITERIA_STATUS))
              .withCondition(new FilterCondition(Operator.OR, Condition.IN, true,
                  HAS_METHOD_OR_CLASS.stream().map(Enum::name).collect(Collectors.joining(",")),
                  CRITERIA_TYPE))
              .withCondition(new FilterCondition(Operator.OR, Condition.EXISTS, false, "true",
                  CRITERIA_ISSUE_TYPE))
              .build();
        }
      })
