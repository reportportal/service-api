...
public class JUsersRecord extends UpdatableRecordImpl<JUsersRecord> {
   ...
   */
  public JUsersRecord(Long id, String login, String password, String email, String attachment,
      String attachmentThumbnail, String role, String type, Boolean expired, String fullName, JSONB metadata, UUID uuid,
      String externalId, Boolean active, String loginBackup, Instant createdAt, Instant updatedAt) {
    super(JUsers.USERS);
