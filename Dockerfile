...
LABEL version="4.0.0-BETA-4"
LABEL description="EPAM Report portal. Main API Service"

ENV APP_FILE service-api-4.0.0-BETA-4
ENV APP_DOWNLOAD_URL https://dl.bintray.com/epam/reportportal/com/epam/reportportal/service-api/4.0.0-BETA-4/$APP_FILE.jar
