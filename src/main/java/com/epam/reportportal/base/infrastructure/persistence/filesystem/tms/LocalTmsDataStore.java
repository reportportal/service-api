...
import com.epam.reportportal.base.infrastructure.persistence.filesystem.distributed.s3.StoredFile;
...
/**
 * Local file-system implementation of the TMS data store.
 *
...
public class LocalTmsDataStore implements TmsDataStore {
  ...
  public LocalTmsDataStore(BlobStore blobStore, FeatureFlagHandler featureFlagHandler,
