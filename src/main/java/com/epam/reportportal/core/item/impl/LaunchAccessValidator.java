...
public interface LaunchAccessValidator {
  ...
  /**
   * @param launch            {@link com.epam.reportportal.infrastructure.persistence.entity.launch.Launch}
  ...
  /**
   * @param launchId          {@link com.epam.reportportal.infrastructure.persistence.entity.launch.Launch#getId()}
   * @param membershipDetails {@link MembershipDetails}
   * @param user              {@link ReportPortalUser}
   */
