...
/**
 * Event published when a launch's importance status changes (marked/unmarked as important).
 *
...
@Getter
@NoArgsConstructor
public class LaunchImportanceChangedEvent extends AbstractEvent<Void> {
