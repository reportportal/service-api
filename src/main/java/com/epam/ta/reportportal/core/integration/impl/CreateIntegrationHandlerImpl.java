...
public class CreateIntegrationHandlerImpl implements CreateIntegrationHandler {
	...
	@Override
	public EntryCreatedRS createProjectIntegration(String projectKey, IntegrationRQ createRequest, String pluginName,
	...
	@Override
	public OperationCompletionRS updateProjectIntegration(Long id, String projectKey, IntegrationRQ updateRequest, ReportPortalUser user) {
