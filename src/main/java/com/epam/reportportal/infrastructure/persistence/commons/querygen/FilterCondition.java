...
import static com.epam.reportportal.infrastructure.persistence.commons.querygen.QueryBuilder.HAVING_CONDITION;
...
public class FilterCondition implements ConvertibleCondition, Serializable {
  ...
  public Map<ConditionType, org.jooq.Condition> toCondition(FilterTarget filterTarget) {
    ...
    BusinessRule.expect(criteriaHolder,
            com.epam.reportportal.infrastructure.persistence.commons.Preconditions.IS_PRESENT)
