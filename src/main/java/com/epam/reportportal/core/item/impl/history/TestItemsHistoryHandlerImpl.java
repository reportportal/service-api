...
package com.epam.reportportal.core.item.impl.history;

import static com.epam.reportportal.infrastructure.model.ValidationConstraints.MAX_HISTORY_DEPTH_BOUND;
import static com.epam.reportportal.infrastructure.model.ValidationConstraints.MIN_HISTORY_DEPTH_BOUND;
...
import static com.epam.reportportal.infrastructure.rules.exception.ErrorType.UNABLE_LOAD_TEST_ITEM_HISTORY;
...
import com.epam.reportportal.core.item.impl.history.provider.HistoryProviderFactory;
...
public class TestItemsHistoryHandlerImpl implements TestItemsHistoryHandler {
  ...
  @Override
  public com.epam.reportportal.model.Page<TestItemHistoryElement> getItemsHistory(
  ...
  private com.epam.reportportal.model.Page<TestItemHistoryElement> buildHistoryElements(
