...
package com.epam.reportportal.core.configs.security.converters;

import com.epam.reportportal.core.configs.security.JwtIssuer;
...
/**
 * Converter for external JWT tokens that retrieves user details and authorities based on a specific claim (e.g., "sub"
 * or "externalId") from the JWT. This class extends {@link AbstractJwtConverter} to provide custom conversion logic.
 *
