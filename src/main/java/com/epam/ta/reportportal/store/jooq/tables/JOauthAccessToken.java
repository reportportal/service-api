...
public class JOauthAccessToken extends TableImpl<JOauthAccessTokenRecord> {
     ...
     */
    public final TableField<JOauthAccessTokenRecord, JAccessTokenTypeEnum> TOKEN_TYPE = createField("token_type", org.jooq.util.postgres.PostgresDataType.VARCHAR.asEnumDataType(com.epam.ta.reportportal.store.jooq.enums.JAccessTokenTypeEnum.class), this, "");
