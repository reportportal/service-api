...
public class JStatisticsField extends TableImpl<JStatisticsFieldRecord> {
   ...
   */
  public final TableField<JStatisticsFieldRecord, Long> SF_ID = createField(DSL.name("sf_id"),
      SQLDataType.BIGINT.nullable(false).identity(true), this, "");

  /**
   * The column <code>public.statistics_field.name</code>.
   */
  public final TableField<JStatisticsFieldRecord, String> NAME = createField(DSL.name("name"),
  ...
  public <O extends Record> JStatisticsField(Table<O> path, ForeignKey<O, JStatisticsFieldRecord> childPath,
      InverseForeignKey<O, JStatisticsFieldRecord> parentPath) {
  ...
  public static class JStatisticsFieldPath extends JStatisticsField implements Path<JStatisticsFieldRecord> {
    ...
    public <O extends Record> JStatisticsFieldPath(Table<O> path, ForeignKey<O, JStatisticsFieldRecord> childPath,
        InverseForeignKey<O, JStatisticsFieldRecord> parentPath) {
  ...
  public JStatisticsPath statistics() {
    if (_statistics == null) {
      _statistics = new JStatisticsPath(this, null,
          Keys.STATISTICS__STATISTICS_STATISTICS_FIELD_ID_FKEY.getInverseKey());
    }
