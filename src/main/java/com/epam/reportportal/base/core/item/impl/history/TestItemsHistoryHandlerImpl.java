...
import static com.epam.reportportal.base.infrastructure.model.ValidationConstraints.MAX_HISTORY_DEPTH_BOUND;
import static com.epam.reportportal.base.infrastructure.model.ValidationConstraints.MIN_HISTORY_DEPTH_BOUND;
...
import static com.epam.reportportal.base.infrastructure.rules.exception.ErrorType.UNABLE_LOAD_TEST_ITEM_HISTORY;
...
import com.epam.reportportal.base.core.item.impl.history.provider.HistoryProviderFactory;
...
public class TestItemsHistoryHandlerImpl implements TestItemsHistoryHandler {
  ...
  @Override
  public com.epam.reportportal.base.model.Page<TestItemHistoryElement> getItemsHistory(
  ...
  private com.epam.reportportal.base.model.Page<TestItemHistoryElement> buildHistoryElements(
