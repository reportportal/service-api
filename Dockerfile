...
LABEL version="5.0.0-BETA-3"
LABEL description="EPAM Report portal. Main API Service"

ENV APP_FILE service-api-5.0.0-BETA-3
ENV APP_DOWNLOAD_URL https://dl.bintray.com/epam/reportportal/com/epam/reportportal/service-api/5.0.0-BETA-3/$APP_FILE.jar
