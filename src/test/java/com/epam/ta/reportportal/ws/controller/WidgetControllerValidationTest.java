...
class WidgetControllerValidationTest extends BaseMvcTest {
  ...
  public void createWidgetShouldReturnErrorWhenNameIsLessThanThreeCharacters() throws Exception {
    ...
    assertEquals(INCORRECT_REQUEST, error.getErrorType());
    assertEquals(
        INCORRECT_REQUEST_MESSAGE + "[" + FIELD_NAME_SIZE_MESSAGE + "] ", error.getMessage());
  }

  @Test
  public void createWidgetShouldReturnErrorWhenNameIsGreaterThanOneHundredAndTwentyEightCharacters()
      throws Exception {
    //GIVEN
    WidgetRQ widgetRQ = prepareWidget();
  ...
  @Test
  public void updateWidgetShouldReturnErrorWhenNameIsGreaterThanOneHundredAndTwentyEightCharacters()
      throws Exception {
    //GIVEN
    WidgetRQ widgetRQ = prepareWidget();
    widgetRQ.setName(LONG_NAME_VALUE);
