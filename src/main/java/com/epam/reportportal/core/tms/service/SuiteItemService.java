...
public class SuiteItemService {
  ...
  @Autowired
  public SuiteItemService(
      TestItemRepository testItemRepository,
      TmsTestFolderTestItemRepository testFolderTestItemRepository,
      TmsTestFolderService tmsTestFolderService,
      SuiteItemBuilder suiteItemBuilder) {
    this.testItemRepository = testItemRepository;
    this.testFolderTestItemRepository = testFolderTestItemRepository;
    this.tmsTestFolderService = tmsTestFolderService;
    this.suiteItemBuilder = suiteItemBuilder;
  }
   ...
   */
  @Transactional
  public TestItem findOrCreateSuiteItem(Long projectId, Long testFolderId, Launch launch) {
   ...
   */
  @Transactional
  public void markAsHavingChildren(TestItem suiteItem) {
    if (!suiteItem.isHasChildren()) {
      log.debug("Marking SUITE item: {} as having children", suiteItem.getItemId());
      suiteItem.setHasChildren(true);
      testItemRepository.save(suiteItem);
    }
  }
  ...
  public void removeFolderTestItemLink(Long testItemId) {
    ...
    testFolderTestItemRepository.deleteByTestItemId(testItemId);
