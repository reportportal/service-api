...
public class JTestItemRecord extends UpdatableRecordImpl<JTestItemRecord> implements Record8<Long, String, JTestItemTypeEnum, Timestamp, String, JParameterRecord[], Timestamp, String> {

    private static final long serialVersionUID = -1120532129;
     ...
     */
    @Override
    public JTestItemRecord values(Long value1, String value2, JTestItemTypeEnum value3, Timestamp value4, String value5, JParameterRecord[] value6, Timestamp value7, String value8) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public JTestItemRecord(Long itemId, String name, JTestItemTypeEnum type, Timestamp startTime, String description, JParameterRecord[] parameters, Timestamp lastModified, String uniqueId) {
        super(JTestItem.TEST_ITEM);
