...
import static com.epam.reportportal.ws.resolver.PagingHandlerMethodArgumentResolver.CUT_DEFAULT_OFFSET;
import static com.epam.reportportal.ws.resolver.PagingHandlerMethodArgumentResolver.CUT_DEFAULT_PAGE_SIZE;
...
import com.epam.reportportal.model.Page.PageMetadata;
...
public class TestCaseSearchHandler {
  ...
  public Page<TestItemResource> searchTestItems(String namePart, String attribute,
    ...
    return new com.epam.reportportal.model.Page<>(result.stream().map(item -> {
