...
/**
 * Converter interface for transforming domain events into Activity entities for audit trail persistence. Each domain
 * event type should have its own converter implementation.
 *
