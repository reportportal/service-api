...
/**
 * Validates JSON documents against a JSON schema. This class uses the NetworkNT JSON Schema library to perform
 * validation. The schema is loaded from the classpath using a prefix mapping.
 *
