...
insert into item_attribute (key, value, item_id, system)
values ('testKey', 'testValue', 2, false);
...
insert into item_attribute (key, value, item_id, system)
values ('testKey', 'testValue', 3, false);
...
insert into item_attribute (key, value, item_id, system)
values ('testKey', 'testValue', 4, false);
...
insert into item_attribute (key, value, item_id, system)
values ('testKey', 'testValue', 5, false);
