...
package com.epam.reportportal.model.dashboard;
...
public class DashboardResource extends OwnedResource {
  ...
  public static class WidgetObjectModel {
    ...
    private com.epam.reportportal.model.Size widgetSize = new com.epam.reportportal.model.Size();
    ...
    public WidgetObjectModel(String name, Long widgetId, com.epam.reportportal.model.Size widgetSize,
