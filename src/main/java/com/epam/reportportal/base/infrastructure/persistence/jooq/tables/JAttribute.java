...
public class JAttribute extends TableImpl<JAttributeRecord> {
  ...
  public <O extends Record> JAttribute(Table<O> path, ForeignKey<O, JAttributeRecord> childPath,
      InverseForeignKey<O, JAttributeRecord> parentPath) {
  ...
  public static class JAttributePath extends JAttribute implements Path<JAttributeRecord> {
    ...
    public <O extends Record> JAttributePath(Table<O> path, ForeignKey<O, JAttributeRecord> childPath,
        InverseForeignKey<O, JAttributeRecord> parentPath) {
  ...
  public JProjectAttributePath projectAttribute() {
    if (_projectAttribute == null) {
      _projectAttribute = new JProjectAttributePath(this, null,
          Keys.PROJECT_ATTRIBUTE__PROJECT_ATTRIBUTE_ATTRIBUTE_ID_FKEY.getInverseKey());
    }
