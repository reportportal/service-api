...
package com.epam.reportportal.auth.permissions;

import com.epam.reportportal.infrastructure.persistence.commons.ReportPortalUser;
import com.epam.reportportal.infrastructure.persistence.commons.ReportPortalUser.OrganizationDetails;
import com.epam.reportportal.infrastructure.persistence.commons.ReportPortalUser.OrganizationDetails.ProjectDetails;
...
/**
 * Base logic for project-related permissions. Validates project exists and there is provided in {@link Authentication}
...
abstract class BaseProjectPermission implements Permission {
  ...
  /**
   * Validates project exists and user assigned to project. After that delegates permission check to subclass
   */
  @Override
