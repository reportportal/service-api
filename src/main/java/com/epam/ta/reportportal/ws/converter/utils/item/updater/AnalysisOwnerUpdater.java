...
/**
 * Updates a {@link TestItemResource} by setting the analysis owner full name. The analysis owner is
 * the user who last performed analysis actions on the test item.
 *
 */
public class AnalysisOwnerUpdater implements ResourceUpdater<TestItemResource> {
  ...
  /**
   * Updates the {@code TestItemResource} by setting its {@code analysisOwner} property using the
   * predefined mapping.
   *
