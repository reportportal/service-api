...
import static com.epam.reportportal.core.widget.util.ContentFieldPatternConstants.EXECUTIONS_TOTAL_REGEX;
import static com.epam.reportportal.infrastructure.persistence.commons.Predicates.equalTo;

import com.epam.reportportal.core.widget.util.ContentFieldMatcherUtil;
...
public class CasesTrendContentValidator implements WidgetValidatorStrategy {
   ...
   * {@link com.epam.reportportal.core.widget.util.ContentFieldPatternConstants#EXECUTIONS_TOTAL_REGEX}
   *
