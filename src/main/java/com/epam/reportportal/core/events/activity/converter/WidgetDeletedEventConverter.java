...
/**
 * Converter for WidgetDeletedEvent to Activity.
 *
 */
@Component
public class WidgetDeletedEventConverter implements EventToActivityConverter<WidgetDeletedEvent> {
  ...
  @Override
  public Class<WidgetDeletedEvent> getEventClass() {
    return WidgetDeletedEvent.class;
  }
}
