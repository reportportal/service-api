...
public class ExcludedPathTokenExtractorTest {
  ...
  private final ExcludedPathTokenExtractor excludedPathsTokenExtractor = new ExcludedPathTokenExtractor(
      exludedPaths, delegate);
  private final ExcludedPathTokenExtractor excludedPathTokenExtractor = new ExcludedPathTokenExtractor(
      PUBLIC_PATH, delegate);
