...
import static com.epam.reportportal.ws.converter.converters.ItemAttributeConverter.FROM_RESOURCE;
...
public class LaunchBuilder implements Supplier<Launch> {
  ...
  public LaunchBuilder addAttribute(
      com.epam.reportportal.reporting.ItemAttributeResource attributeResource) {
