...
public final class ProjectConverter {
  ...
  public Function<Project, ProjectResource> TO_PROJECT_RESOURCE = project -> {
    ...
    Map<String, String> attributes = ProjectUtils.getConfigParameters(
    ...
    ofNullable(project.getSenderCases()).ifPresent(
        senderCases -> notificationConfig.setSenderCases(NotificationConfigConverter.TO_RESOURCE
            .apply(senderCases)));
