...
insert into test_item(item_id, name, type, start_time, description, unique_id, last_modified, path, parent_id, launch_id)
values (6, 'test item 1', 'STEP', now(), 'desc', 'uuid1', now(), '6', null, 2);
insert into test_item_results(result_id, status)
...
insert into test_item(item_id, name, type, start_time, description, unique_id, last_modified, path, parent_id, launch_id)
values (7, 'test item 2', 'STEP', now(), 'desc', 'uuid2', now(), '7', null, 2);
insert into test_item_results(result_id, status)
...
insert into test_item(item_id, name, type, start_time, description, unique_id, last_modified, path, parent_id, launch_id)
values (8, 'test item 3', 'STEP', now(), 'desc', 'uuid3', now(), '8', null, 2);
insert into test_item_results(result_id, status)
...
insert into test_item(item_id, name, type, start_time, description, unique_id, last_modified, path, parent_id, launch_id)
values (9, 'test item 4', 'STEP', now(), 'desc', 'uuid4', now(), '9', null, 2);
insert into test_item_results(result_id, status)
...
insert into test_item(item_id, name, type, start_time, description, unique_id, last_modified, path, parent_id, launch_id)
values (10, 'test item 5', 'STEP', now(), 'desc', 'uuid5', now(), '10', null, 2);
insert into test_item_results(result_id, status)
...
VALUES (2, 'passing rate summary', null, 'passingRateSummary', 10, '{"options": {}}'),
       (3, 'passing rate summary', null, 'passingRateSummary', 10, '{"options": {}}');
