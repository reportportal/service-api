...
package com.epam.reportportal.base.exception.rest;


import static com.epam.reportportal.base.exception.ExceptionMappings.MESSAGE_SOURCE;
import static com.epam.reportportal.base.infrastructure.rules.commons.validation.Suppliers.formattedMessage;
...
public class DefaultErrorResolver implements ErrorResolver {
   ...
   *
   * @see
   * com.epam.reportportal.base.ws.exception.ErrorResolver#resolveError(java
   * .lang.Exception)
   */
  @Override
