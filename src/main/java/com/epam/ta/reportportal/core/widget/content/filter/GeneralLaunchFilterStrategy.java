...
import static com.epam.ta.reportportal.commons.querygen.constant.LaunchCriteriaConstant.CRITERIA_STATUS;
...
public class GeneralLaunchFilterStrategy extends ProjectFilterStrategy {
	...
	protected Filter buildDefaultFilter(Widget widget, Long projectId) {
		...
		filter.withConditions(Sets.newHashSet(
				...
				new FilterCondition(Condition.EQUALS, false, Mode.DEFAULT.toString(), CRITERIA_MODE)
		));
		return filter;
	}
}
