...
public class JTestItemResults extends TableImpl<JTestItemResultsRecord> {
	...
	private static final long serialVersionUID = 1215879984;
	 ...
	 */
	public final TableField<JTestItemResultsRecord, Long> ID = createField(
			"id",
			org.jooq.impl.SQLDataType.BIGINT.nullable(false)
					.defaultValue(org.jooq.impl.DSL.field(
							"nextval('test_item_results_id_seq'::regclass)",
	 ...
	 */
	public final TableField<JTestItemResultsRecord, Long> ITEM_ID = createField("item_id", org.jooq.impl.SQLDataType.BIGINT, this, "");

	/**
	 * The column <code>public.test_item_results.status</code>.
	 */
	public final TableField<JTestItemResultsRecord, JStatusEnum> STATUS = createField(
			"status",
	 ...
	 */
	@Override
	public Identity<JTestItemResultsRecord, Long> getIdentity() {
	...
	public List<UniqueKey<JTestItemResultsRecord>> getKeys() {
		return Arrays.<UniqueKey<JTestItemResultsRecord>>asList(Keys.TEST_ITEM_RESULTS_PK, Keys.TEST_ITEM_RESULTS_ITEM_ID_KEY);
	}
