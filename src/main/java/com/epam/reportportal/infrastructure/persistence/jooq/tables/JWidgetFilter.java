...
public class JWidgetFilter extends TableImpl<JWidgetFilterRecord> {
   ...
   */
  public final TableField<JWidgetFilterRecord, Long> WIDGET_ID = createField(DSL.name("widget_id"),
      SQLDataType.BIGINT.nullable(false), this, "");

  /**
   * The column <code>public.widget_filter.filter_id</code>.
   */
  public final TableField<JWidgetFilterRecord, Long> FILTER_ID = createField(DSL.name("filter_id"),
      SQLDataType.BIGINT.nullable(false), this, "");
  ...
  public <O extends Record> JWidgetFilter(Table<O> path, ForeignKey<O, JWidgetFilterRecord> childPath,
      InverseForeignKey<O, JWidgetFilterRecord> parentPath) {
  ...
  public static class JWidgetFilterPath extends JWidgetFilter implements Path<JWidgetFilterRecord> {
    ...
    public <O extends Record> JWidgetFilterPath(Table<O> path, ForeignKey<O, JWidgetFilterRecord> childPath,
        InverseForeignKey<O, JWidgetFilterRecord> parentPath) {
  ...
  public List<ForeignKey<JWidgetFilterRecord, ?>> getReferences() {
    return Arrays.asList(Keys.WIDGET_FILTER__WIDGET_FILTER_FILTER_ID_FKEY,
