...
public class DeleteLogHandlerTest {
	...
	private LaunchRepository launchRepositoryMock(String launchId, String projectId, String owner) {
	...
	private TestItemRepository itemRepositoryMock(String logId, String launchId, String testId) {
	...
	private LogRepository logRepositoryMock(String logId, String testId) {
