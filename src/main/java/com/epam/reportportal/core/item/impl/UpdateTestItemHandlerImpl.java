...
import static com.epam.reportportal.infrastructure.rules.exception.ErrorType.FAILED_TEST_ITEM_ISSUE_TYPE_DEFINITION;
...
import static com.epam.reportportal.util.ItemInfoUtils.extractAttribute;
import static com.epam.reportportal.util.ItemInfoUtils.extractAttributeResource;
...
import com.epam.reportportal.infrastructure.rules.commons.validation.BusinessRuleViolationException;
...
import com.epam.reportportal.model.item.ExternalIssueRQ;
...
import com.epam.reportportal.util.ItemInfoUtils;
import com.epam.reportportal.ws.converter.builders.IssueEntityBuilder;
import com.epam.reportportal.ws.converter.builders.TestItemBuilder;
import com.epam.reportportal.ws.converter.converters.IssueConverter;
import com.epam.reportportal.ws.converter.converters.ItemAttributeConverter;
