...
public interface TmsTestCaseExecutionService {
  ...
  /**
   * Finds last executions for multiple test cases within a specific test plan. Returns a map where key is test case ID
   * and value is the last execution.
   *
  ...
  /**
   * Finds all executions for a specific test case within a test plan. Results are ordered by test_item.start_time DESC
   * (latest first).
   *
