...
/**
 * Converter for PluginUploadedEvent to Activity. System events (plugin load on startup/reload) are not persisted to
 * activity.
 */
@Component
public class PluginUploadedEventConverter implements EventToActivityConverter<PluginUploadedEvent> {
  ...
  @Override
  public Class<PluginUploadedEvent> getEventClass() {
    return PluginUploadedEvent.class;
  }
}
