...
INSERT INTO test_item(item_id, uuid, name, type, start_time, description, last_modified, path, unique_id, has_children,
                      has_retries, has_stats, parent_id, retry_of, launch_id)
VALUES (1, 'uuid', 'item', 'STEP', now(), 'desc', now(), '1', 'uniqueId', FALSE, FALSE, TRUE, NULL, NULL, 1);
