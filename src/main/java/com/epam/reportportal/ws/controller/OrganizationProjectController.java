...
import static com.epam.reportportal.auth.permissions.Permissions.ALLOWED_TO_EDIT_ORG_PROJECT;
import static com.epam.reportportal.auth.permissions.Permissions.ORGANIZATION_MANAGER;
import static com.epam.reportportal.auth.permissions.Permissions.ORGANIZATION_MEMBER;
...
import com.epam.reportportal.core.project.patch.PatchProjectHandler;
...
import com.epam.reportportal.util.ControllerUtils;
...
/**
 * Controller class for handling organization project-related requests. * Extends the BaseController and implements the
 * ProjectsApi interface. Provides endpoints for retrieving and managing organization projects. Controller
 * implementation for working with external systems.
 *
