        ...
        <tr>
          <td align="left" height="170">
            ...
            <h2 style="font-size: 20px; color: #777777;" align="center">Launch "${name}" #${number}
              has been
              finished</h2>
            <p style="font-size: 14px; color: #777777;">To view it on Report Portal just visit this
              <a
            ...
            <table border="0" cellspacing="0" cellpadding="12" class="linksline" align="center">
              ...
              <tr>
                ...
                <td><a href="https://github.com/reportportal" target="_blank"><img
                        src="cid:ic-github.png"
                        border="0" width="20"
                        height="21"
                        alt="github"></a>
                </td>
                <td><a href="https://www.facebook.com/ReportPortal.io" target="_blank"><img
                        src="cid:ic-fb.png" border="0" width="18" height="18" alt="facebook"></a>
                </td>
                <td><a href="http://twitter.com/ReportPortal_io" target="_blank"><img
                        src="cid:ic-twitter.png" border="0" width="20" height="16"
                        alt="twitter"></a></td>
                <td><a href="http://youtube.com/c/ReportPortalCommunity"
                       target="_blank"><img src="cid:ic-youtube.png" border="0" width="20"
                                            height="15"
                                            alt="youtube"></a></td>
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0" class="footerwrapper">
        ...
        <tr>
          <td align="center" height="52" class="footercontent">
            <p style="font-size: 11px; line-height: 1.5; color: #6d6d6d"><b>Report Portal
                Notification
                Center</b><br>
