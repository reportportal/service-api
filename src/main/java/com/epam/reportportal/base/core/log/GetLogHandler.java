...
public interface GetLogHandler {
   ...
   *
   * @param parentId          {@link Log#testItem} ID or {@link TestItem#parentId} ID
   * @param membershipDetails {@link MembershipDetails}
   * @param params            Request params
   * @param queryable         {@link Queryable}
   * @param pageable          {@link Pageable}
   * @return The {@link Iterable} of {@link LogResource} and {@link com.epam.reportportal.base.model.NestedStepResource}
   * entities
   */
