...
class CreateProjectSettingsHandlerImplTest {
	...
	void createSubtypeOnNotExistProject() {
		...
		ReportPortalException exception = assertThrows(ReportPortalException.class,
				() -> handler.createProjectIssueSubType(TEST_ORGANIZATION_SLUG, TEST_ORGANIZATION_SLUG, user, new CreateIssueSubTypeRQ())
		);
	...
	void createSubtypeWithWrongGroup() {
		...
		ReportPortalException exception = assertThrows(ReportPortalException.class,
				() -> handler.createProjectIssueSubType(TEST_ORGANIZATION_SLUG, TEST_PROJECT_NAME, user, createIssueSubTypeRQ)
		);
	...
	void maxSubtypesCount() {
		...
		when(projectRepository.findBySlugAndKey(TEST_ORGANIZATION_SLUG, TEST_PROJECT_NAME)).thenReturn(Optional.of(project));
