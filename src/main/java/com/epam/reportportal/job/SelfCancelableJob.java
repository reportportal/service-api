...
/**
 * Job contains run method and trigger. The main idea to provide possibility to cancel next execution from run method.
 * User can override job, call {@link SelfCancelableJob#oneMoreTime(boolean)} method and this way cancel next execution.
 * In case if we need job to keep executed, we do not call anything, next execution time calculation delegated to
 * provided trigger
 *
