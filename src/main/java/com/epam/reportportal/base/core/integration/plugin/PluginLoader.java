...
public interface PluginLoader {
  ...
  /**
   * Validate the plugin with {@link ExtensionPoint} on the presence of the mandatory extension class/classes
   *
  ...
  /**
   * Save plugin in the {@link DataStore}
   *
  ...
  /**
   * Copy plugin with resources from the {@link DataStore} to the provided path
   *
   * @param fileId              value
  ...
  /**
   * Delete plugin file from the {@link DataStore}
   *
   ...
   * {@link com.epam.reportportal.base.plugin.Pf4jPluginManager}
   *
