...
/**
 * Replacement of Spring's ResourceAssemblerSupport. Adds possibility to converter {@link Page}
 * resources which is basically arrays of entities with pageable information like current page, max
 * pages, total items, etc
 *
