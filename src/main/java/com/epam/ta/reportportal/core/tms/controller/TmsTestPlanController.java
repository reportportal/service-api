...
public class TmsTestPlanController {
  ...
  @Operation(
      ...
      description = "Duplicates test plan by test plan ID with all associated test cases. Creates a new test plan with '-copy' postfix in the name and duplicates all test cases that are currently added to the original test plan, also with '-copy' postfix in their names. All test cases are duplicated to their same folders."
  )
