...
public class JUsers extends TableImpl<JUsersRecord> {
	...
	private static final long serialVersionUID = -811940389;
	...
	public final TableField<JUsersRecord, Integer> ID = createField(
			"id", org.jooq.impl.SQLDataType.INTEGER.nullable(false)
					.defaultValue(org.jooq.impl.DSL.field("nextval('users_id_seq'::regclass)", org.jooq.impl.SQLDataType.INTEGER)), this,
			""
	);
	...
	public final TableField<JUsersRecord, String> PASSWORD = createField(
			"password", org.jooq.impl.SQLDataType.VARCHAR.nullable(false), this, "");
	...
	public final TableField<JUsersRecord, String> FULL_NAME = createField(
			"full_name", org.jooq.impl.SQLDataType.VARCHAR.nullable(false), this, "");
