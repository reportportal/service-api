...
/**
 * Converter for DefectTypeCreatedEvent to Activity.
 */
@Component
public class DefectTypeCreatedEventConverter implements
    EventToActivityConverter<DefectTypeCreatedEvent> {

  @Override
  public Activity convert(DefectTypeCreatedEvent event) {
    return new ActivityBuilder()
        .addCreatedAt(event.getOccurredAt())
        .addAction(EventAction.CREATE)
        .addEventName(ActivityAction.CREATE_DEFECT.getValue())
        .addPriority(EventPriority.LOW)
        .addObjectId(event.getIssueTypeActivityResource().getId())
        .addObjectName(event.getIssueTypeActivityResource().getLongName())
  ...
  @Override
  public Class<DefectTypeCreatedEvent> getEventClass() {
    return DefectTypeCreatedEvent.class;
  }
}
