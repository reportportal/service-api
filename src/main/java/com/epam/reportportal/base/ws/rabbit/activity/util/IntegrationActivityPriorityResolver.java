...
public class IntegrationActivityPriorityResolver {
  ...
  /**
   * Resolves priority depending on integration type. Global integrations detected by the project id absence.
   *
   * @param activity current event
   * @return {@link EventPriority#HIGH} for global integration if project id is absent. {@link EventPriority#MEDIUM} for
   * project integration
   */
