...
import static com.epam.reportportal.infrastructure.persistence.commons.querygen.constant.ActivityCriteriaConstant.CRITERIA_ACTION;
import static com.epam.reportportal.infrastructure.persistence.commons.querygen.constant.ActivityCriteriaConstant.CRITERIA_ACTIVITY_ORG_ID;
...
import static com.epam.reportportal.infrastructure.persistence.commons.querygen.constant.ActivityCriteriaConstant.CRITERIA_ACTIVITY_PROJECT_NAME;
...
import static com.epam.reportportal.infrastructure.persistence.commons.querygen.constant.ActivityCriteriaConstant.CRITERIA_PRIORITY;
import static com.epam.reportportal.infrastructure.persistence.commons.querygen.constant.ActivityCriteriaConstant.CRITERIA_SUBJECT_ID;
import static com.epam.reportportal.infrastructure.persistence.commons.querygen.constant.ActivityCriteriaConstant.CRITERIA_SUBJECT_NAME;
import static com.epam.reportportal.infrastructure.persistence.commons.querygen.constant.ActivityCriteriaConstant.CRITERIA_SUBJECT_TYPE;
import static com.epam.reportportal.infrastructure.persistence.commons.querygen.constant.GeneralCriteriaConstant.CRITERIA_CREATION_DATE;
...
import static com.epam.reportportal.infrastructure.persistence.commons.querygen.constant.GeneralCriteriaConstant.CRITERIA_OWNER;
...
import static com.epam.reportportal.infrastructure.persistence.commons.querygen.constant.GeneralCriteriaConstant.CRITERIA_SLUG;
...
import static com.epam.reportportal.infrastructure.persistence.commons.querygen.constant.GeneralCriteriaConstant.CRITERIA_USER_ID;
import static com.epam.reportportal.infrastructure.persistence.commons.querygen.constant.IntegrationCriteriaConstant.CRITERIA_INTEGRATION_TYPE;
import static com.epam.reportportal.infrastructure.persistence.commons.querygen.constant.IssueCriteriaConstant.CRITERIA_ISSUE_AUTO_ANALYZED;
import static com.epam.reportportal.infrastructure.persistence.commons.querygen.constant.IssueCriteriaConstant.CRITERIA_ISSUE_COMMENT;
import static com.epam.reportportal.infrastructure.persistence.commons.querygen.constant.IssueCriteriaConstant.CRITERIA_ISSUE_ID;
import static com.epam.reportportal.infrastructure.persistence.commons.querygen.constant.IssueCriteriaConstant.CRITERIA_ISSUE_IGNORE_ANALYZER;
import static com.epam.reportportal.infrastructure.persistence.commons.querygen.constant.IssueCriteriaConstant.CRITERIA_ISSUE_LOCATOR;
import static com.epam.reportportal.infrastructure.persistence.commons.querygen.constant.ItemAttributeConstant.CRITERIA_COMPOSITE_ATTRIBUTE;
import static com.epam.reportportal.infrastructure.persistence.commons.querygen.constant.ItemAttributeConstant.CRITERIA_COMPOSITE_SYSTEM_ATTRIBUTE;
...
import static com.epam.reportportal.infrastructure.persistence.commons.querygen.constant.ItemAttributeConstant.CRITERIA_LEVEL_ATTRIBUTE;
...
import static com.epam.reportportal.infrastructure.persistence.commons.querygen.constant.ItemAttributeConstant.LAUNCH_ATTRIBUTE;
...
import static com.epam.reportportal.infrastructure.persistence.commons.querygen.constant.LogCriteriaConstant.CRITERIA_LOG_MESSAGE;
import static com.epam.reportportal.infrastructure.persistence.commons.querygen.constant.LogCriteriaConstant.CRITERIA_LOG_PROJECT_ID;
...
import static com.epam.reportportal.infrastructure.persistence.commons.querygen.constant.OrganizationCriteriaConstant.CRITERIA_ORG_CREATED_AT;
...
import static com.epam.reportportal.infrastructure.persistence.commons.querygen.constant.OrganizationCriteriaConstant.CRITERIA_ORG_LAST_LAUNCH_RUN;
import static com.epam.reportportal.infrastructure.persistence.commons.querygen.constant.OrganizationCriteriaConstant.CRITERIA_ORG_LAUNCHES;
import static com.epam.reportportal.infrastructure.persistence.commons.querygen.constant.OrganizationCriteriaConstant.CRITERIA_ORG_NAME;
import static com.epam.reportportal.infrastructure.persistence.commons.querygen.constant.OrganizationCriteriaConstant.CRITERIA_ORG_PROJECTS;
import static com.epam.reportportal.infrastructure.persistence.commons.querygen.constant.OrganizationCriteriaConstant.CRITERIA_ORG_SLUG;
import static com.epam.reportportal.infrastructure.persistence.commons.querygen.constant.OrganizationCriteriaConstant.CRITERIA_ORG_TYPE;
import static com.epam.reportportal.infrastructure.persistence.commons.querygen.constant.OrganizationCriteriaConstant.CRITERIA_ORG_UPDATED_AT;
import static com.epam.reportportal.infrastructure.persistence.commons.querygen.constant.OrganizationCriteriaConstant.CRITERIA_ORG_USERS;
import static com.epam.reportportal.infrastructure.persistence.commons.querygen.constant.OrganizationCriteriaConstant.CRITERIA_ORG_USER_ID;
import static com.epam.reportportal.infrastructure.persistence.commons.querygen.constant.ProjectCriteriaConstant.CRITERIA_ALLOCATED_STORAGE;
import static com.epam.reportportal.infrastructure.persistence.commons.querygen.constant.ProjectCriteriaConstant.CRITERIA_PROJECT_ATTRIBUTE_NAME;
import static com.epam.reportportal.infrastructure.persistence.commons.querygen.constant.ProjectCriteriaConstant.CRITERIA_PROJECT_CREATION_DATE;
...
import static com.epam.reportportal.infrastructure.persistence.commons.querygen.constant.ProjectCriteriaConstant.CRITERIA_PROJECT_NAME;
import static com.epam.reportportal.infrastructure.persistence.commons.querygen.constant.ProjectCriteriaConstant.CRITERIA_PROJECT_ORGANIZATION;
import static com.epam.reportportal.infrastructure.persistence.commons.querygen.constant.ProjectCriteriaConstant.CRITERIA_PROJECT_ORGANIZATION_ID;
import static com.epam.reportportal.infrastructure.persistence.commons.querygen.constant.TestItemCriteriaConstant.CRITERIA_CLUSTER_ID;
...
import static com.epam.reportportal.infrastructure.persistence.commons.querygen.constant.TestItemCriteriaConstant.CRITERIA_HAS_CHILDREN;
import static com.epam.reportportal.infrastructure.persistence.commons.querygen.constant.TestItemCriteriaConstant.CRITERIA_HAS_RETRIES;
import static com.epam.reportportal.infrastructure.persistence.commons.querygen.constant.TestItemCriteriaConstant.CRITERIA_HAS_STATS;
import static com.epam.reportportal.infrastructure.persistence.commons.querygen.constant.TestItemCriteriaConstant.CRITERIA_ISSUE_GROUP_ID;
...
import static com.epam.reportportal.infrastructure.persistence.commons.querygen.constant.TestItemCriteriaConstant.CRITERIA_PARAMETER_KEY;
import static com.epam.reportportal.infrastructure.persistence.commons.querygen.constant.TestItemCriteriaConstant.CRITERIA_PARAMETER_VALUE;
import static com.epam.reportportal.infrastructure.persistence.commons.querygen.constant.TestItemCriteriaConstant.CRITERIA_PARENT_ID;
import static com.epam.reportportal.infrastructure.persistence.commons.querygen.constant.TestItemCriteriaConstant.CRITERIA_PATH;
import static com.epam.reportportal.infrastructure.persistence.commons.querygen.constant.TestItemCriteriaConstant.CRITERIA_PATTERN_TEMPLATE_NAME;
import static com.epam.reportportal.infrastructure.persistence.commons.querygen.constant.TestItemCriteriaConstant.CRITERIA_RETRY_PARENT_ID;
...
import static com.epam.reportportal.infrastructure.persistence.commons.querygen.constant.TestItemCriteriaConstant.CRITERIA_TEST_CASE_ID;
import static com.epam.reportportal.infrastructure.persistence.commons.querygen.constant.TestItemCriteriaConstant.CRITERIA_TICKET_ID;
import static com.epam.reportportal.infrastructure.persistence.commons.querygen.constant.TestItemCriteriaConstant.CRITERIA_UNIQUE_ID;
import static com.epam.reportportal.infrastructure.persistence.commons.querygen.constant.TestItemCriteriaConstant.CRITERIA_UUID;
import static com.epam.reportportal.infrastructure.persistence.commons.querygen.constant.TestItemCriteriaConstant.RETRY_PARENT;
import static com.epam.reportportal.infrastructure.persistence.commons.querygen.constant.UserCriteriaConstant.CRITERIA_ACCOUNT_TYPE;
import static com.epam.reportportal.infrastructure.persistence.commons.querygen.constant.UserCriteriaConstant.CRITERIA_ACTIVE;
...
import static com.epam.reportportal.infrastructure.persistence.commons.querygen.constant.UserCriteriaConstant.CRITERIA_EXTERNALID;
import static com.epam.reportportal.infrastructure.persistence.commons.querygen.constant.UserCriteriaConstant.CRITERIA_EXTERNAL_ID;
import static com.epam.reportportal.infrastructure.persistence.commons.querygen.constant.UserCriteriaConstant.CRITERIA_FULLNAME;
...
import static com.epam.reportportal.infrastructure.persistence.commons.querygen.constant.UserCriteriaConstant.CRITERIA_INSTANCE_ROLE;
...
import static com.epam.reportportal.infrastructure.persistence.commons.querygen.constant.UserCriteriaConstant.CRITERIA_SYNCHRONIZATION_DATE;
import static com.epam.reportportal.infrastructure.persistence.commons.querygen.constant.UserCriteriaConstant.CRITERIA_TYPE;
...
import static com.epam.reportportal.infrastructure.persistence.entity.project.ProjectInfo.LAST_RUN;
import static com.epam.reportportal.infrastructure.persistence.entity.project.ProjectInfo.LAUNCHES_QUANTITY;
import static com.epam.reportportal.infrastructure.persistence.entity.project.ProjectInfo.USERS_QUANTITY;
import static com.epam.reportportal.infrastructure.persistence.jooq.Tables.ACTIVITY;
import static com.epam.reportportal.infrastructure.persistence.jooq.Tables.ATTACHMENT;
import static com.epam.reportportal.infrastructure.persistence.jooq.Tables.ATTRIBUTE;
import static com.epam.reportportal.infrastructure.persistence.jooq.Tables.CLUSTERS_TEST_ITEM;
import static com.epam.reportportal.infrastructure.persistence.jooq.Tables.DASHBOARD;
import static com.epam.reportportal.infrastructure.persistence.jooq.Tables.DASHBOARD_WIDGET;
import static com.epam.reportportal.infrastructure.persistence.jooq.Tables.FILTER;
import static com.epam.reportportal.infrastructure.persistence.jooq.Tables.FILTER_CONDITION;
...
import static com.epam.reportportal.infrastructure.persistence.jooq.Tables.INTEGRATION_TYPE;
import static com.epam.reportportal.infrastructure.persistence.jooq.Tables.ISSUE;
import static com.epam.reportportal.infrastructure.persistence.jooq.Tables.ISSUE_GROUP;
import static com.epam.reportportal.infrastructure.persistence.jooq.Tables.ISSUE_TICKET;
import static com.epam.reportportal.infrastructure.persistence.jooq.Tables.ISSUE_TYPE;
...
import com.epam.reportportal.infrastructure.persistence.commons.querygen.constant.TestItemCriteriaConstant;
