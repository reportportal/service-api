...
import static com.epam.reportportal.base.ws.converter.converters.UserConverter.TO_INSTANCE_USER;
...
import com.epam.reportportal.base.infrastructure.persistence.dao.GroupMembershipRepository;
...
public class GetUserHandlerImpl implements GetUserHandler {
  ...
  @Override
  public com.epam.reportportal.base.model.Page<UserResource> getUsers(Filter filter, Pageable pageable,
  ...
  @Override
  public com.epam.reportportal.base.model.Page<UserResource> getAllUsers(Queryable filter, Pageable pageable) {
  ...
  @Override
  public com.epam.reportportal.base.model.Page<UserResource> searchUsers(String term, Pageable pageable) {
