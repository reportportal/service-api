...
class LaunchFinishedEventListenerTest {
  ...
  private final LaunchFinishedMessagePublisher launchFinishedMessagePublisher = mock(
      LaunchFinishedMessagePublisher.class);
  ...
  private final LaunchFinishedEventListener eventListener = new LaunchFinishedEventListener(
      List.of(launchFinishedMessagePublisher,
