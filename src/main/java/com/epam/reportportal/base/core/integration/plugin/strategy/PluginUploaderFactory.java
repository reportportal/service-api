...
package com.epam.reportportal.base.core.integration.plugin.strategy;
...
/**
 * Factory class for creating instances of {@link PluginUploader} based on the content type. This class is responsible
 * for managing different types of plugin uploads and providing the appropriate one based on the content type.
 *
