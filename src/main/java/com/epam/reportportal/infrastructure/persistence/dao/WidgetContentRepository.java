...
public interface WidgetContentRepository {
   ...
   * {@link com.epam.reportportal.infrastructure.persistence.entity.filter.UserFilter#getName()} as key and list of
   ...
   * {@link com.epam.reportportal.infrastructure.persistence.entity.launch.Launch} with combined {@link Filter}
   *
   * @param filter        {@link Filter}
   * @param contentFields Custom fields for select query building
   * @param customColumns Map of the custom column name as key and {@link ItemAttribute#getKey()} as value
  ...
  /**
   * Load TOP-20 most matched {@link com.epam.reportportal.infrastructure.persistence.entity.pattern.PatternTemplate}
