...
public interface Pf4jPluginBox extends PluginBox {
   ...
   *                 {@link com.epam.reportportal.base.plugin.Pf4jPluginManager#uploadingPlugins} which uploaded state
   *                 is required
   * @return 'true' if {@link com.epam.reportportal.base.plugin.Pf4jPluginManager#uploadingPlugins} contains plugin file
   * name, else 'false'
