...
import com.epam.reportportal.util.email.strategy.EmailNotificationStrategy;
import com.epam.reportportal.util.email.strategy.EmailTemplate;
import com.epam.reportportal.util.email.strategy.UserDeletionNotificationStrategy;
import com.epam.reportportal.util.email.strategy.UserExpirationNotificationStrategy;
import com.epam.reportportal.util.email.strategy.UserSelfDeletionNotificationStrategy;
