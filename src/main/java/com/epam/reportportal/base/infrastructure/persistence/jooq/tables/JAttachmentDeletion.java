...
public class JAttachmentDeletion extends TableImpl<JAttachmentDeletionRecord> {
   ...
   */
  public final TableField<JAttachmentDeletionRecord, String> FILE_ID = createField(DSL.name("file_id"),
      SQLDataType.CLOB.nullable(false), this, "");

  /**
   * The column <code>public.attachment_deletion.thumbnail_id</code>.
   */
  public final TableField<JAttachmentDeletionRecord, String> THUMBNAIL_ID = createField(DSL.name("thumbnail_id"),
   ...
   */
  public final TableField<JAttachmentDeletionRecord, Instant> CREATION_ATTACHMENT_DATE = createField(
      DSL.name("creation_attachment_date"), SQLDataType.LOCALDATETIME(6), this, "", new JooqInstantConverter());

  /**
   * The column <code>public.attachment_deletion.deletion_date</code>.
   */
  public final TableField<JAttachmentDeletionRecord, Instant> DELETION_DATE = createField(DSL.name("deletion_date"),
