...
import static com.epam.reportportal.base.core.widget.util.ContentFieldPatternConstants.EXECUTIONS_TOTAL_REGEX;
...
/**
 * Validates content fields and filter mappings for the Cases Trend widget.
 *
...
public class CasesTrendContentValidator implements WidgetValidatorStrategy {
   ...
   * <p>
   * The value of content field should not be empty Content fields should contain only 1 value Content field value
   * should match the pattern
   * {@link com.epam.reportportal.base.core.widget.util.ContentFieldPatternConstants#EXECUTIONS_TOTAL_REGEX}
   *
