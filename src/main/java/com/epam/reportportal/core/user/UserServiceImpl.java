 ...
 *
 * <p>When a user with the requested id cannot be found, methods of this implementation throw a
  ...
  public User findById(Long userId) {
    return userRepository.findById(userId)
        .orElseThrow(() -> new ReportPortalException(USER_NOT_FOUND,
            Suppliers.formattedSupplier("User with id '{}' not found", userId).get()));
  }
}
