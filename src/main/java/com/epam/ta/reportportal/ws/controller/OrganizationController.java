...
/**
 * Controller for managing organizations in ReportPortal.
 * Provides endpoints for creating, updating, retrieving, and deleting organizations.
 *
...
public class OrganizationController extends BaseController implements OrganizationApi {
   ...
   * @param pluginManager          The plugin manager for managing extensions related to organizations.
   */
  @Autowired
  ...
  private OrganizationExtensionPoint getOrgExtension() {
    return pluginManager.getExtensions(OrganizationExtensionPoint.class)
        .stream()
        .findFirst()
        .orElseThrow(
