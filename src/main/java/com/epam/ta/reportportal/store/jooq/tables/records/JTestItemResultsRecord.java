...
public class JTestItemResultsRecord extends UpdatableRecordImpl<JTestItemResultsRecord> implements Record3<Long, JStatusEnum, Long> {

    private static final long serialVersionUID = 1178551505;
     ...
     */
    @Override
    public Row3<Long, JStatusEnum, Long> fieldsRow() {
     ...
     */
    @Override
    public Row3<Long, JStatusEnum, Long> valuesRow() {
     ...
     */
    @Override
    public JTestItemResultsRecord value3(Long value) {
        setDuration(value);
        return this;
    }
     ...
     */
    @Override
    public JTestItemResultsRecord values(Long value1, JStatusEnum value2, Long value3) {
        value1(value1);
        value2(value2);
        value3(value3);
        return this;
     ...
     */
    public JTestItemResultsRecord(Long itemId, JStatusEnum status, Long duration) {
        super(JTestItemResults.TEST_ITEM_RESULTS);
