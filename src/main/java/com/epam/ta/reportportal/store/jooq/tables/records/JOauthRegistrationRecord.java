...
public class JOauthRegistrationRecord extends UpdatableRecordImpl<JOauthRegistrationRecord>
		implements Record13<String, String, String, String, String, String, String[], String, String, String, String, String, String> {

	private static final long serialVersionUID = 537288148;
	...
	/**
	 * Setter for <code>public.oauth_registration.scopes</code>.
	 */
	...
	/**
	 * Getter for <code>public.oauth_registration.scopes</code>.
	 */
	...
	public Field<String[]> field7() {
		return JOauthRegistration.OAUTH_REGISTRATION.SCOPES;
	}
	...
	public JOauthRegistrationRecord(String id, String clientId, String clientSecret, String clientAuthMethod, String authGrantType,
		...
		set(6, scopes);
		set(7, authorizationUri);
		set(8, tokenUri);
		set(9, userInfoEndpointUri);
		set(10, userInfoEndpointNameAttr);
		set(11, jwkSetUri);
		set(12, clientName);
	}
}
