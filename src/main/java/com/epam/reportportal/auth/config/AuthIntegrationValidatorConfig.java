...
/**
 * Registers auth request validators. Each auth plugin provides its own validation logic; this bean is a no-op fallback
 * used by plugins that do not need additional param validation.
 */
@Configuration
public class AuthIntegrationValidatorConfig {

  @Bean
  public AuthRequestValidator<IntegrationRQ> updateAuthRequestValidator() {
