...
package com.epam.reportportal.core.item.history;
...
public interface TestItemsHistoryHandler {
  ...
  /**
   * Get history for {@link com.epam.reportportal.infrastructure.persistence.entity.item.TestItem}s according to input
   * parameters
   *
   ...
   */
  Page<TestItemHistoryElement> getItemsHistory(MembershipDetails membershipDetails,
