...
VALUES (7, 1, 6, FALSE, 'superadmin', now(), 'n1'),
       (8, 1, 7, FALSE, 'superadmin', now(), 'n2'),
       (9, 2, 6, FALSE, 'superadmin', now(), 'n3'),
       (10, 2, 7, FALSE, 'superadmin', now(), 'n4');
...
VALUES (13, 'jira', 7, false, 'superadmin', now(), '{
  "params": {
    "url" : "bts.com",
    "project" : "bts_project"
  }
...
VALUES (14, 'jira1', 1, 7, false, 'superadmin', now(), '{
  "params": {
    "url" : "projectbts.com",
    "project" : "project"
  }
...
VALUES (15, 1, 6, false, 'superadmin', now(), '{
  "params": {
    "url" : "rallybts.com",
...
VALUES (16, 6, false, 'superadmin', now(), '{
  "params": {
    "url" : "globalrally.com",
...
VALUES (18, 'jira clone', 7, false, 'superadmin', now(), '{
  "params": {
    "url" : "bts.com",
    "project" : "bts_project"
  }
