...
import com.epam.reportportal.base.model.PagedResponse;
...
/**
 * Replacement of Spring's ResourceAssemblerSupport. Adds possibility to converter {@link Page} resources which is
 * basically arrays of entities with pageable information like current page, max pages, total items, etc
 *
...
public abstract class PagedResourcesAssembler<T, R> extends ResourceAssembler<T, R> {
  ...
  public static <T> Function<Page<T>, com.epam.reportportal.base.model.Page<T>> pageConverter() {
    return page -> new com.epam.reportportal.base.model.Page<>(page.getContent(),
        new com.epam.reportportal.base.model.Page.PageMetadata(page.getSize(),
  ...
  public static <T, R> Function<Page<T>, com.epam.reportportal.base.model.Page<R>> pageConverter(
  ...
  public static <T, R> Function<Page<T>, com.epam.reportportal.base.model.Page<R>> pageMultiConverter(
  ...
  /**
   * Creates {@link com.epam.reportportal.base.model.Page} from {@link Page} DB query result
   *
   ...
   */
  @Deprecated
  public com.epam.reportportal.base.model.Page<R> toPagedResources(Page<T> content) {
    Preconditions.checkNotNull(content, "Content should be null");

    return new com.epam.reportportal.base.model.Page<>(toResources(content),
        new com.epam.reportportal.base.model.Page.PageMetadata(content.getSize(),
