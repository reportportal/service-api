...
public interface MessageBus {
  ...
  /**
   * Publish event to remove {@link com.epam.ta.reportportal.entity.attachment.Attachment} from the
   * database and {@link com.epam.ta.reportportal.filesystem.DataStore}
   *
