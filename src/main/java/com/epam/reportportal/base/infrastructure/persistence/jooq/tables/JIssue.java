...
public class JIssue extends TableImpl<JIssueRecord> {
   ...
   */
  public final TableField<JIssueRecord, Long> ISSUE_ID = createField(DSL.name("issue_id"),
   ...
   */
  public final TableField<JIssueRecord, String> ISSUE_DESCRIPTION = createField(DSL.name("issue_description"),
      SQLDataType.CLOB, this, "");

  /**
   * The column <code>public.issue.auto_analyzed</code>.
   */
  public final TableField<JIssueRecord, Boolean> AUTO_ANALYZED = createField(DSL.name("auto_analyzed"),
   ...
   */
  public final TableField<JIssueRecord, Boolean> IGNORE_ANALYZER = createField(DSL.name("ignore_analyzer"),
      SQLDataType.BOOLEAN.defaultValue(DSL.field(DSL.raw("false"), SQLDataType.BOOLEAN)), this, "");
  ...
  public <O extends Record> JIssue(Table<O> path, ForeignKey<O, JIssueRecord> childPath,
      InverseForeignKey<O, JIssueRecord> parentPath) {
  ...
  public static class JIssuePath extends JIssue implements Path<JIssueRecord> {
    ...
    public <O extends Record> JIssuePath(Table<O> path, ForeignKey<O, JIssueRecord> childPath,
        InverseForeignKey<O, JIssueRecord> parentPath) {
  ...
  /**
   * Get the implicit join path to the <code>public.test_item_results</code> table.
   */
  ...
  /**
   * Get the implicit many-to-many join path to the <code>public.ticket</code> table
   */
