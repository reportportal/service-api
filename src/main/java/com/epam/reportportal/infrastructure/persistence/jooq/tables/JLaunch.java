...
import com.epam.reportportal.infrastructure.persistence.jooq.enums.JRetentionPolicyEnum;
...
public class JLaunch extends TableImpl<JLaunchRecord> {
   ...
   */
  public final TableField<JLaunchRecord, Long> ID = createField(DSL.name("id"),
      SQLDataType.BIGINT.nullable(false).identity(true), this, "");

  /**
   * The column <code>public.launch.uuid</code>.
   */
  public final TableField<JLaunchRecord, String> UUID = createField(DSL.name("uuid"),
      SQLDataType.VARCHAR(36).nullable(false), this, "");

  /**
   * The column <code>public.launch.project_id</code>.
   */
  public final TableField<JLaunchRecord, Long> PROJECT_ID = createField(DSL.name("project_id"),
   ...
   */
  public final TableField<JLaunchRecord, String> NAME = createField(DSL.name("name"),
   ...
   */
  public final TableField<JLaunchRecord, Instant> START_TIME = createField(DSL.name("start_time"),
      SQLDataType.LOCALDATETIME(6).nullable(false), this, "", new JooqInstantConverter());

  /**
   * The column <code>public.launch.end_time</code>.
   */
  public final TableField<JLaunchRecord, Instant> END_TIME = createField(DSL.name("end_time"),
      SQLDataType.LOCALDATETIME(6), this, "", new JooqInstantConverter());

  /**
   * The column <code>public.launch.number</code>.
   */
  public final TableField<JLaunchRecord, Integer> NUMBER = createField(DSL.name("number"),
   ...
   */
  public final TableField<JLaunchRecord, JLaunchModeEnum> MODE = createField(DSL.name("mode"),
      SQLDataType.VARCHAR.nullable(false).asEnumDataType(JLaunchModeEnum.class), this, "");

  /**
   * The column <code>public.launch.status</code>.
   */
  public final TableField<JLaunchRecord, JStatusEnum> STATUS = createField(DSL.name("status"),
      SQLDataType.VARCHAR.nullable(false).asEnumDataType(JStatusEnum.class), this, "");
  ...
  public <O extends Record> JLaunch(Table<O> path, ForeignKey<O, JLaunchRecord> childPath,
      InverseForeignKey<O, JLaunchRecord> parentPath) {
  ...
  public static class JLaunchPath extends JLaunch implements Path<JLaunchRecord> {
    ...
    public <O extends Record> JLaunchPath(Table<O> path, ForeignKey<O, JLaunchRecord> childPath,
        InverseForeignKey<O, JLaunchRecord> parentPath) {
  ...
  public List<Index> getIndexes() {
    return Arrays.asList(Indexes.LAUNCH_PROJECT_START_TIME_IDX, Indexes.LAUNCH_STATUS_IDX, Indexes.LAUNCH_USER_IDX,
        Indexes.MODE_IDX);
  }
