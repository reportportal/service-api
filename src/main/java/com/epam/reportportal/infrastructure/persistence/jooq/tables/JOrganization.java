...
public class JOrganization extends TableImpl<JOrganizationRecord> {
   ...
   */
  public final TableField<JOrganizationRecord, Long> ID = createField(DSL.name("id"),
      SQLDataType.BIGINT.nullable(false).identity(true), this, "");

  /**
   * The column <code>public.organization.created_at</code>.
   */
  public final TableField<JOrganizationRecord, Instant> CREATED_AT = createField(DSL.name("created_at"),
   ...
   */
  public final TableField<JOrganizationRecord, Instant> UPDATED_AT = createField(DSL.name("updated_at"),
      SQLDataType.LOCALDATETIME(6).nullable(false).defaultValue(DSL.field(DSL.raw("now()"), SQLDataType.LOCALDATETIME)),
      this, "", new JooqInstantConverter());
   ...
   */
  public final TableField<JOrganizationRecord, String> NAME = createField(DSL.name("name"),
      SQLDataType.CLOB.nullable(false), this, "");

  /**
   * The column <code>public.organization.organization_type</code>.
   */
  public final TableField<JOrganizationRecord, String> ORGANIZATION_TYPE = createField(DSL.name("organization_type"),
      SQLDataType.CLOB.nullable(false), this, "");

  /**
   * The column <code>public.organization.external_id</code>.
   */
  public final TableField<JOrganizationRecord, String> EXTERNAL_ID = createField(DSL.name("external_id"),
      SQLDataType.CLOB, this, "");

  /**
   * The column <code>public.organization.slug</code>.
   */
  public final TableField<JOrganizationRecord, String> SLUG = createField(DSL.name("slug"),
      SQLDataType.CLOB.nullable(false), this, "");

  /**
   * The column <code>public.organization.owner_id</code>.
   */
  public final TableField<JOrganizationRecord, Long> OWNER_ID = createField(DSL.name("owner_id"), SQLDataType.BIGINT,
      this, "");
  ...
  public <O extends Record> JOrganization(Table<O> path, ForeignKey<O, JOrganizationRecord> childPath,
      InverseForeignKey<O, JOrganizationRecord> parentPath) {
  ...
  public static class JOrganizationPath extends JOrganization implements Path<JOrganizationRecord> {
    ...
    public <O extends Record> JOrganizationPath(Table<O> path, ForeignKey<O, JOrganizationRecord> childPath,
        InverseForeignKey<O, JOrganizationRecord> parentPath) {
  ...
  /**
   * Get the implicit to-many join path to the <code>public.project</code> table
   */
  ...
  public JOrganizationUserPath organizationUser() {
    if (_organizationUser == null) {
      _organizationUser = new JOrganizationUserPath(this, null,
          Keys.ORGANIZATION_USER__ORGANIZATION_USER_ORGANIZATION_ID_FKEY.getInverseKey());
    }
