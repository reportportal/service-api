...
insert into test_item(test_case_hash, item_id, uuid, name, type, start_time, description, unique_id,
                      last_modified, path, parent_id, launch_id)
values (6, 6, 'uuid6', 'test item 6', 'STEP', now(), 'desc', 'uuid6', now(), '6', null, 1);
insert into test_item_results(result_id, status)
...
VALUES (2, 'overall statistics default', null, 'overallStatistics', 20, '{"options": {}}'),
       (3, 'overall statistics separated', null, 'overallStatistics', 20,
        '{"options": {"separateInterrupted": true}}');
...
values (2, 'statistics$executions$total'),
       ...
       (3, 'statistics$defects$to_investigate$ti001');

insert into widget_filter(widget_id, filter_id)
values (2, 1),
       (3, 1);

-- Statistics (only launch 1 with items 1-6)
...
INSERT INTO statistics(s_counter, statistics_field_id, item_id) VALUES (1, 1, 6), (1, 4, 6);
INSERT INTO launch_statistics(s_counter, statistics_field_id, launch_id) VALUES (6, 1, 1), (2, 2, 1), (4, 4, 1), (1, 5, 1), (1, 6, 1), (1, 7, 1), (1, 8, 1), (1, 11, 1), (1, 12, 1);
