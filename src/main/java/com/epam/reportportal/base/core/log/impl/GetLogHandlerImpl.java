...
import static com.epam.reportportal.base.infrastructure.rules.exception.ErrorType.LOG_NOT_FOUND;
...
import com.epam.reportportal.base.infrastructure.persistence.dao.LogRepositoryCustom;
...
public class GetLogHandlerImpl implements GetLogHandler {
  ...
  @Override
  public com.epam.reportportal.base.model.Page<LogResource> getLogs(@Nullable String path,
  ...
  @Override
  public com.epam.reportportal.base.model.Page<?> getNestedItems(Long parentId,
  ...
  @Override
  public com.epam.reportportal.base.model.Page<PagedLogResource> getLogsWithLocationBySearch(
