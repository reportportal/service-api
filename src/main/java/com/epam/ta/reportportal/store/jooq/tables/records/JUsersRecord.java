...
public class JUsersRecord extends UpdatableRecordImpl<JUsersRecord> implements Record9<Integer, String, String, String, JUserRoleEnum, JUserTypeEnum, Integer, String, Object> {

    private static final long serialVersionUID = 193560424;
     ...
     */
    @Override
    public JUsersRecord values(Integer value1, String value2, String value3, String value4, JUserRoleEnum value5, JUserTypeEnum value6, Integer value7, String value8, Object value9) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public JUsersRecord(Integer id, String login, String password, String email, JUserRoleEnum role, JUserTypeEnum type, Integer defaultProjectId, String fullName, Object metadata) {
        super(JUsers.USERS);
