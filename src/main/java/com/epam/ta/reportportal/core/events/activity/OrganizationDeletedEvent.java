 ...
 */
@Getter
public class OrganizationDeletedEvent extends AbstractEvent implements ActivityEvent {

  private final Long organizationId;
  private final String organizationName;

  public OrganizationDeletedEvent(Long userId, String userLogin, Long organizationId, String organizationName) {
