...
insert into test_item(item_id, uuid, name, type, start_time, description, last_modified, path, unique_id, has_children, has_retries, parent_id, retry_of, launch_id)
values (6, '253ea6e6-0f04-4c8c-801c-6776b9f626de', 'child item', 'STEP', now(), 'desc', now(), '1.6', '74c35be0-3ffc-4c72-adfd-28bb3671f210', false, false, 1, null, 1);
...
insert into test_item(item_id, uuid, name, type, start_time, description, last_modified, path, unique_id, has_children, has_retries, parent_id, retry_of, launch_id)
values (3, '0b4e8847-03fc-4326-bbc3-2dca9c31e22d', 'child item', 'STEP', now(), 'desc', now(), '3', '73737d72-6629-44b4-9047-3e7afb1936ba5', false, false, null, null, 2);
...
insert into test_item(item_id, uuid, name, type, start_time, description, last_modified, path, unique_id, has_children, has_retries, parent_id, retry_of, launch_id)
values (5, '3ab067e5-537b-45ff-9605-843ab695c96a', 'child item', 'STEP', now(), 'desc', now(), '5', '757b376f-dfa0-40db-9373-d8092ab404a4', false, false, null, null, 3);
