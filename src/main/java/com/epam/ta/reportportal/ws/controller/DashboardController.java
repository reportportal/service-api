...
public class DashboardController {
  ...
  public OperationCompletionRS addWidget(@PathVariable String projectName,
      ...
      @RequestBody @Validated AddWidgetRq addWidgetRq,
      @AuthenticationPrincipal ReportPortalUser user) {
    return updateDashboardHandler.addWidget(dashboardId,
        projectExtractor.extractProjectDetails(user, projectName), addWidgetRq, user);
  }
  ...
  public OperationCompletionRS removeWidget(@PathVariable String projectName,
      ...
      @AuthenticationPrincipal ReportPortalUser user) {
    return updateDashboardHandler.removeWidget(widgetId, dashboardId,
  ...
  public OperationCompletionRS deleteDashboard(@PathVariable String projectName,
      @PathVariable Long dashboardId,
      @AuthenticationPrincipal ReportPortalUser user) {
    return deleteDashboardHandler.deleteDashboard(dashboardId,
        projectExtractor.extractProjectDetails(user, projectName), user);
  }
