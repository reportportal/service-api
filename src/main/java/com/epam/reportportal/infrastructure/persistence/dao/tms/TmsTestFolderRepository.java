...
import com.epam.reportportal.infrastructure.persistence.entity.tms.TmsTestFolderIdWithCountOfTestCases;
...
public interface TmsTestFolderRepository extends ReportPortalRepository<TmsTestFolder, Long> {
   ...
   */
  @Query(
      "SELECT new com.epam.reportportal.infrastructure.persistence.entity.tms."
