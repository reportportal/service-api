...
public final class AuthUtils {
  ...
  /**
   * Dirty hack to fix <a
   * href="https://github.com/spring-projects/spring-security-oauth/issues/665">Spring Security
   * Issue</a> If there is serialUid mismatch, replaces Uuid and tries de-serialize object again
  ...
  public static <T> T deserializeSafely(byte[] data, @Nullable Consumer<T> mismatchCallback) {
    try {
      ...
      boolean serialUidMismatch = java.io.InvalidClassException.class.equals(
          e.getCause().getClass());
