...
import com.epam.ta.reportportal.core.integration.bootstrap.PluginBootstrapper;
...
public class DefaultPluginBootstrapper implements PluginBootstrapper {
	...
	@Autowired
	public DefaultPluginBootstrapper(IntegrationTypeRepository integrationTypeRepository, PluginLoader pluginLoader) {
