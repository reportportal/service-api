...
import com.epam.reportportal.base.core.filter.GetUserFilterHandler;
...
public class GetUserFilterHandlerImpl implements GetUserFilterHandler {
  ...
  @Override
  public com.epam.reportportal.base.model.Page<UserFilterResource> getUserFilters(String projectName, Pageable pageable,
  ...
  @Override
  public com.epam.reportportal.base.model.Page<OwnedEntityResource> getFiltersNames(
