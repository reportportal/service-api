...
/**
 * Converter for DashboardDeletedEvent to Activity.
 */
@Component
public class DashboardDeletedEventConverter implements
    EventToActivityConverter<DashboardDeletedEvent> {
  ...
  @Override
  public Class<DashboardDeletedEvent> getEventClass() {
    return DashboardDeletedEvent.class;
  }
}
