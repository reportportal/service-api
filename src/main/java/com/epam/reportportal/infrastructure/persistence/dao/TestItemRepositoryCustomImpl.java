...
import static com.epam.reportportal.infrastructure.persistence.commons.querygen.FilterTarget.FILTERED_ID;
import static com.epam.reportportal.infrastructure.persistence.commons.querygen.FilterTarget.FILTERED_QUERY;
import static com.epam.reportportal.infrastructure.persistence.commons.querygen.QueryBuilder.retrieveOffsetAndApplyBoundaries;
...
import static com.epam.reportportal.infrastructure.persistence.dao.constant.LogRepositoryConstants.ITEM;
import static com.epam.reportportal.infrastructure.persistence.dao.constant.TestItemRepositoryConstants.ATTACHMENTS_COUNT;
import static com.epam.reportportal.infrastructure.persistence.dao.constant.TestItemRepositoryConstants.HAS_CONTENT;
import static com.epam.reportportal.infrastructure.persistence.dao.constant.TestItemRepositoryConstants.NESTED;
import static com.epam.reportportal.infrastructure.persistence.dao.constant.WidgetContentRepositoryConstants.HISTORY;
...
import static com.epam.reportportal.infrastructure.persistence.dao.util.RecordMappers.INDEX_TEST_ITEM_RECORD_MAPPER;
import static com.epam.reportportal.infrastructure.persistence.dao.util.RecordMappers.ISSUE_TYPE_RECORD_MAPPER;
import static com.epam.reportportal.infrastructure.persistence.dao.util.RecordMappers.NESTED_STEP_RECORD_MAPPER;
import static com.epam.reportportal.infrastructure.persistence.dao.util.RecordMappers.TEST_ITEM_RECORD_MAPPER;
import static com.epam.reportportal.infrastructure.persistence.dao.util.ResultFetchers.TEST_ITEM_CLIPPED_FETCHER;
import static com.epam.reportportal.infrastructure.persistence.dao.util.ResultFetchers.TEST_ITEM_FETCHER;
import static com.epam.reportportal.infrastructure.persistence.dao.util.ResultFetchers.TEST_ITEM_RETRY_FETCHER;
...
import static com.epam.reportportal.infrastructure.persistence.jooq.Tables.ISSUE_TYPE_PROJECT;
...
import static com.epam.reportportal.infrastructure.persistence.jooq.tables.JIssueType.ISSUE_TYPE;
...
import com.epam.reportportal.infrastructure.persistence.dao.util.TimestampUtils;
...
import com.epam.reportportal.infrastructure.persistence.entity.item.ItemPathName;
import com.epam.reportportal.infrastructure.persistence.entity.item.LaunchPathName;
...
import com.epam.reportportal.infrastructure.persistence.jooq.Tables;
