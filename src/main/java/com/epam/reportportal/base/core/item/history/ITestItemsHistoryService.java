...
package com.epam.reportportal.base.core.item.history;
...
/**
 * Define interface for loading and validating additional data( launches and test Items) which should be used for
 * loading test items history.
 *
...
public interface ITestItemsHistoryService {
   ...
   * @param showBrokenLaunches - <b>boolean</b> should in_progress and interrupted launches been included in
   *                           history:<br>
