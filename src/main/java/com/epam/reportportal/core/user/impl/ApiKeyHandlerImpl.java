...
import com.epam.reportportal.infrastructure.persistence.dao.ApiKeyRepository;
...
import com.epam.reportportal.ws.converter.converters.ApiKeyConverter;
...
public class ApiKeyHandlerImpl implements ApiKeyHandler {
  ...
  public ApiKeysRS getAllUsersApiKeys(Long userId) {
    ...
    apiKeysRS.setApiKeys(
        apiKeys.stream().map(ApiKeyConverter.TO_RESOURCE).toList());
    return apiKeysRS;
  }
