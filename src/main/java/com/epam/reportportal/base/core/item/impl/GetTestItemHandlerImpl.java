...
import com.epam.reportportal.base.core.item.impl.provider.DataProviderType;
...
import com.epam.reportportal.base.ws.converter.converters.StatisticsConverter;
...
class GetTestItemHandlerImpl implements GetTestItemHandler {
  ...
  @Override
  public com.epam.reportportal.base.model.Page<TestItemResource> getTestItems(Queryable filter,
      Pageable pageable,
      MembershipDetails membershipDetails, ReportPortalUser user,
  ...
  @Override
  public com.epam.reportportal.base.model.Page<TestItemResource> getTestItemsByProvider(
