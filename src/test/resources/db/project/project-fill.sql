...
-- First launch
insert into launch(id, uuid, project_id, user_id, name, description, start_time, end_time, number, last_modified, mode, status, has_retries, organization_id)
values (1, 'uuid', 1, 1, 'test launch', 'desc', now(), null, 3, now(), 'DEFAULT', 'FAILED', false, 1);
...
-- Second launch
insert into launch(id, uuid, project_id, user_id, name, description, start_time, end_time, number, last_modified, mode, status, has_retries, organization_id)
values (2, 'uuid2', 3, 1, 'test launch', 'desc', now(), null, 2, now(), 'DEFAULT', 'FAILED', false, 101);
...
-- Third launch
insert into launch(id, uuid, project_id, user_id, name, description, start_time, end_time, number, last_modified, mode, status, has_retries, organization_id)
values (3, 'uuid3', 1, 1, 'empty launch', 'desc', now(), null, 2, now(), 'DEFAULT', 'FAILED', false, 1);
