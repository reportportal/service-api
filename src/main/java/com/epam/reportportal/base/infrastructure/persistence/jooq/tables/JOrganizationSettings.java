...
public class JOrganizationSettings extends TableImpl<JOrganizationSettingsRecord> {
   ...
   */
  public final TableField<JOrganizationSettingsRecord, Long> ID = createField(DSL.name("id"),
      SQLDataType.BIGINT.nullable(false).identity(true), this, "");

  /**
   * The column <code>public.organization_settings.organization_id</code>.
   */
  public final TableField<JOrganizationSettingsRecord, Long> ORGANIZATION_ID = createField(DSL.name("organization_id"),
      SQLDataType.BIGINT.nullable(false), this, "");

  /**
   * The column <code>public.organization_settings.setting_key</code>.
   */
  public final TableField<JOrganizationSettingsRecord, String> SETTING_KEY = createField(DSL.name("setting_key"),
      SQLDataType.VARCHAR(255).nullable(false), this, "");

  /**
   * The column <code>public.organization_settings.setting_value</code>.
   */
  public final TableField<JOrganizationSettingsRecord, String> SETTING_VALUE = createField(DSL.name("setting_value"),
  ...
  private JOrganizationSettings(Name alias, Table<JOrganizationSettingsRecord> aliased, Field<?>[] parameters,
      Condition where) {
    super(alias, null, aliased, parameters, DSL.comment(""), TableOptions.table(), where);
  }

  /**
   * Create an aliased <code>public.organization_settings</code> table reference
   */
