...
/**
 * Converter for ProjectIndexEvent to Activity.
 */
@Component
public class ProjectIndexEventConverter implements EventToActivityConverter<ProjectIndexEvent> {
  ...
  public Activity convert(ProjectIndexEvent event) {
    return new ActivityBuilder()
        ...
        .addPriority(event.isIndexing() ? EventPriority.LOW : EventPriority.MEDIUM)
  ...
  @Override
  public Class<ProjectIndexEvent> getEventClass() {
    return ProjectIndexEvent.class;
  }
}
