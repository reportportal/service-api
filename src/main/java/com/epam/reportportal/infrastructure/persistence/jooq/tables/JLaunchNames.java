...
public class JLaunchNames extends TableImpl<JLaunchNamesRecord> {
   ...
   */
  public final TableField<JLaunchNamesRecord, Long> SENDER_CASE_ID = createField(DSL.name("sender_case_id"),
      SQLDataType.BIGINT, this, "");

  /**
   * The column <code>public.launch_names.launch_name</code>.
   */
  public final TableField<JLaunchNamesRecord, String> LAUNCH_NAME = createField(DSL.name("launch_name"),
  ...
  public <O extends Record> JLaunchNames(Table<O> path, ForeignKey<O, JLaunchNamesRecord> childPath,
      InverseForeignKey<O, JLaunchNamesRecord> parentPath) {
  ...
  public static class JLaunchNamesPath extends JLaunchNames implements Path<JLaunchNamesRecord> {
    ...
    public <O extends Record> JLaunchNamesPath(Table<O> path, ForeignKey<O, JLaunchNamesRecord> childPath,
        InverseForeignKey<O, JLaunchNamesRecord> parentPath) {
