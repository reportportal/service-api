...
public class JItemTag extends TableImpl<JItemTagRecord> {
	 ...
	 */
	public final TableField<JItemTagRecord, Integer> ID = createField("id",
			org.jooq.impl.SQLDataType.INTEGER.nullable(false)
					.defaultValue(org.jooq.impl.DSL.field("nextval('item_tag_id_seq'::regclass)", org.jooq.impl.SQLDataType.INTEGER)),
			this,
			""
	);
