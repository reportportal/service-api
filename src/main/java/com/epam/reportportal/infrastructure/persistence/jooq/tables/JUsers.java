...
import com.epam.reportportal.infrastructure.persistence.jooq.tables.JApiKeys.JApiKeysPath;
import com.epam.reportportal.infrastructure.persistence.jooq.tables.JGroups.JGroupsPath;
import com.epam.reportportal.infrastructure.persistence.jooq.tables.JGroupsUsers.JGroupsUsersPath;
...
import com.epam.reportportal.infrastructure.persistence.jooq.tables.JOrganizationUser.JOrganizationUserPath;
...
import com.epam.reportportal.infrastructure.persistence.jooq.tables.JUserCreationBid.JUserCreationBidPath;
...
public class JUsers extends TableImpl<JUsersRecord> {
   ...
   */
  public final TableField<JUsersRecord, Long> ID = createField(DSL.name("id"),
      SQLDataType.BIGINT.nullable(false).identity(true), this, "");

  /**
   * The column <code>public.users.login</code>.
   */
  public final TableField<JUsersRecord, String> LOGIN = createField(DSL.name("login"),
   ...
   */
  public final TableField<JUsersRecord, String> EMAIL = createField(DSL.name("email"),
      SQLDataType.VARCHAR.nullable(false), this, "");

  /**
   * The column <code>public.users.attachment</code>.
   */
  public final TableField<JUsersRecord, String> ATTACHMENT = createField(DSL.name("attachment"), SQLDataType.VARCHAR,
      this, "");

  /**
   * The column <code>public.users.attachment_thumbnail</code>.
   */
  public final TableField<JUsersRecord, String> ATTACHMENT_THUMBNAIL = createField(DSL.name("attachment_thumbnail"),
      SQLDataType.VARCHAR, this, "");

  /**
   * The column <code>public.users.role</code>.
   */
  public final TableField<JUsersRecord, String> ROLE = createField(DSL.name("role"),
      SQLDataType.VARCHAR.nullable(false), this, "");

  /**
   * The column <code>public.users.type</code>.
   */
  public final TableField<JUsersRecord, String> TYPE = createField(DSL.name("type"),
      SQLDataType.VARCHAR.nullable(false), this, "");

  /**
   * The column <code>public.users.expired</code>.
   */
  public final TableField<JUsersRecord, Boolean> EXPIRED = createField(DSL.name("expired"),
      SQLDataType.BOOLEAN.nullable(false), this, "");

  /**
   * The column <code>public.users.full_name</code>.
   */
  public final TableField<JUsersRecord, String> FULL_NAME = createField(DSL.name("full_name"), SQLDataType.VARCHAR,
      this, "");
   ...
   */
  public final TableField<JUsersRecord, java.util.UUID> UUID = createField(DSL.name("uuid"),
      SQLDataType.UUID.nullable(false).defaultValue(DSL.field(DSL.raw("gen_random_uuid()"), SQLDataType.UUID)), this,
      "");

  /**
   * The column <code>public.users.external_id</code>.
   */
  public final TableField<JUsersRecord, String> EXTERNAL_ID = createField(DSL.name("external_id"), SQLDataType.VARCHAR,
      this, "");

  /**
   * The column <code>public.users.active</code>.
   */
  public final TableField<JUsersRecord, Boolean> ACTIVE = createField(DSL.name("active"),
   ...
   */
  public final TableField<JUsersRecord, String> LOGIN_BACKUP = createField(DSL.name("login_backup"),
      SQLDataType.VARCHAR(255).defaultValue(DSL.field(DSL.raw("NULL::character varying"), SQLDataType.VARCHAR)), this,
      "");

  /**
   * The column <code>public.users.created_at</code>.
   */
  public final TableField<JUsersRecord, Instant> CREATED_AT = createField(DSL.name("created_at"),
   ...
   */
  public final TableField<JUsersRecord, Instant> UPDATED_AT = createField(DSL.name("updated_at"),
      SQLDataType.LOCALDATETIME(6).nullable(false).defaultValue(DSL.field(DSL.raw("now()"), SQLDataType.LOCALDATETIME)),
      this, "", new JooqInstantConverter());
  ...
  public <O extends Record> JUsers(Table<O> path, ForeignKey<O, JUsersRecord> childPath,
      InverseForeignKey<O, JUsersRecord> parentPath) {
  ...
  public static class JUsersPath extends JUsers implements Path<JUsersRecord> {
    ...
    public <O extends Record> JUsersPath(Table<O> path, ForeignKey<O, JUsersRecord> childPath,
        InverseForeignKey<O, JUsersRecord> parentPath) {
  ...
  /**
   * Get the implicit to-many join path to the <code>public.api_keys</code> table
   */
  ...
  /**
   * Get the implicit to-many join path to the <code>public.groups</code> table
   */
  ...
  public JOrganizationUserPath organizationUser() {
    if (_organizationUser == null) {
      _organizationUser = new JOrganizationUserPath(this, null,
          Keys.ORGANIZATION_USER__ORGANIZATION_USER_USER_ID_FKEY.getInverseKey());
    }
  ...
  public JUserCreationBidPath userCreationBid() {
    if (_userCreationBid == null) {
      _userCreationBid = new JUserCreationBidPath(this, null,
          Keys.USER_CREATION_BID__USER_CREATION_BID_INVITING_USER_ID_FKEY.getInverseKey());
    }
  ...
  public JUserPreferencePath userPreference() {
    if (_userPreference == null) {
      _userPreference = new JUserPreferencePath(this, null,
          Keys.USER_PREFERENCE__USER_PREFERENCE_USER_ID_FKEY.getInverseKey());
    }
