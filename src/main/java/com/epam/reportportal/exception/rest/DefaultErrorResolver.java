...
import static com.epam.reportportal.exception.ExceptionMappings.MESSAGE_SOURCE;
import static com.epam.reportportal.infrastructure.rules.commons.validation.Suppliers.formattedMessage;
...
public class DefaultErrorResolver implements ErrorResolver {
   ...
   *
   * @see
   * com.epam.reportportal.ws.exception.ErrorResolver#resolveError(java
   * .lang.Exception)
   */
  @Override
