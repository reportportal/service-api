insert into launch (id, uuid, project_id, user_id, name, description, start_time, end_time, number, last_modified, mode, status, organization_id)
values (1, 'a7b66ef2-db30-4db7-94df-f5f7786b398a', 2, 2, 'test launch', 'desc', now(), null, 1, now(), 'DEFAULT', 'IN_PROGRESS', 1);
...
insert into launch (id, uuid, project_id, user_id, name, description, start_time, end_time, number, last_modified, mode, status, organization_id)
values (2, '45a80a5e-d73e-483a-a51f-43cc7f5111af', 2, 2, 'test launch 2', 'desc', now(), null, 1, now(), 'DEFAULT', 'FAILED', 1);
...
insert into launch (id, uuid, project_id, user_id, name, description, start_time, end_time, number, last_modified, mode, status, organization_id)
values (3, '334d153c-8f9c-4dff-8627-47dd003bee0f', 1, 1, 'test launch admin', 'desc', now(), null, 1, now(), 'DEFAULT', 'IN_PROGRESS', 1);
