...
/**
 * Wraps {@link HandlerMethodReturnValueHandler}. Checks if {@link ResponseView} annotation present, and if yes wraps
 * bean to be serialized with view mapped to it on controller's level class
 *
