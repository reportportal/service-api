...
/**
 * {@link org.springframework.web.bind.support.WebArgumentResolver} for ReportPortal User Roles. Will resolve
 * {@link UserRole} in case if method parameter annotated by {@link ActiveRole} annotation
 *
...
public class ActiveUserWebArgumentResolver implements HandlerMethodArgumentResolver {
  ...
  /**
   * Returns TRUE if method argument is {@link UserRole} and annotated by {@link ActiveRole} annotation
   */
  @Override
