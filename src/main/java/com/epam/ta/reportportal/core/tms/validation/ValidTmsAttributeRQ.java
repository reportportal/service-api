...
/**
 * Validation annotation to ensure that at either id or key for TmsAttributeRQ is provided.
 * <p>
 ...
 */
@Documented
@Constraint(validatedBy = TmsAttributeRQValidator.class)
@Target({ElementType.TYPE})
@Retention(RetentionPolicy.RUNTIME)
public @interface ValidTmsAttributeRQ {
