...
/**
 * Report Portal plugin descriptor. This class is used to describe the properties of a plugin in Report Portal. It
 * includes information such as the plugin ID, name, description, version, dependencies, and other metadata.
 *
