...
public class JOwnedEntity extends TableImpl<JOwnedEntityRecord> {
   ...
   */
  public final TableField<JOwnedEntityRecord, Boolean> LOCKED = createField(DSL.name("locked"),
  ...
  public <O extends Record> JOwnedEntity(Table<O> path, ForeignKey<O, JOwnedEntityRecord> childPath,
