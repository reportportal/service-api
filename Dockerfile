...
LABEL version="4.1.0-BETA-1"
LABEL description="EPAM Report portal. Main API Service"

ENV APP_FILE service-api-4.1.0-BETA-1
ENV APP_DOWNLOAD_URL https://dl.bintray.com/epam/reportportal/com/epam/reportportal/service-api/4.1.0-BETA-1/$APP_FILE.jar
