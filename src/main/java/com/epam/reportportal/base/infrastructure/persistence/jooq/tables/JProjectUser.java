...
public class JProjectUser extends TableImpl<JProjectUserRecord> {
     ...
     */
    public final TableField<JProjectUserRecord, Long> USER_ID = createField(DSL.name("user_id"), SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>public.project_user.project_id</code>.
     */
    public final TableField<JProjectUserRecord, Long> PROJECT_ID = createField(DSL.name("project_id"), SQLDataType.BIGINT.nullable(false), this, "");
    ...
    public <O extends Record> JProjectUser(Table<O> path, ForeignKey<O, JProjectUserRecord> childPath, InverseForeignKey<O, JProjectUserRecord> parentPath) {
    ...
    public static class JProjectUserPath extends JProjectUser implements Path<JProjectUserRecord> {
        ...
        private static final long serialVersionUID = 1L;
        public <O extends Record> JProjectUserPath(Table<O> path, ForeignKey<O, JProjectUserRecord> childPath, InverseForeignKey<O, JProjectUserRecord> parentPath) {
