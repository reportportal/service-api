...
package com.epam.reportportal.base.core.integration.util.validator;
...
public final class IntegrationValidator {
  ...
  /**
   * Validation fails if a project has at least one integration with the same type as the provided global integration
   * has
   *
