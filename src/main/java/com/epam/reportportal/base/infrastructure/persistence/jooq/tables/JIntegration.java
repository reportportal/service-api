...
public class JIntegration extends TableImpl<JIntegrationRecord> {
    ...
    /**
     * The column <code>public.integration.organization_id</code>.
     */
    public final TableField<JIntegrationRecord, Long> ORGANIZATION_ID = createField(DSL.name("organization_id"), SQLDataType.BIGINT, this, "");
    ...
    public List<ForeignKey<JIntegrationRecord, ?>> getReferences() {
        return Arrays.asList(Keys.INTEGRATION__INTEGRATION_ORGANIZATION_ID_FKEY, Keys.INTEGRATION__INTEGRATION_PROJECT_ID_FKEY, Keys.INTEGRATION__INTEGRATION_TYPE_FKEY);
    }
    ...
    public JOrganizationPath organization() {
        if (_organization == null)
            _organization = new JOrganizationPath(this, Keys.INTEGRATION__INTEGRATION_ORGANIZATION_ID_FKEY, null);
