...
public class JTestItemStructure extends TableImpl<JTestItemStructureRecord> {
	...
	private static final long serialVersionUID = 2096103006;
	 ...
	 */
	public final TableField<JTestItemStructureRecord, Long> ID = createField(
			"id",
			org.jooq.impl.SQLDataType.BIGINT.nullable(false)
					.defaultValue(org.jooq.impl.DSL.field(
							"nextval('test_item_structure_id_seq'::regclass)",
	 ...
	 */
	public final TableField<JTestItemStructureRecord, Long> ITEM_ID = createField("item_id", org.jooq.impl.SQLDataType.BIGINT, this, "");
	...
	public List<UniqueKey<JTestItemStructureRecord>> getKeys() {
		return Arrays.<UniqueKey<JTestItemStructureRecord>>asList(Keys.TEST_ITEM_STRUCTURE_PK, Keys.TEST_ITEM_STRUCTURE_ITEM_ID_KEY);
	}
	...
	public List<ForeignKey<JTestItemStructureRecord, ?>> getReferences() {
		return Arrays.<ForeignKey<JTestItemStructureRecord, ?>>asList(
				Keys.TEST_ITEM_STRUCTURE__TEST_ITEM_STRUCTURE_ITEM_ID_FKEY,
				Keys.TEST_ITEM_STRUCTURE__TEST_ITEM_STRUCTURE_LAUNCH_ID_FKEY,
				Keys.TEST_ITEM_STRUCTURE__TEST_ITEM_STRUCTURE_PARENT_ID_FKEY,
				Keys.TEST_ITEM_STRUCTURE__TEST_ITEM_STRUCTURE_RETRY_OF_FKEY
		);
	}
