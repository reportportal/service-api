...
/**
 * Converter for FilterDeletedEvent to Activity.
 */
@Component
public class FilterDeletedEventConverter implements EventToActivityConverter<FilterDeletedEvent> {
  ...
  @Override
  public Class<FilterDeletedEvent> getEventClass() {
    return FilterDeletedEvent.class;
  }
}
