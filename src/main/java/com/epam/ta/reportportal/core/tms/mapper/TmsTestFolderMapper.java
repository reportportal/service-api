...
public abstract class TmsTestFolderMapper {
  ...
  @Mapping(target = "subFolders", source = "tmsTestFolder.subFolders", qualifiedByName = "mapSubFolders")
  ...
  @Mapping(target = "subFolders", source = "tmsTestFolder.subFolders", qualifiedByName = "mapSubFolders")
  @Mapping(target = "parentFolderId", source = "tmsTestFolder.parentTestFolder.id")
  public abstract TmsTestFolderRS convertFromTmsTestFolderWithCountOfTestCasesToRS(TmsTestFolder tmsTestFolder,
  ...
  private List<TmsTestFolderRS> convert(
    ...
    return testFoldersWithCountOfTestCases
        .stream()
        .map((TmsTestFolderWithCountOfTestCases t) -> convertFromTmsTestFolderWithCountOfTestCasesToRS(t, testCaseCountForSubfolders))
        .toList();
  }
