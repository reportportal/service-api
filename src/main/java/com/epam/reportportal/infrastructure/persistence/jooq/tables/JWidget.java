...
import com.epam.reportportal.infrastructure.persistence.jooq.tables.JContentField.JContentFieldPath;
import com.epam.reportportal.infrastructure.persistence.jooq.tables.JDashboard.JDashboardPath;
...
public class JWidget extends TableImpl<JWidgetRecord> {
   ...
   */
  public final TableField<JWidgetRecord, Long> ID = createField(DSL.name("id"), SQLDataType.BIGINT.nullable(false),
      this, "");

  /**
   * The column <code>public.widget.name</code>.
   */
  public final TableField<JWidgetRecord, String> NAME = createField(DSL.name("name"),
      SQLDataType.VARCHAR.nullable(false), this, "");

  /**
   * The column <code>public.widget.description</code>.
   */
  public final TableField<JWidgetRecord, String> DESCRIPTION = createField(DSL.name("description"), SQLDataType.VARCHAR,
      this, "");

  /**
   * The column <code>public.widget.widget_type</code>.
   */
  public final TableField<JWidgetRecord, String> WIDGET_TYPE = createField(DSL.name("widget_type"),
      SQLDataType.VARCHAR.nullable(false), this, "");

  /**
   * The column <code>public.widget.items_count</code>.
   */
  public final TableField<JWidgetRecord, Short> ITEMS_COUNT = createField(DSL.name("items_count"), SQLDataType.SMALLINT,
      this, "");

  /**
   * The column <code>public.widget.widget_options</code>.
   */
  public final TableField<JWidgetRecord, JSONB> WIDGET_OPTIONS = createField(DSL.name("widget_options"),
  ...
  public <O extends Record> JWidget(Table<O> path, ForeignKey<O, JWidgetRecord> childPath,
      InverseForeignKey<O, JWidgetRecord> parentPath) {
  ...
  public static class JWidgetPath extends JWidget implements Path<JWidgetRecord> {
    ...
    public <O extends Record> JWidgetPath(Table<O> path, ForeignKey<O, JWidgetRecord> childPath,
        InverseForeignKey<O, JWidgetRecord> parentPath) {
  ...
  public JWidgetFilterPath widgetFilter() {
    if (_widgetFilter == null) {
      _widgetFilter = new JWidgetFilterPath(this, null,
          Keys.WIDGET_FILTER__WIDGET_FILTER_WIDGET_ID_FKEY.getInverseKey());
    }
  ...
  /**
   * Get the implicit many-to-many join path to the <code>public.filter</code> table
   */
