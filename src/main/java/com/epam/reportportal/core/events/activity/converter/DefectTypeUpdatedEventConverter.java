...
/**
 * Converter for DefectTypeUpdatedEvent to Activity.
 */
@Component
public class DefectTypeUpdatedEventConverter implements
    EventToActivityConverter<DefectTypeUpdatedEvent> {
  ...
  @Override
  public Class<DefectTypeUpdatedEvent> getEventClass() {
    return DefectTypeUpdatedEvent.class;
  }
}
