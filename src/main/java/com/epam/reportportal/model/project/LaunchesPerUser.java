...
/**
 * Basic representation of launches information per user for specified project<br> Current view is:<br> String:user_id :
 * {String:fullname, Integer:launchesCount}<br>
 *
