...
public class FileExtensionUtils {
  ...
  /**
   * Determines the appropriate file extension based on content type. If the filename already has an extension, it
   * returns the filename as is. If no extension is found for the content type, it returns the filename as is.
   *
