        ...
        <tr>
          <td height="130">
            <img class="mainimg" src="cid:create-user.png" border="0" width="540" height="130"
                 alt="You’ve been invited to join Report Portal">
          </td>
        </tr>
        </tbody>
      </table>
      <table width="100%" border="0" cellspacing="0" cellpadding="30" class="contentwrapper"
        ...
        <tr>
          <td align="left" height="170">
            <h2 style="font-size: 20px; color: #777777;" align="center">Welcome to Report
              Portal!</h2>
            <p style="font-size: 14px; color: #777777;">You’ve been invited to join Report
              Portal.</p>
            ...
            <p style="font-size: 14px; color: #777777;">New to Report Portal? Check out all the
              details in the <a
                  href="http://reportportal.io/#documentation/User-Guide" target="_blank">User
                Guide</a>.</p>
            <br>
          ...
          <td height="82" align="center">
            <table border="0" cellspacing="0" cellpadding="12" class="linksline" align="center">
              ...
              <tr>
                ...
                <td><a href="https://github.com/reportportal" target="_blank"><img
                        src="cid:ic-github.png" border="0"
                        width="20" height="21" alt="github"></a>
                </td>
                <td><a href="https://www.facebook.com/ReportPortal.io" target="_blank"><img
                        src="cid:ic-fb.png" border="0"
                        width="18" height="18"
                        alt="facebook"></a></td>
                <td><a href="http://twitter.com/ReportPortal_io" target="_blank"><img
                        src="cid:ic-twitter.png" border="0"
                        width="20" height="16" alt="twitter"></a>
                </td>
                <td><a href="http://youtube.com/c/ReportPortalCommunity" target="_blank"><img
                        src="cid:ic-youtube.png"
                        border="0" width="20"
                        height="15" alt="youtube"></a>
                </td>
                <td><a href="https://vk.com/reportportal_io" target="_blank"><img
                        src="cid:ic-vk.png" border="0" width="21"
                        height="12" alt="vk"></a></td>
                <td><a href="https://reportportal-slack-auto.herokuapp.com" target="_blank"><img
                        src="cid:ic-slack.png"
                        border="0" width="18"
                        height="18"
                        alt="slack"></a></td>
              </tr>
