...
import com.epam.reportportal.infrastructure.persistence.jooq.tables.JFilterCondition.JFilterConditionPath;
import com.epam.reportportal.infrastructure.persistence.jooq.tables.JFilterSort.JFilterSortPath;
...
import com.epam.reportportal.infrastructure.persistence.jooq.tables.JWidgetFilter.JWidgetFilterPath;
...
public class JFilter extends TableImpl<JFilterRecord> {
   ...
   */
  public final TableField<JFilterRecord, Long> ID = createField(DSL.name("id"), SQLDataType.BIGINT.nullable(false),
      this, "");

  /**
   * The column <code>public.filter.name</code>.
   */
  public final TableField<JFilterRecord, String> NAME = createField(DSL.name("name"),
      SQLDataType.VARCHAR.nullable(false), this, "");

  /**
   * The column <code>public.filter.target</code>.
   */
  public final TableField<JFilterRecord, String> TARGET = createField(DSL.name("target"),
      SQLDataType.VARCHAR.nullable(false), this, "");

  /**
   * The column <code>public.filter.description</code>.
   */
  public final TableField<JFilterRecord, String> DESCRIPTION = createField(DSL.name("description"), SQLDataType.VARCHAR,
      this, "");
  ...
  public <O extends Record> JFilter(Table<O> path, ForeignKey<O, JFilterRecord> childPath,
      InverseForeignKey<O, JFilterRecord> parentPath) {
  ...
  public static class JFilterPath extends JFilter implements Path<JFilterRecord> {
    ...
    public <O extends Record> JFilterPath(Table<O> path, ForeignKey<O, JFilterRecord> childPath,
        InverseForeignKey<O, JFilterRecord> parentPath) {
  ...
  public JFilterConditionPath filterCondition() {
    if (_filterCondition == null) {
      _filterCondition = new JFilterConditionPath(this, null,
          Keys.FILTER_CONDITION__FILTER_CONDITION_FILTER_ID_FKEY.getInverseKey());
    }
  ...
  /**
   * Get the implicit to-many join path to the <code>public.filter_sort</code> table
   */
  ...
  public JUserPreferencePath userPreference() {
    if (_userPreference == null) {
      _userPreference = new JUserPreferencePath(this, null,
          Keys.USER_PREFERENCE__USER_PREFERENCE_FILTER_ID_FKEY.getInverseKey());
    }
  ...
  public JWidgetFilterPath widgetFilter() {
    if (_widgetFilter == null) {
      _widgetFilter = new JWidgetFilterPath(this, null,
          Keys.WIDGET_FILTER__WIDGET_FILTER_FILTER_ID_FKEY.getInverseKey());
    }
