...
public interface RerunHandler {
  ...
  /**
   * Retrieves the UUID of the launch to be rerun based on the provided rerun information, launch name, and project ID.
   *
   * @param rerunOf    The UUID of a specific launch to rerun (optional). If provided, this value is returned directly.
   * @param launchName The name of the launch to find the latest matching launch if `rerunOf` is not provided.
   * @param projectId  The ID of the project in which to find the launch.
   * @return The UUID of the launch to be rerun.
   * @throws ReportPortalException If no matching launch can be found when `rerunOf` is not provided.
   */
