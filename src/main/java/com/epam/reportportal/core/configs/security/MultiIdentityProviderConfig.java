...
import static com.epam.reportportal.core.configs.security.UserResolverType.EXTERNAL;

import com.epam.reportportal.auth.userdetails.DefaultUserDetailsService;
import com.epam.reportportal.auth.userdetails.ExternalUserDetailsService;
import com.epam.reportportal.core.configs.security.converters.ExternalJwtConverter;
import com.epam.reportportal.core.configs.security.converters.ReportPortalJwtConverter;
