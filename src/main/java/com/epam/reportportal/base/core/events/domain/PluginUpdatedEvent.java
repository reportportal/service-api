...
/**
 * Event published when a plugin is updated by a user or reloaded by the system. Use {@link #isSystemEvent()} to
 * distinguish between user-initiated updates (activity audit required) and system lifecycle reloads (no audit).
 */
@Getter
@NoArgsConstructor
