...
public class JDashboardWidgetRecord extends UpdatableRecordImpl<JDashboardWidgetRecord>
		implements Record7<Integer, Integer, String, Integer, Integer, Integer, Integer> {

	private static final long serialVersionUID = -1535685131;
	 ...
	 */
	@Override
	public JDashboardWidgetRecord values(Integer value1, Integer value2, String value3, Integer value4, Integer value5, Integer value6,
			Integer value7) {
		value1(value1);
		value2(value2);
		value3(value3);
	 ...
	 */
	public JDashboardWidgetRecord(Integer dashboardId, Integer widgetId, String widgetName, Integer wdigetWidth, Integer widgetHeigth,
