...
package com.epam.reportportal.core.preference.impl;

import com.epam.reportportal.core.preference.UpdatePreferenceHandler;
...
import com.epam.reportportal.ws.converter.builders.UserPreferenceBuilder;
import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.stereotype.Service;

/**
 * Default implementation of {@link com.epam.reportportal.core.preference.UpdatePreferenceHandler}
 *
...
public class UpdatePreferenceHandlerImpl implements UpdatePreferenceHandler {
  ...
  @Override
  public OperationCompletionRS addPreference(MembershipDetails membershipDetails, ReportPortalUser user,
      Long filterId) {

    if (userPreferenceRepository.findByProjectIdAndUserIdAndFilterId(membershipDetails.getProjectId(), user.getUserId(),
            filterId)
        .isPresent()) {
  ...
  @Override
  public OperationCompletionRS removePreference(MembershipDetails membershipDetails, ReportPortalUser user,
      Long filterId) {
