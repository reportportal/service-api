...
public class Keys {
    ...
    public static final Identity<JIssueRecord, Long> IDENTITY_ISSUE = Identities0.IDENTITY_ISSUE;
    ...
    public static final Identity<JTestItemResultsRecord, Long> IDENTITY_TEST_ITEM_RESULTS = Identities0.IDENTITY_TEST_ITEM_RESULTS;
    ...
    public static final UniqueKey<JIssueRecord> ISSUE_TEST_ITEM_RESULTS_ID_KEY = UniqueKeys0.ISSUE_TEST_ITEM_RESULTS_ID_KEY;
    ...
    public static final UniqueKey<JTestItemResultsRecord> TEST_ITEM_RESULTS_ITEM_ID_KEY = UniqueKeys0.TEST_ITEM_RESULTS_ITEM_ID_KEY;
    public static final UniqueKey<JTestItemStructureRecord> TEST_ITEM_STRUCTURE_PK = UniqueKeys0.TEST_ITEM_STRUCTURE_PK;
    public static final UniqueKey<JTestItemStructureRecord> TEST_ITEM_STRUCTURE_ITEM_ID_KEY = UniqueKeys0.TEST_ITEM_STRUCTURE_ITEM_ID_KEY;
    ...
    public static final ForeignKey<JIssueRecord, JTestItemResultsRecord> ISSUE__ISSUE_TEST_ITEM_RESULTS_ID_FKEY = ForeignKeys0.ISSUE__ISSUE_TEST_ITEM_RESULTS_ID_FKEY;
    ...
    private static class Identities0 {
        public static Identity<JBugTrackingSystemRecord, Integer> IDENTITY_BUG_TRACKING_SYSTEM = Internal.createIdentity(
                JBugTrackingSystem.BUG_TRACKING_SYSTEM,
                JBugTrackingSystem.BUG_TRACKING_SYSTEM.ID
        );
        public static Identity<JDashboardRecord, Integer> IDENTITY_DASHBOARD = Internal.createIdentity(
                JDashboard.DASHBOARD,
                JDashboard.DASHBOARD.ID
        );
        public static Identity<JDefectFieldAllowedValueRecord, Integer> IDENTITY_DEFECT_FIELD_ALLOWED_VALUE = Internal.createIdentity(
                JDefectFieldAllowedValue.DEFECT_FIELD_ALLOWED_VALUE,
                JDefectFieldAllowedValue.DEFECT_FIELD_ALLOWED_VALUE.ID
        );
        public static Identity<JDefectFormFieldRecord, Integer> IDENTITY_DEFECT_FORM_FIELD = Internal.createIdentity(
                JDefectFormField.DEFECT_FORM_FIELD,
                JDefectFormField.DEFECT_FORM_FIELD.ID
        );
        public static Identity<JIssueRecord, Long> IDENTITY_ISSUE = Internal.createIdentity(JIssue.ISSUE, JIssue.ISSUE.ID);
        public static Identity<JIssueTypeRecord, Integer> IDENTITY_ISSUE_TYPE = Internal.createIdentity(
        ...
        public static Identity<JProjectConfigurationRecord, Integer> IDENTITY_PROJECT_CONFIGURATION = Internal.createIdentity(
                JProjectConfiguration.PROJECT_CONFIGURATION,
                JProjectConfiguration.PROJECT_CONFIGURATION.ID
        );
        public static Identity<JProjectEmailConfigurationRecord, Integer> IDENTITY_PROJECT_EMAIL_CONFIGURATION = Internal.createIdentity(
                JProjectEmailConfiguration.PROJECT_EMAIL_CONFIGURATION,
                JProjectEmailConfiguration.PROJECT_EMAIL_CONFIGURATION.ID
        );
        public static Identity<JServerSettingsRecord, Short> IDENTITY_SERVER_SETTINGS = Internal.createIdentity(
                JServerSettings.SERVER_SETTINGS,
                JServerSettings.SERVER_SETTINGS.ID
        );
        public static Identity<JTestItemRecord, Long> IDENTITY_TEST_ITEM = Internal.createIdentity(
                JTestItem.TEST_ITEM,
                JTestItem.TEST_ITEM.ID
        );
        public static Identity<JTestItemResultsRecord, Long> IDENTITY_TEST_ITEM_RESULTS = Internal.createIdentity(
                JTestItemResults.TEST_ITEM_RESULTS,
                JTestItemResults.TEST_ITEM_RESULTS.ID
        );
        public static Identity<JTestItemStructureRecord, Long> IDENTITY_TEST_ITEM_STRUCTURE = Internal.createIdentity(
                ...
                JTestItemStructure.TEST_ITEM_STRUCTURE.ID
        );
    ...
    private static class UniqueKeys0 {
        public static final UniqueKey<JBugTrackingSystemRecord> BUG_TRACKING_SYSTEM_PK = Internal.createUniqueKey(
                JBugTrackingSystem.BUG_TRACKING_SYSTEM,
                "bug_tracking_system_pk",
                JBugTrackingSystem.BUG_TRACKING_SYSTEM.ID
        );
        public static final UniqueKey<JDashboardRecord> DASHBOARD_PK = Internal.createUniqueKey(
                JDashboard.DASHBOARD,
                "dashboard_pk",
                JDashboard.DASHBOARD.ID
        );
        public static final UniqueKey<JDashboardRecord> UNQ_NAME_PROJECT = Internal.createUniqueKey(
                JDashboard.DASHBOARD,
                "unq_name_project",
        ...
        public static final UniqueKey<JDefectFormFieldRecord> DEFECT_FORM_FIELD_PK = Internal.createUniqueKey(
                JDefectFormField.DEFECT_FORM_FIELD,
                "defect_form_field_pk",
                JDefectFormField.DEFECT_FORM_FIELD.ID
        );
        public static final UniqueKey<JIssueRecord> ISSUE_PK = Internal.createUniqueKey(JIssue.ISSUE, "issue_pk", JIssue.ISSUE.ID);
        public static final UniqueKey<JIssueRecord> ISSUE_TEST_ITEM_RESULTS_ID_KEY = Internal.createUniqueKey(
                JIssue.ISSUE,
                "issue_test_item_results_id_key",
                JIssue.ISSUE.TEST_ITEM_RESULTS_ID
        );
        ...
        public static final UniqueKey<JItemTagRecord> ITEM_TAG_PK = Internal.createUniqueKey(
                JItemTag.ITEM_TAG,
                "item_tag_pk",
                JItemTag.ITEM_TAG.ID
        );
        ...
        public static final UniqueKey<JOauthAccessTokenRecord> ACCESS_TOKENS_PK = Internal.createUniqueKey(
        ...
        public static final UniqueKey<JProjectRecord> PROJECT_PROJECT_CONFIGURATION_ID_KEY = Internal.createUniqueKey(
                JProject.PROJECT,
                "project_project_configuration_id_key",
                JProject.PROJECT.PROJECT_CONFIGURATION_ID
        );
        public static final UniqueKey<JProjectConfigurationRecord> PROJECT_CONFIGURATION_PK = Internal.createUniqueKey(
                JProjectConfiguration.PROJECT_CONFIGURATION,
                "project_configuration_pk",
                JProjectConfiguration.PROJECT_CONFIGURATION.ID
        );
        public static final UniqueKey<JProjectConfigurationRecord> PROJECT_CONFIGURATION_EMAIL_CONFIGURATION_ID_KEY = Internal.createUniqueKey(
                JProjectConfiguration.PROJECT_CONFIGURATION,
                "project_configuration_email_configuration_id_key",
                JProjectConfiguration.PROJECT_CONFIGURATION.EMAIL_CONFIGURATION_ID
        );
        public static final UniqueKey<JProjectEmailConfigurationRecord> PROJECT_EMAIL_CONFIGURATION_PK = Internal.createUniqueKey(
                JProjectEmailConfiguration.PROJECT_EMAIL_CONFIGURATION,
        ...
        public static final UniqueKey<JTestItemResultsRecord> TEST_ITEM_RESULTS_ITEM_ID_KEY = Internal.createUniqueKey(
                JTestItemResults.TEST_ITEM_RESULTS,
                "test_item_results_item_id_key",
                JTestItemResults.TEST_ITEM_RESULTS.ITEM_ID
        );
        ...
        public static final UniqueKey<JTestItemStructureRecord> TEST_ITEM_STRUCTURE_ITEM_ID_KEY = Internal.createUniqueKey(
                JTestItemStructure.TEST_ITEM_STRUCTURE,
    ...
    private static class ForeignKeys0 {
        public static final ForeignKey<JDashboardRecord, JProjectRecord> DASHBOARD__DASHBOARD_PROJECT_ID_FKEY = Internal.createForeignKey(
                com.epam.ta.reportportal.store.jooq.Keys.PROJECT_PK,
                JDashboard.DASHBOARD,
        ...
        public static final ForeignKey<JDashboardWidgetRecord, JDashboardRecord> DASHBOARD_WIDGET__DASHBOARD_WIDGET_DASHBOARD_ID_FKEY = Internal
                .createForeignKey(com.epam.ta.reportportal.store.jooq.Keys.DASHBOARD_PK,
                        JDashboardWidget.DASHBOARD_WIDGET,
        ...
        public static final ForeignKey<JDashboardWidgetRecord, JWidgetRecord> DASHBOARD_WIDGET__DASHBOARD_WIDGET_WIDGET_ID_FKEY = Internal.createForeignKey(
                com.epam.ta.reportportal.store.jooq.Keys.WIDGET_ID,
                JDashboardWidget.DASHBOARD_WIDGET,
        ...
        public static final ForeignKey<JDefectFieldAllowedValueRecord, JDefectFormFieldRecord> DEFECT_FIELD_ALLOWED_VALUE__DEFECT_FIELD_ALLOWED_VALUE_DEFECT_FORM_FIELD_FKEY = Internal
                .createForeignKey(com.epam.ta.reportportal.store.jooq.Keys.DEFECT_FORM_FIELD_PK,
                        JDefectFieldAllowedValue.DEFECT_FIELD_ALLOWED_VALUE,
        ...
        public static final ForeignKey<JDefectFormFieldRecord, JBugTrackingSystemRecord> DEFECT_FORM_FIELD__DEFECT_FORM_FIELD_BUGTRACKING_SYSTEM_FKEY = Internal
                .createForeignKey(com.epam.ta.reportportal.store.jooq.Keys.BUG_TRACKING_SYSTEM_PK,
                        JDefectFormField.DEFECT_FORM_FIELD,
                        "defect_form_field__defect_form_field_bugtracking_system_fkey",
        ...
        public static final ForeignKey<JIssueRecord, JIssueTypeRecord> ISSUE__ISSUE_ISSUE_TYPE_FKEY = Internal.createForeignKey(
                com.epam.ta.reportportal.store.jooq.Keys.ISSUE_TYPE_PK,
                JIssue.ISSUE,
                "issue__issue_issue_type_fkey",
                JIssue.ISSUE.ISSUE_TYPE
        );
        public static final ForeignKey<JIssueRecord, JTestItemResultsRecord> ISSUE__ISSUE_TEST_ITEM_RESULTS_ID_FKEY = Internal.createForeignKey(
                com.epam.ta.reportportal.store.jooq.Keys.TEST_ITEM_RESULTS_PK,
                JIssue.ISSUE,
                "issue__issue_test_item_results_id_fkey",
                JIssue.ISSUE.TEST_ITEM_RESULTS_ID
        );
        public static final ForeignKey<JIssueTicketRecord, JIssueRecord> ISSUE_TICKET__ISSUE_TICKET_ISSUE_ID_FKEY = Internal.createForeignKey(
                com.epam.ta.reportportal.store.jooq.Keys.ISSUE_PK,
                JIssueTicket.ISSUE_TICKET,
        ...
        public static final ForeignKey<JIssueTicketRecord, JTicketRecord> ISSUE_TICKET__ISSUE_TICKET_TICKET_ID_FKEY = Internal.createForeignKey(
                com.epam.ta.reportportal.store.jooq.Keys.TICKET_PK,
                JIssueTicket.ISSUE_TICKET,
        ...
        public static final ForeignKey<JItemTagRecord, JTestItemRecord> ITEM_TAG__ITEM_TAG_ITEM_ID_FKEY = Internal.createForeignKey(
                com.epam.ta.reportportal.store.jooq.Keys.TEST_ITEM_PK,
                JItemTag.ITEM_TAG,
        ...
        public static final ForeignKey<JLaunchRecord, JUsersRecord> LAUNCH__LAUNCH_USER_ID_FKEY = Internal.createForeignKey(
                com.epam.ta.reportportal.store.jooq.Keys.USERS_PK,
                JLaunch.LAUNCH,
        ...
        public static final ForeignKey<JLaunchTagRecord, JLaunchRecord> LAUNCH_TAG__LAUNCH_TAG_LAUNCH_ID_FKEY = Internal.createForeignKey(
                com.epam.ta.reportportal.store.jooq.Keys.LAUNCH_PK,
                JLaunchTag.LAUNCH_TAG,
        ...
        public static final ForeignKey<JOauthAccessTokenRecord, JUsersRecord> OAUTH_ACCESS_TOKEN__OAUTH_ACCESS_TOKEN_USER_ID_FKEY = Internal
                .createForeignKey(com.epam.ta.reportportal.store.jooq.Keys.USERS_PK,
                        JOauthAccessToken.OAUTH_ACCESS_TOKEN,
        ...
        public static final ForeignKey<JOauthRegistrationScopeRecord, JOauthRegistrationRecord> OAUTH_REGISTRATION_SCOPE__OAUTH_REGISTRATION_SCOPE_OAUTH_REGISTRATION_FK_FKEY = Internal
                .createForeignKey(com.epam.ta.reportportal.store.jooq.Keys.OAUTH_REGISTRATION_PKEY,
                        JOauthRegistrationScope.OAUTH_REGISTRATION_SCOPE,
        ...
        public static final ForeignKey<JProjectRecord, JProjectConfigurationRecord> PROJECT__PROJECT_PROJECT_CONFIGURATION_ID_FKEY = Internal
                .createForeignKey(com.epam.ta.reportportal.store.jooq.Keys.PROJECT_CONFIGURATION_PK,
                        JProject.PROJECT,
                        "project__project_project_configuration_id_fkey",
                        JProject.PROJECT.PROJECT_CONFIGURATION_ID
                );
        public static final ForeignKey<JProjectConfigurationRecord, JProjectEmailConfigurationRecord> PROJECT_CONFIGURATION__PROJECT_CONFIGURATION_EMAIL_CONFIGURATION_ID_FKEY = Internal
                .createForeignKey(com.epam.ta.reportportal.store.jooq.Keys.PROJECT_EMAIL_CONFIGURATION_PK,
                        JProjectConfiguration.PROJECT_CONFIGURATION,
        ...
        public static final ForeignKey<JTestItemResultsRecord, JTestItemRecord> TEST_ITEM_RESULTS__TEST_ITEM_RESULTS_ITEM_ID_FKEY = Internal
                .createForeignKey(com.epam.ta.reportportal.store.jooq.Keys.TEST_ITEM_PK,
                        JTestItemResults.TEST_ITEM_RESULTS,
                        "test_item_results__test_item_results_item_id_fkey",
                        JTestItemResults.TEST_ITEM_RESULTS.ITEM_ID
                );
        public static final ForeignKey<JTestItemStructureRecord, JTestItemRecord> TEST_ITEM_STRUCTURE__TEST_ITEM_STRUCTURE_ITEM_ID_FKEY = Internal
                .createForeignKey(com.epam.ta.reportportal.store.jooq.Keys.TEST_ITEM_PK,
                        JTestItemStructure.TEST_ITEM_STRUCTURE,
        ...
        public static final ForeignKey<JTestItemStructureRecord, JLaunchRecord> TEST_ITEM_STRUCTURE__TEST_ITEM_STRUCTURE_LAUNCH_ID_FKEY = Internal
                .createForeignKey(com.epam.ta.reportportal.store.jooq.Keys.LAUNCH_PK,
                        JTestItemStructure.TEST_ITEM_STRUCTURE,
                        "test_item_structure__test_item_structure_launch_id_fkey",
                        JTestItemStructure.TEST_ITEM_STRUCTURE.LAUNCH_ID
                );
        public static final ForeignKey<JTestItemStructureRecord, JTestItemStructureRecord> TEST_ITEM_STRUCTURE__TEST_ITEM_STRUCTURE_PARENT_ID_FKEY = Internal
                .createForeignKey(com.epam.ta.reportportal.store.jooq.Keys.TEST_ITEM_STRUCTURE_PK,
                        JTestItemStructure.TEST_ITEM_STRUCTURE,
                        "test_item_structure__test_item_structure_parent_id_fkey",
                        JTestItemStructure.TEST_ITEM_STRUCTURE.PARENT_ID
                );
        public static final ForeignKey<JTestItemStructureRecord, JTestItemStructureRecord> TEST_ITEM_STRUCTURE__TEST_ITEM_STRUCTURE_RETRY_OF_FKEY = Internal
                .createForeignKey(com.epam.ta.reportportal.store.jooq.Keys.TEST_ITEM_STRUCTURE_PK,
                        JTestItemStructure.TEST_ITEM_STRUCTURE,
                        "test_item_structure__test_item_structure_retry_of_fkey",
                        JTestItemStructure.TEST_ITEM_STRUCTURE.RETRY_OF
                );
        ...
        public static final ForeignKey<JTicketRecord, JBugTrackingSystemRecord> TICKET__TICKET_BTS_ID_FKEY = Internal.createForeignKey(
                com.epam.ta.reportportal.store.jooq.Keys.BUG_TRACKING_SYSTEM_PK,
                JTicket.TICKET,
