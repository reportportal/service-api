...
import static com.epam.reportportal.infrastructure.persistence.commons.querygen.Condition.UNDR;
...
import static com.epam.reportportal.util.ControllerUtils.findByFileName;
import static com.epam.reportportal.util.ControllerUtils.getUploadedFiles;
import static com.epam.reportportal.util.ControllerUtils.validateSaveRQ;
import static com.epam.reportportal.ws.resolver.FilterCriteriaResolver.DEFAULT_FILTER_PREFIX;
import static org.springframework.http.HttpStatus.CREATED;
import static org.springframework.http.HttpStatus.OK;

import com.epam.reportportal.core.analyzer.auto.SearchLogService;
import com.epam.reportportal.core.log.CreateLogHandler;
import com.epam.reportportal.core.log.DeleteLogHandler;
import com.epam.reportportal.core.log.GetLogHandler;
import com.epam.reportportal.core.log.impl.PagedLogResource;
...
import com.epam.reportportal.model.log.GetLogsUnderRq;
import com.epam.reportportal.model.log.LogResource;
import com.epam.reportportal.model.log.SearchLogRq;
import com.epam.reportportal.model.log.SearchLogRs;
import com.epam.reportportal.reporting.BatchElementCreatedRS;
import com.epam.reportportal.reporting.BatchSaveOperatingRS;
import com.epam.reportportal.reporting.Constants;
...
import com.epam.reportportal.ws.resolver.SortFor;
...
public class LogController {
  ...
  /**
   * @deprecated in favour of {@link LogController#createLogEntry(String, SaveLogRQ, ReportPortalUser)} because of
   * mapping collisions
   */
  /* Report client API */
  @Deprecated
  ...
  public Page<LogResource> getLogs(@PathVariable String projectKey,
  ...
  /**
   * @deprecated Need to remove in version 6.0. This API significantly impacts database performance - high IO operations
   * on getting log record by UUID from production-like database amount.
   */
  ...
  @Transactional(readOnly = true)
  @PreAuthorize(ALLOWED_TO_VIEW_PROJECT)
  public Page<?> getNestedItems(@PathVariable String projectKey, @PathVariable Long parentId,
  ...
  @Transactional(readOnly = true)
  public Page<PagedLogResource> getLogsWithLocationBySearch(@PathVariable String projectKey,
      @PathVariable Long parentId, @RequestParam Map<String, String> params,
      @FilterFor(Log.class) Filter filter, @SortFor(Log.class) Pageable pageable,
      @AuthenticationPrincipal ReportPortalUser user) {
