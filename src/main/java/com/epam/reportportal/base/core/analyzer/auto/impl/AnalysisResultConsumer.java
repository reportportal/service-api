...
/**
 * Listens to the analyzer reply queue and delegates every incoming batch of {@link AnalyzedItemRs} to
 * {@link AnalysisResultHandler}. The analyzer instance name is read from the AMQP {@code app_id} property when
 * present.
 *
