...
public class LaunchExportService {
   ...
   * @param flatAttachments if {@code true}, all attachments are placed in a flat {@code attachments/} directory named
   *                        {@code <id>_<name>.ext}; if {@code false}, attachments are organized in a hierarchical
   *                        directory structure
