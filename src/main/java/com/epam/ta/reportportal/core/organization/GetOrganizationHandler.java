...
public interface GetOrganizationHandler {
   ...
   */
  OrganizationProfile getResource(Long organizationId, ReportPortalUser user);
   ...
   * projects
   */
  Iterable<OrganizationProfile> getOrganizations(Queryable filter, Pageable pageable);
