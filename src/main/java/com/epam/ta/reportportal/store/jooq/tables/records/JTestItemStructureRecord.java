...
public class JTestItemStructureRecord extends UpdatableRecordImpl<JTestItemStructureRecord> implements Record3<Long, Long, Long> {

    private static final long serialVersionUID = 1743434480;
     ...
     */
    @Override
    public JTestItemStructureRecord values(Long value1, Long value2, Long value3) {
        value1(value1);
        value2(value2);
        value3(value3);
        return this;
     ...
     */
    public JTestItemStructureRecord(Long itemId, Long parentId, Long retryOf) {
        super(JTestItemStructure.TEST_ITEM_STRUCTURE);
