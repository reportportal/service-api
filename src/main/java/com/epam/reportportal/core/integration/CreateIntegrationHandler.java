...
package com.epam.reportportal.core.integration;
...
public interface CreateIntegrationHandler {
  ...
  /**
   * Create {@link Integration} for {@link com.epam.reportportal.infrastructure.persistence.entity.project.Project} with
   * provided ID
   *
  ...
  /**
   * Updated {@link Integration} for {@link com.epam.reportportal.infrastructure.persistence.entity.project.Project}
   * with provided ID
   *
   * @param id            {@link Integration#id}
   * @param projectName   Project name
