...
package com.epam.reportportal.core.activity.impl;
...
import static com.epam.reportportal.infrastructure.rules.exception.ErrorType.ACTIVITY_NOT_FOUND;
...
import com.epam.reportportal.core.activity.ActivityHandler;
...
import com.epam.reportportal.ws.converter.converters.ActivityConverter;
import com.epam.reportportal.ws.converter.converters.ActivityEventConverter;
...
public class ActivityHandlerImpl implements ActivityHandler {
  ...
  @Override
  public com.epam.reportportal.model.Page<ActivityEventResource> getItemActivities(
   ...
   * @return {@link Filter} with {@link EventAction#MATCH}, {@link EventObject#PATTERN} search conditions
   */
