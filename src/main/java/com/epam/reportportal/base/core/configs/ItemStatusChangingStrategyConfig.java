...
import com.epam.reportportal.base.core.item.impl.status.ToFailedStatusChangingStrategy;
import com.epam.reportportal.base.core.item.impl.status.ToPassedStatusChangingStrategy;
import com.epam.reportportal.base.core.item.impl.status.ToSkippedStatusChangingStrategy;
...
/**
 * Wires test item status changing strategies and handler.
 *
