...
import static com.epam.reportportal.core.events.activity.util.ActivityDetailsUtil.ATTRIBUTES_OPERATOR;
...
import static com.epam.reportportal.core.events.activity.util.ActivityDetailsUtil.LAUNCH_NAMES;
import static com.epam.reportportal.core.events.activity.util.ActivityDetailsUtil.RECIPIENTS;
import static com.epam.reportportal.core.events.activity.util.ActivityDetailsUtil.RULE_DETAILS;
import static com.epam.reportportal.core.events.activity.util.ActivityDetailsUtil.SEND_CASE;
import static com.epam.reportportal.core.events.activity.util.ActivityDetailsUtil.TYPE;
import static com.epam.reportportal.core.events.activity.util.ActivityDetailsUtil.processBoolean;
import static com.epam.reportportal.core.events.activity.util.ActivityDetailsUtil.processList;
import static com.epam.reportportal.core.events.activity.util.ActivityDetailsUtil.processMap;
import static com.epam.reportportal.core.events.activity.util.ActivityDetailsUtil.processName;
import static com.epam.reportportal.core.events.activity.util.ActivityDetailsUtil.processString;
...
public class NotificationRuleUpdatedEvent extends AroundEvent<NotificationRuleActivityResource>
  ...
  private static Optional<HistoryField> processAttributesSet(Set<ItemAttributeResource> before,
    ...
    if (!left.equals(right)) {
      return Optional.of(HistoryField.of(
          com.epam.reportportal.core.events.activity.util.ActivityDetailsUtil.ATTRIBUTES, String.join(", ", left),
          String.join(", ", right)));
    }
  ...
  private static List<String> normalizeAttributes(
      Set<com.epam.reportportal.reporting.ItemAttributeResource> attrs) {
    if (attrs == null) {
      return List.of();
    }
    return attrs.stream()
