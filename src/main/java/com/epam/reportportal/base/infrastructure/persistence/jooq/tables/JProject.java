...
public class JProject extends TableImpl<JProjectRecord> {
  ...
  /**
   * Get the implicit to-many join path to the <code>public.tms_dataset</code> table
   */
  ...
  public JTmsEnvironmentPath tmsEnvironment() {
    if (_tmsEnvironment == null) {
      _tmsEnvironment = new JTmsEnvironmentPath(this, null,
          Keys.TMS_ENVIRONMENT__TMS_ENVIRONMENT_FK_PROJECT.getInverseKey());
    }
  ...
  public JTmsProductVersionPath tmsProductVersion() {
    if (_tmsProductVersion == null) {
      _tmsProductVersion = new JTmsProductVersionPath(this, null,
          Keys.TMS_PRODUCT_VERSION__TMS_PRODUCT_VERSION_FK_PROJECT.getInverseKey());
    }
  ...
  public JTmsTestFolderPath tmsTestFolder() {
    if (_tmsTestFolder == null) {
      _tmsTestFolder = new JTmsTestFolderPath(this, null,
          Keys.TMS_TEST_FOLDER__TMS_TEST_FOLDER_FK_PROJECT.getInverseKey());
    }
