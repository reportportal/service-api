...
import static com.epam.reportportal.core.hierarchy.AbstractFinishHierarchyHandler.ATTRIBUTE_KEY_STATUS;
import static com.epam.reportportal.core.hierarchy.AbstractFinishHierarchyHandler.ATTRIBUTE_VALUE_INTERRUPTED;
...
import static com.epam.reportportal.infrastructure.persistence.entity.enums.StatusEnum.fromValue;
...
import static com.epam.reportportal.infrastructure.rules.exception.ErrorType.AMBIGUOUS_TEST_ITEM_STATUS;
import static com.epam.reportportal.infrastructure.rules.exception.ErrorType.FINISH_ITEM_NOT_ALLOWED;
...
import com.epam.reportportal.core.item.impl.retry.RetrySearcher;
