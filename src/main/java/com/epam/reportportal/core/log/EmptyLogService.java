...
/**
 * It's temporary class, that's used for gracefully migration logs to Elasticsearch. Will be removed in the future.
 * That's why, for instance, some methods may be duplicated with ElasticLogService instead of moving it to some parent
 * class.
 */
@Service
