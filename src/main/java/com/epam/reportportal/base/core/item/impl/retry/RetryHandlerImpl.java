...
import com.epam.reportportal.base.infrastructure.persistence.dao.RetryRepository;
...
public class RetryHandlerImpl implements RetryHandler {
  ...
  @Override
  public void finishRetries(TestItem item, StatusEnum status, Instant endTime) {
