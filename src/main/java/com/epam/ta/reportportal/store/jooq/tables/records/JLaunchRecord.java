...
public class JLaunchRecord extends UpdatableRecordImpl<JLaunchRecord> implements Record10<Long, Integer, Integer, String, String, Timestamp, Integer, Timestamp, JLaunchModeEnum, JStatusEnum> {
     ...
     */
    @Override
    public JLaunchRecord values(Long value1, Integer value2, Integer value3, String value4, String value5, Timestamp value6, Integer value7, Timestamp value8, JLaunchModeEnum value9, JStatusEnum value10) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public JLaunchRecord(Long id, Integer projectId, Integer userId, String name, String description, Timestamp startTime, Integer number, Timestamp lastModified, JLaunchModeEnum mode, JStatusEnum status) {
        super(JLaunch.LAUNCH);
