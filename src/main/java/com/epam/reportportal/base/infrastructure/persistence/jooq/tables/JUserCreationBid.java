...
public class JUserCreationBid extends TableImpl<JUserCreationBidRecord> {
   ...
   */
  public final TableField<JUserCreationBidRecord, String> UUID = createField(DSL.name("uuid"),
      SQLDataType.VARCHAR.nullable(false), this, "");

  /**
   * The column <code>public.user_creation_bid.last_modified</code>.
   */
  public final TableField<JUserCreationBidRecord, Instant> LAST_MODIFIED = createField(DSL.name("last_modified"),
   ...
   */
  public final TableField<JUserCreationBidRecord, String> EMAIL = createField(DSL.name("email"),
      SQLDataType.VARCHAR.nullable(false), this, "");

  /**
   * The column <code>public.user_creation_bid.inviting_user_id</code>.
   */
  public final TableField<JUserCreationBidRecord, Long> INVITING_USER_ID = createField(DSL.name("inviting_user_id"),
      SQLDataType.BIGINT, this, "");

  /**
   * The column <code>public.user_creation_bid.metadata</code>.
   */
  public final TableField<JUserCreationBidRecord, JSONB> METADATA = createField(DSL.name("metadata"), SQLDataType.JSONB,
      this, "");

  /**
   * The column <code>public.user_creation_bid.project_role_backup</code>.
   */
  public final TableField<JUserCreationBidRecord, String> PROJECT_ROLE_BACKUP = createField(
      DSL.name("project_role_backup"), SQLDataType.VARCHAR, this, "");
  ...
  public <O extends Record> JUserCreationBid(Table<O> path, ForeignKey<O, JUserCreationBidRecord> childPath,
      InverseForeignKey<O, JUserCreationBidRecord> parentPath) {
  ...
  public static class JUserCreationBidPath extends JUserCreationBid implements Path<JUserCreationBidRecord> {
    ...
    public <O extends Record> JUserCreationBidPath(Table<O> path, ForeignKey<O, JUserCreationBidRecord> childPath,
        InverseForeignKey<O, JUserCreationBidRecord> parentPath) {
