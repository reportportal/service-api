...
import com.epam.reportportal.reporting.StatisticsResource;
...
public interface GetTestItemHandler {
   ...
   * @param term     part of {@link com.epam.reportportal.infrastructure.persistence.entity.bts.Ticket#ticketId} to
   *                 search
   * @return {@link List} of {@link com.epam.reportportal.infrastructure.persistence.entity.bts.Ticket#ticketId}
   */
  ...
  /**
   * Retrieves a list of unique attribute keys based on the provided project details, a substring of the key
   * ({@code keyPart}), and an optional launch ID.
   *
   ...
   * @param launchId          optional launch ID to restrict the search to a specific launch. If {@code null}, all
   *                          launches within the project are considered.
   * @return a list of unique attribute keys matching the criteria, or an empty list if none are found.
   */
  List<String> getUniqueAttributeKeys(MembershipDetails membershipDetails, String keyPart, Long launchId);

  /**
   * Retrieves a list of unique attribute values based on the provided project details, a substring of the value
   * ({@code valuePart}), and an optional launch ID.
   *
   * <p>If {@code launchId} is {@code null}, the search spans all launches in the project.
   *
   * @param membershipDetails details of the project; must not be {@code null}.
   ...
   * @param launchId          optional launch ID to restrict the search to a specific launch. If {@code null}, all
   *                          launches within the project are considered.
   * @return a list of unique attribute values matching the criteria, or an empty list if none are found.
   */
   ...
   * @param value    part of the {@link com.epam.reportportal.infrastructure.persistence.entity.ItemAttribute#value} to
   *                 search
   * @return {@link List} of the {@link com.epam.reportportal.infrastructure.persistence.entity.ItemAttribute#value}
   */
   ...
   * {@link com.epam.reportportal.infrastructure.persistence.entity.project.Project} specified by `projectDetails`
   *
   * @param membershipDetails {@link MembershipDetails}
  ...
  /**
   * @param ids               array of the
   *                          {@link com.epam.reportportal.infrastructure.persistence.entity.launch.Launch#id}
   * @param membershipDetails {@link MembershipDetails}
   * @param user              {@link ReportPortalUser}
