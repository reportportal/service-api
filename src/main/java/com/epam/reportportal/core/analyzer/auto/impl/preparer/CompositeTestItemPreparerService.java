...
/**
 * Composite service that delegates test item preparation to appropriate strategies based on analyzer configuration and
...
public class CompositeTestItemPreparerService implements TestItemPreparerService {
  ...
  /**
   * Prepares test items with analyzer configuration consideration. If largestRetryPriority is enabled, separates items
   * by retry status and applies appropriate strategies.
   *
