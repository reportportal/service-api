...
/**
 * Converter for JWT tokens to Spring Security authentication tokens. This class extends AbstractJwtConverter to provide
 * a specific implementation for converting JWTs issued by Report Portal.
 *
