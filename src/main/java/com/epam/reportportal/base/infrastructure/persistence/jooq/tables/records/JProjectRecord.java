...
public class JProjectRecord extends UpdatableRecordImpl<JProjectRecord> {
   ...
   */
  public JProjectRecord(Long id, String name, String organization, Instant createdAt, JSONB metadata,
      Long allocatedStorage, Long organizationId, String slug, String key, Instant updatedAt) {
    super(JProject.PROJECT);
