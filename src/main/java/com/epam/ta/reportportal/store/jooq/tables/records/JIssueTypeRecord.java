...
public class JIssueTypeRecord extends UpdatableRecordImpl<JIssueTypeRecord> implements Record6<Integer, JIssueGroupEnum, String, String, String, String> {

    private static final long serialVersionUID = -1326389947;
     ...
     */
    public JIssueTypeRecord(Integer id, JIssueGroupEnum issueGroup, String locator, String issueName, String abbreviation, String hexColor) {
        super(JIssueType.ISSUE_TYPE);
