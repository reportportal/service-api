...
public class JLaunchAttributeRules extends TableImpl<JLaunchAttributeRulesRecord> {
   ...
   */
  public final TableField<JLaunchAttributeRulesRecord, Long> SENDER_CASE_ID = createField(DSL.name("sender_case_id"),
   ...
   */
  public final TableField<JLaunchAttributeRulesRecord, String> VALUE = createField(DSL.name("value"),
      SQLDataType.VARCHAR(512).nullable(false), this, "");
  ...
  public <O extends Record> JLaunchAttributeRules(Table<O> path, ForeignKey<O, JLaunchAttributeRulesRecord> childPath,
      InverseForeignKey<O, JLaunchAttributeRulesRecord> parentPath) {
   ...
   */
  public static class JLaunchAttributeRulesPath extends JLaunchAttributeRules implements
      Path<JLaunchAttributeRulesRecord> {

    private static final long serialVersionUID = 1L;

    public <O extends Record> JLaunchAttributeRulesPath(Table<O> path,
        ForeignKey<O, JLaunchAttributeRulesRecord> childPath,
        InverseForeignKey<O, JLaunchAttributeRulesRecord> parentPath) {
  ...
  public JSenderCasePath senderCase() {
    if (_senderCase == null) {
      _senderCase = new JSenderCasePath(this, Keys.LAUNCH_ATTRIBUTE_RULES__LAUNCH_ATTRIBUTE_RULES_SENDER_CASE_ID_FKEY,
          null);
    }
