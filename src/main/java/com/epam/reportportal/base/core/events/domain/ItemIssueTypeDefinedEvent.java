...
/**
 * Event published when an issue type is defined for a test item. Use {@link #isSystemEvent()} to distinguish between
 * user-initiated definitions and analyzer-initiated definitions.
 *
