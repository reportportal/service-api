...
/**
 * Spring Data repository for test items, steps, and tree paths.
 *
...
public interface TestItemRepository extends ReportPortalRepository<TestItem, Long>,
   ...
   *
   * @param parentId {@code TestItem#getParent()} ID
  ...
  /**
   * Interrupts all {@link com.epam.reportportal.base.infrastructure.persistence.entity.enums.StatusEnum#IN_PROGRESS}
   * children items of the launch with provided launchId. Sets them
   * {@link com.epam.reportportal.base.infrastructure.persistence.entity.enums.StatusEnum#INTERRUPTED} status
   *
   * @param launchId Launch id
   */
  @Modifying
