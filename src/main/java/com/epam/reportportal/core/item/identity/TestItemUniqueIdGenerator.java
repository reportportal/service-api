...
/**
 * Generates the unique identifier for test item based on Base64 encoding and includes information about project, name
 * of item's launch, full path of item's parent names, item name and parameters.
 *
