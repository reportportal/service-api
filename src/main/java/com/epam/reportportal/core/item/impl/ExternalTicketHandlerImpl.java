...
import com.epam.reportportal.reporting.Issue.ExternalSystemIssue;
import com.epam.reportportal.ws.converter.converters.TicketConverter;
...
public class ExternalTicketHandlerImpl implements ExternalTicketHandler {
   ...
   *
   * @param externalIssues {@link com.epam.reportportal.reporting.Issue.ExternalSystemIssue}
   ...
   *
   * @param externalIssues {@link com.epam.reportportal.reporting.Issue.ExternalSystemIssue}
   * @param username       {@link com.epam.reportportal.infrastructure.persistence.entity.user.User#login}
