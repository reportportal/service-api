...
public class JTestItem extends TableImpl<JTestItemRecord> {
	...
	private static final long serialVersionUID = -1059993018;
	...
	public final TableField<JTestItemRecord, Long> ITEM_ID = createField(
			"item_id", org.jooq.impl.SQLDataType.BIGINT.nullable(false)
	...
	public final TableField<JTestItemRecord, JTestItemTypeEnum> TYPE = createField(
			"type", org.jooq.util.postgres.PostgresDataType.VARCHAR.asEnumDataType(
					com.epam.ta.reportportal.store.jooq.enums.JTestItemTypeEnum.class), this, "");
	...
	public final TableField<JTestItemRecord, JParameterRecord[]> PARAMETERS = createField(
			"parameters", com.epam.ta.reportportal.store.jooq.udt.JParameter.PARAMETER.getDataType().getArrayDataType(), this, "");
	...
	public final TableField<JTestItemRecord, String> UNIQUE_ID = createField(
			"unique_id", org.jooq.impl.SQLDataType.VARCHAR(256).nullable(false), this, "");
