...
VALUES (13, 5, 'activity stream12', 'superadmin', 'activityStream', 5, 5, 0, 0),
       (13, 7, 'INVESTIGATED PERCENTAGE OF LAUNCHES', 'investigatedTrend', 'superadmin', 6, 3, 0,
        0),
...
VALUES (1, 'com.epam.ta.reportportal.entity.filter.UserFilter', 'java.lang.Long'),
...
INSERT INTO public.acl_object_identity (id, object_id_class, object_id_identity, parent_object,
...
INSERT INTO public.acl_entry (id, acl_object_identity, ace_order, sid, mask, granting,
                              audit_success, audit_failure)
VALUES (1, 1, 0, 1, 16, true, false, false),
