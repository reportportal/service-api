...
public class JLaunchRecord extends UpdatableRecordImpl<JLaunchRecord> implements Record11<Long, Long, Long, String, String, Timestamp, Timestamp, Integer, Timestamp, JLaunchModeEnum, JStatusEnum> {

    private static final long serialVersionUID = 1946604550;
     ...
     */
    @Override
    public Row11<Long, Long, Long, String, String, Timestamp, Timestamp, Integer, Timestamp, JLaunchModeEnum, JStatusEnum> fieldsRow() {
     ...
     */
    @Override
    public Row11<Long, Long, Long, String, String, Timestamp, Timestamp, Integer, Timestamp, JLaunchModeEnum, JStatusEnum> valuesRow() {
     ...
     */
    @Override
    public Field<JLaunchModeEnum> field10() {
     ...
     */
    @Override
    public Field<JStatusEnum> field11() {
     ...
     */
    @Override
    public JLaunchModeEnum component10() {
        return getMode();
    }
     ...
     */
    @Override
    public JStatusEnum component11() {
        return getStatus();
    }
     ...
     */
    @Override
    public JLaunchModeEnum value10() {
        return getMode();
    }
     ...
     */
    @Override
    public JLaunchRecord value8(Integer value) {
        setNumber(value);
        return this;
    }
     ...
     */
    @Override
    public JLaunchRecord value9(Timestamp value) {
     ...
     */
    @Override
    public JLaunchRecord value10(JLaunchModeEnum value) {
        setMode(value);
        return this;
    }
     ...
     */
    @Override
    public JLaunchRecord value11(JStatusEnum value) {
        setStatus(value);
        return this;
    }
     ...
     */
    @Override
    public JLaunchRecord values(Long value1, Long value2, Long value3, String value4, String value5, Timestamp value6, Timestamp value7, Integer value8, Timestamp value9, JLaunchModeEnum value10, JStatusEnum value11) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public JLaunchRecord(Long id, Long projectId, Long userId, String name, String description, Timestamp startTime, Timestamp endTime, Integer number, Timestamp lastModified, JLaunchModeEnum mode, JStatusEnum status) {
        super(JLaunch.LAUNCH);
