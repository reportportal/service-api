...
/**
 * Converter for LaunchDeletedEvent to Activity.
 *
 */
@Component
public class LaunchDeletedEventConverter implements EventToActivityConverter<LaunchDeletedEvent> {
  ...
  @Override
  public Class<LaunchDeletedEvent> getEventClass() {
    return LaunchDeletedEvent.class;
  }
}
