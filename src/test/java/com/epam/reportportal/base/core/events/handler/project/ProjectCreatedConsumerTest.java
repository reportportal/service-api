package com.epam.reportportal.base.core.events.handler.project;
...
import com.epam.reportportal.base.ws.rabbit.ProjectCreatedConsumer;
...
class ProjectCreatedConsumerTest {
  ...
  void onProjectCreatedShouldInitializeLogTypesWhenEventIsValid() {
    ...
    // when
    projectCreatedConsumer.onProjectCreated(event);
  ...
  void onProjectCreated_ShouldLogWarning_WhenEventIsNullOrProjectIdIsNull() {
    ...
    // when
    projectCreatedConsumer.onProjectCreated(eventWithNullId);
