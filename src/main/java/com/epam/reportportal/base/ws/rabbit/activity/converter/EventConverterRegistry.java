...
/**
 * Registry for event-to-activity converters. Encapsulates converter lookup logic and provides type-safe access to
 * converters.
 *
 */
@Component
...
public class EventConverterRegistry {
  ...
  /**
   * Convenience method to convert an event to an Activity. Returns empty Optional if no converter is registered for the
   * event type.
   *
