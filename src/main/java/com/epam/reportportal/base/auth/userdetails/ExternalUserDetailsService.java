...
package com.epam.reportportal.base.auth.userdetails;

import static com.epam.reportportal.base.core.configs.security.converters.UserReportPortalUserConverter.TO_REPORT_PORTAL_USER;
...
/**
 * Spring's {@link UserDetailsService} implementation for external users. Uses {@link User} entity from ReportPortal
 * database.
 *
