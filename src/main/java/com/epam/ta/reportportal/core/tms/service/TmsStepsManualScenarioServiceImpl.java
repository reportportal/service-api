...
public class TmsStepsManualScenarioServiceImpl implements TmsManualScenarioService {
  ...
  public TmsManualScenario createTmsManualScenario(TmsTestCaseVersion testCaseVersion,
    ...
    tmsStepService.createSteps(tmsManualScenario,
  ...
  public TmsManualScenario updateTmsManualScenario(TmsTestCaseVersion testCaseVersion,
    ...
    tmsStepService.updateSteps(existingManualScenario,
        (TmsStepsManualScenarioRQ) testCaseManualScenarioRQ);
  ...
  public TmsManualScenario patchTmsManualScenario(TmsTestCaseVersion testCaseVersion,
    ...
    tmsStepService.patchSteps(existingManualScenario,
        (TmsStepsManualScenarioRQ) testCaseManualScenarioRQ);
