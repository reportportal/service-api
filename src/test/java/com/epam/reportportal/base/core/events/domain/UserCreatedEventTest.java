...
import com.epam.reportportal.base.ws.rabbit.activity.converter.UserCreatedEventConverter;
...
class UserCreatedEventTest {
  ...
  @Test
  void toActivity() {
    UserCreatedEvent event = new UserCreatedEvent(getUser(), 1L, "user");
    UserCreatedEventConverter converter = new UserCreatedEventConverter();
