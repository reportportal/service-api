...
public class JIntegrationType extends TableImpl<JIntegrationTypeRecord> {
   ...
   */
  public final TableField<JIntegrationTypeRecord, Integer> ID = createField(DSL.name("id"),
      SQLDataType.INTEGER.nullable(false).identity(true), this, "");

  /**
   * The column <code>public.integration_type.name</code>.
   */
  public final TableField<JIntegrationTypeRecord, String> NAME = createField(DSL.name("name"),
  ...
  public final TableField<JIntegrationTypeRecord, JIntegrationAuthFlowEnum> AUTH_FLOW = createField(
      DSL.name("auth_flow"), SQLDataType.VARCHAR.asEnumDataType(JIntegrationAuthFlowEnum.class), this, "");

  /**
   * The column <code>public.integration_type.creation_date</code>.
   */
  public final TableField<JIntegrationTypeRecord, Instant> CREATION_DATE = createField(DSL.name("creation_date"),
  ...
  public final TableField<JIntegrationTypeRecord, JIntegrationGroupEnum> GROUP_TYPE = createField(
      DSL.name("group_type"), SQLDataType.VARCHAR.nullable(false).asEnumDataType(JIntegrationGroupEnum.class), this,
      "");

  /**
   * The column <code>public.integration_type.enabled</code>.
   */
  public final TableField<JIntegrationTypeRecord, Boolean> ENABLED = createField(DSL.name("enabled"),
      SQLDataType.BOOLEAN.nullable(false), this, "");

  /**
   * The column <code>public.integration_type.details</code>.
   */
  public final TableField<JIntegrationTypeRecord, JSONB> DETAILS = createField(DSL.name("details"), SQLDataType.JSONB,
      this, "");

  /**
   * The column <code>public.integration_type.plugin_type</code>.
   */
  public final TableField<JIntegrationTypeRecord, String> PLUGIN_TYPE = createField(DSL.name("plugin_type"),
      SQLDataType.VARCHAR(128).nullable(false)
          .defaultValue(DSL.field(DSL.raw("'EXTENSION'::character varying"), SQLDataType.VARCHAR)), this, "");
  ...
  public <O extends Record> JIntegrationType(Table<O> path, ForeignKey<O, JIntegrationTypeRecord> childPath,
      InverseForeignKey<O, JIntegrationTypeRecord> parentPath) {
  ...
  public static class JIntegrationTypePath extends JIntegrationType implements Path<JIntegrationTypeRecord> {
    ...
    public <O extends Record> JIntegrationTypePath(Table<O> path, ForeignKey<O, JIntegrationTypeRecord> childPath,
        InverseForeignKey<O, JIntegrationTypeRecord> parentPath) {
