...
public class JLaunchTag extends TableImpl<JLaunchTagRecord> {
	 ...
	 */
	public final TableField<JLaunchTagRecord, Long> ID = createField("id", org.jooq.impl.SQLDataType.BIGINT.nullable(false)
			.defaultValue(org.jooq.impl.DSL.field("nextval('launch_tag_id_seq'::regclass)", org.jooq.impl.SQLDataType.BIGINT)), this, "");
