...
/**
 * Validation annotation to ensure that at least 1 field of BatchPatchTestCaseAttributesRQ is provided.
 * <p>
 ...
 */
@Documented
@Constraint(validatedBy = BatchPatchTestCaseAttributesRQValidator.class)
@Target({ElementType.TYPE})
@Retention(RetentionPolicy.RUNTIME)
public @interface ValidBatchPatchTestCaseAttributesRQ {
