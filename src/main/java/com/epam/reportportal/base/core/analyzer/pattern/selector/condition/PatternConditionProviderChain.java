...
package com.epam.reportportal.base.core.analyzer.pattern.selector.condition;

import com.epam.reportportal.base.core.analyzer.auto.strategy.analyze.AnalyzeItemsMode;
import com.epam.reportportal.base.core.analyzer.pattern.selector.condition.impl.AutoAnalyzedPatternConditionProvider;
import com.epam.reportportal.base.core.analyzer.pattern.selector.condition.impl.IgnoreImmediatePatternAnalysisConditionProvider;
import com.epam.reportportal.base.core.analyzer.pattern.selector.condition.impl.ManualPatternConditionProvider;
import com.epam.reportportal.base.core.analyzer.pattern.selector.condition.impl.ToInvestigatePatternConditionProvider;
...
import com.epam.reportportal.base.infrastructure.persistence.dao.IssueGroupRepository;
...
/**
 * Composes per-mode pattern condition providers into a single filter.
 *
