...
package com.epam.reportportal.base.ws.resolver;

import com.epam.reportportal.base.core.filter.predefined.PredefinedFilterType;
import com.epam.reportportal.base.core.filter.predefined.PredefinedFilters;
 ...
 * parameter with name 'age' you have to put in request the following: '?filter.age=20'. Resolves parameter only in case
 * argument marked with annotation {@link FilterFor}. <br> By FilterFor value resolves criterias/parameters to the given
 * domain class and resolves them if possible. If there are no criteria/parameter defined for specified class than will
 * throw exception
 *
...
public class PredefinedFilterCriteriaResolver implements HandlerMethodArgumentResolver {
  ...
  /**
   * Default prefix for filter conditions. Since Request contains a lot of parameters (some of them may not be related
   * to filtering), we have to introduce this
   */
