...
/**
 * Event published when a plugin is uploaded by a user or loaded by the system. Use {@link #isSystemEvent()} to
 * distinguish between user-initiated uploads (activity audit required) and system lifecycle loads (startup, reload - no
 * audit).
 */
@Setter
@Getter
