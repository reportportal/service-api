...
values (1, 'uuid1', 1, 'superadmin', 'test launch', 'desc', now(), null, 1, now(), 'DEFAULT', 'FAILED', false);
...
values (1, 'uuid', 'test item 1', 'TEST', now(), 'desc', 'uuid1', now(), '1', null, 1);
insert into test_item_results(result_id, status)
values (1, 'IN_PROGRESS');


insert into test_item(item_id, uuid, name, type, start_time, description, unique_id, last_modified, path, parent_id, launch_id)
values (2, 'uuid2', 'step item 1', 'STEP', now(), 'desc', 'uuid1', now(), '1.2', 1, 1);
insert into test_item_results(result_id, status)
...
insert into test_item(item_id, uuid, name, type, start_time, description, unique_id, last_modified, path, parent_id, launch_id)
values (3, 'uuid3', 'step item 2', 'STEP', now(), 'desc', 'uuid3', now(), '1.3', 1, 1);
insert into test_item_results(result_id, status)
...
-- Test level item with 2 step items
insert into test_item(item_id, uuid, name, type, start_time, description, unique_id, last_modified, path, parent_id, launch_id)
values (4, 'uuid4', 'test item 1', 'TEST', now(), 'desc', 'uuid4', now(), '4', null, 1);
insert into test_item_results(result_id, status)
values (4, 'IN_PROGRESS');

insert into test_item(item_id, uuid, name, type, start_time, description, unique_id, last_modified, path, parent_id, launch_id)
values (5, 'uuid5', 'step item 3', 'STEP', now(), 'desc', 'uuid5', now(), '4.5', 4, 1);
insert into test_item_results(result_id, status)
...
insert into test_item(item_id, uuid, name, type, start_time, description, unique_id, last_modified, path, parent_id, launch_id)
values (6, 'uuid6', 'step item 4', 'STEP', now(), 'desc', 'uuid6', now(), '4.6', 4, 1);
insert into test_item_results(result_id, status)
...
insert into test_item(item_id, uuid, name, type, start_time, description, unique_id, last_modified, path, parent_id, launch_id)
values (7, 'uuid7', 'step item 7', 'STEP', now(), 'desc', 'uuid7', now(), '4.7', 4, 1);
insert into test_item_results(result_id, status)
