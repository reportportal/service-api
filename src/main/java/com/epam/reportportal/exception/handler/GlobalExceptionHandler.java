...
package com.epam.reportportal.exception.handler;

import com.epam.reportportal.exception.ExceptionMappings;
import com.epam.reportportal.exception.forwarding.ClientResponseForwardingExceptionHandler;
import com.epam.reportportal.exception.forwarding.ResponseForwardingException;
import com.epam.reportportal.exception.rest.DefaultErrorResolver;
import com.epam.reportportal.exception.rest.ReportPortalExceptionResolver;
...
@RestControllerAdvice(value = {
    "com.epam.reportportal.ws.controller",
    "com.epam.reportportal.core.tms.controller",
    "com.epam.reportportal.reporting.async.controller"
})
@Log4j2
@Order(1)
