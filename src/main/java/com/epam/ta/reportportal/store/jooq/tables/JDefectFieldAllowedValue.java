...
public class JDefectFieldAllowedValue extends TableImpl<JDefectFieldAllowedValueRecord> {
	...
	private static final long serialVersionUID = 2109933245;
	...
	public final TableField<JDefectFieldAllowedValueRecord, Integer> ID = createField(
			"id", org.jooq.impl.SQLDataType.INTEGER.nullable(false)
					.defaultValue(org.jooq.impl.DSL.field("nextval('defect_field_allowed_value_id_seq'::regclass)",
	...
	public final TableField<JDefectFieldAllowedValueRecord, Integer> DEFECT_FORM_FIELD = createField(
			"defect_form_field", org.jooq.impl.SQLDataType.INTEGER, this, "");
	...
	public final TableField<JDefectFieldAllowedValueRecord, String> VALUE_ID = createField(
			"value_id", org.jooq.impl.SQLDataType.VARCHAR.nullable(false), this, "");
	...
	public final TableField<JDefectFieldAllowedValueRecord, String> VALUE_NAME = createField(
			"value_name", org.jooq.impl.SQLDataType.VARCHAR, this, "");
	...
	public List<ForeignKey<JDefectFieldAllowedValueRecord, ?>> getReferences() {
		return Arrays.<ForeignKey<JDefectFieldAllowedValueRecord, ?>>asList(
				Keys.DEFECT_FIELD_ALLOWED_VALUE__DEFECT_FIELD_ALLOWED_VALUE_DEFECT_FORM_FIELD_FKEY);
	}
