 ...
 *
 * @author Siarhe Hrabko
 */
public interface OrganizationsSearchCriteriaService {

  Filter createFilterBySearchCriteria(SearchCriteriaRQ searchCriteriaRQ, Class<?> target);
