...
/**
 * This class represents information about a plugin, including its ID, version, file ID, file name, enabled status, and
 * additional details.
 *
...
public class PluginInfo implements Serializable {
  ...
  /**
   * Constructs a {@link PluginInfo} object with the specified ID, version, file ID, file name, and enabled status.
   *
   * @param id        The ID of the plugin.
   * @param version   The version of the plugin.
