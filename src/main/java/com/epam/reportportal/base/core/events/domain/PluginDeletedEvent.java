...
/**
 * Event published when a plugin is deleted by a user or unloaded by the system. Use {@link #isSystemEvent()} to
 * distinguish between user-initiated deletes (activity audit required) and system lifecycle unloads (shutdown, reload -
 * no audit).
 */
@Getter
@NoArgsConstructor
