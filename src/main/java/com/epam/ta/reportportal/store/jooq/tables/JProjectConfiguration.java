...
public class JProjectConfiguration extends TableImpl<JProjectConfigurationRecord> {
	...
	private static final long serialVersionUID = -1935922752;
	 ...
	 */
	public final TableField<JProjectConfigurationRecord, Integer> ID = createField(
			"id", org.jooq.impl.SQLDataType.INTEGER.nullable(false)
					.defaultValue(org.jooq.impl.DSL.field("nextval('project_configuration_id_seq'::regclass)",
	 ...
	 */
	public final TableField<JProjectConfigurationRecord, JProjectTypeEnum> PROJECT_TYPE = createField(
			"project_type", org.jooq.util.postgres.PostgresDataType.VARCHAR.asEnumDataType(
					com.epam.ta.reportportal.store.jooq.enums.JProjectTypeEnum.class), this, "");
	 ...
	 */
	public final TableField<JProjectConfigurationRecord, Boolean> AA_ENABLED = createField(
			"aa_enabled", org.jooq.impl.SQLDataType.BOOLEAN.nullable(false)
	 ...
	 */
	public final TableField<JProjectConfigurationRecord, Integer> EMAIL_CONFIGURATION_ID = createField(
			"email_configuration_id", org.jooq.impl.SQLDataType.INTEGER, this, "");

	/**
	 * The column <code>public.project_configuration.created_on</code>.
	 */
	public final TableField<JProjectConfigurationRecord, Timestamp> CREATED_ON = createField(
			"created_on", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false)
	...
	public List<UniqueKey<JProjectConfigurationRecord>> getKeys() {
		return Arrays.<UniqueKey<JProjectConfigurationRecord>>asList(
				Keys.PROJECT_CONFIGURATION_PK, Keys.PROJECT_CONFIGURATION_EMAIL_CONFIGURATION_ID_KEY);
	}
	...
	public List<ForeignKey<JProjectConfigurationRecord, ?>> getReferences() {
		return Arrays.<ForeignKey<JProjectConfigurationRecord, ?>>asList(
				Keys.PROJECT_CONFIGURATION__PROJECT_CONFIGURATION_EMAIL_CONFIGURATION_ID_FKEY);
	}
