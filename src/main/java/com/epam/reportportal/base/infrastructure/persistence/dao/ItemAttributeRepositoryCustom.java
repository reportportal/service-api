...
public interface ItemAttributeRepositoryCustom {
  ...
  /**
   * Retrieves {@link Launch} and {@link TestItem} {@link ItemAttribute#getKey()} by project id and
   ...
   * @param isLatest       Flag defines whether all or latest launches will be included in
   *                       the query condition
  ...
  /**
   * Retrieves test item attribute keys by project id and part of value. Used for autocompletion
   * functionality
   *
   * @param projectId  Id of {@link Project} which items' attribute keys should be found
  ...
  /**
   * Retrieves test item attribute values by project id, specified key and part of value. Used for
   * autocompletion functionality
   *
   * @param projectId  Id of {@link Project} which items' attribute values should be found
   * @param launchName {@link Launch#getName()} which items' attributes should be found
   * @param key        Specified key
  ...
  /**
   * Save item attribute by {@link TestItem#itemId}
   *
