...
import com.epam.reportportal.base.infrastructure.persistence.jooq.tables.JParameter.JParameterPath;
...
public class JTestItem extends TableImpl<JTestItemRecord> {
   ...
   */
  public final TableField<JTestItemRecord, Long> ITEM_ID = createField(DSL.name("item_id"),
      SQLDataType.BIGINT.nullable(false).identity(true), this, "");

  /**
   * The column <code>public.test_item.uuid</code>.
   */
  public final TableField<JTestItemRecord, String> UUID = createField(DSL.name("uuid"),
   ...
   */
  public final TableField<JTestItemRecord, String> CODE_REF = createField(DSL.name("code_ref"), SQLDataType.VARCHAR,
      this, "");

  /**
   * The column <code>public.test_item.type</code>.
   */
  public final TableField<JTestItemRecord, JTestItemTypeEnum> TYPE = createField(DSL.name("type"),
      SQLDataType.VARCHAR.nullable(false).asEnumDataType(JTestItemTypeEnum.class), this, "");

  /**
   * The column <code>public.test_item.start_time</code>.
   */
  public final TableField<JTestItemRecord, Instant> START_TIME = createField(DSL.name("start_time"),
   ...
   */
  public final TableField<JTestItemRecord, String> DESCRIPTION = createField(DSL.name("description"), SQLDataType.CLOB,
      this, "");

  /**
   * The column <code>public.test_item.last_modified</code>.
   */
  public final TableField<JTestItemRecord, Instant> LAST_MODIFIED = createField(DSL.name("last_modified"),
      SQLDataType.LOCALDATETIME(6).nullable(false), this, "", new JooqInstantConverter());

  /**
   * The column <code>public.test_item.path</code>.
   */
  public final TableField<JTestItemRecord, Object> PATH = createField(DSL.name("path"),
      DefaultDataType.getDefaultDataType("\"public\".\"ltree\""), this, "");

  /**
   * The column <code>public.test_item.unique_id</code>.
   */
  public final TableField<JTestItemRecord, String> UNIQUE_ID = createField(DSL.name("unique_id"),
      SQLDataType.VARCHAR(1024), this, "");

  /**
   * The column <code>public.test_item.test_case_id</code>.
   */
  public final TableField<JTestItemRecord, String> TEST_CASE_ID = createField(DSL.name("test_case_id"),
      SQLDataType.VARCHAR(1024), this, "");

  /**
   * The column <code>public.test_item.has_children</code>.
   */
  public final TableField<JTestItemRecord, Boolean> HAS_CHILDREN = createField(DSL.name("has_children"),
   ...
   */
  public final TableField<JTestItemRecord, Boolean> HAS_RETRIES = createField(DSL.name("has_retries"),
      SQLDataType.BOOLEAN.defaultValue(DSL.field(DSL.raw("false"), SQLDataType.BOOLEAN)), this, "");

  /**
   * The column <code>public.test_item.has_stats</code>.
   */
  public final TableField<JTestItemRecord, Boolean> HAS_STATS = createField(DSL.name("has_stats"),
   ...
   */
  public final TableField<JTestItemRecord, Long> PARENT_ID = createField(DSL.name("parent_id"), SQLDataType.BIGINT,
      this, "");
   ...
   */
  public final TableField<JTestItemRecord, Long> LAUNCH_ID = createField(DSL.name("launch_id"), SQLDataType.BIGINT,
      this, "");

  /**
   * The column <code>public.test_item.test_case_hash</code>.
   */
  public final TableField<JTestItemRecord, Integer> TEST_CASE_HASH = createField(DSL.name("test_case_hash"),
  ...
  public <O extends Record> JTestItem(Table<O> path, ForeignKey<O, JTestItemRecord> childPath,
      InverseForeignKey<O, JTestItemRecord> parentPath) {
  ...
  public static class JTestItemPath extends JTestItem implements Path<JTestItemRecord> {
    ...
    public <O extends Record> JTestItemPath(Table<O> path, ForeignKey<O, JTestItemRecord> childPath,
        InverseForeignKey<O, JTestItemRecord> parentPath) {
  ...
  public List<Index> getIndexes() {
    return Arrays.asList(Indexes.IDX_TEST_ITEM_NAME_TRGM, Indexes.ITEM_TEST_CASE_ID_LAUNCH_ID_IDX,
        Indexes.PATH_GIST_IDX, Indexes.TEST_CASE_HASH_LAUNCH_ID_IDX, Indexes.TEST_ITEM_START_TIME_IDX,
  ...
  public List<ForeignKey<JTestItemRecord, ?>> getReferences() {
    return Arrays.asList(Keys.TEST_ITEM__TEST_ITEM_LAUNCH_ID_FKEY, Keys.TEST_ITEM__TEST_ITEM_PARENT_ID_FKEY,
  ...
  /**
   * Get the implicit join path to the <code>public.test_item</code> table, via the
   * <code>test_item_parent_id_fkey</code> key.
   */
  ...
  /**
   * Get the implicit join path to the <code>public.test_item</code> table, via the <code>test_item_retry_of_fkey</code>
   * key.
   */
  ...
  public JItemAttributePath itemAttribute() {
    if (_itemAttribute == null) {
      _itemAttribute = new JItemAttributePath(this, null,
          Keys.ITEM_ATTRIBUTE__ITEM_ATTRIBUTE_ITEM_ID_FKEY.getInverseKey());
    }
  ...
  /**
   * Get the implicit to-many join path to the <code>public.parameter</code> table
   */
  ...
  public JPatternTemplateTestItemPath patternTemplateTestItem() {
    if (_patternTemplateTestItem == null) {
      _patternTemplateTestItem = new JPatternTemplateTestItemPath(this, null,
          Keys.PATTERN_TEMPLATE_TEST_ITEM__PATTERN_TEMPLATE_TEST_ITEM_ITEM_ID_FKEY.getInverseKey());
    }
  ...
  public JTestItemResultsPath testItemResults() {
    if (_testItemResults == null) {
      _testItemResults = new JTestItemResultsPath(this, null,
          Keys.TEST_ITEM_RESULTS__TEST_ITEM_RESULTS_RESULT_ID_FKEY.getInverseKey());
    }
  ...
  public JTmsTestCaseExecutionPath tmsTestCaseExecution() {
    if (_tmsTestCaseExecution == null) {
      _tmsTestCaseExecution = new JTmsTestCaseExecutionPath(this, null,
          Keys.TMS_TEST_CASE_EXECUTION__TMS_TEST_CASE_EXECUTION_FK_TEST_ITEM.getInverseKey());
    }
