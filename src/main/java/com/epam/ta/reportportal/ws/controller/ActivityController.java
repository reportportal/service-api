 ...
 public class ActivityController {
   ...
   public Iterable<ActivityResource> getActivities(@PathVariable String projectName,
       @FilterFor(Activity.class) Filter filter,
       @FilterFor(Activity.class) Queryable predefinedFilter,
     ...
     return activityHandler.getActivitiesHistory(projectDetails, filter, predefinedFilter,
         pageable);
   }
   ...
   public Iterable<ActivityResource> getTestItemActivities(@PathVariable String projectName,
