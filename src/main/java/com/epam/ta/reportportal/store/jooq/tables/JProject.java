...
public class JProject extends TableImpl<JProjectRecord> {
	...
	private static final long serialVersionUID = -1568294169;
	...
	public final TableField<JProjectRecord, Integer> ID = createField(
			"id", org.jooq.impl.SQLDataType.INTEGER.nullable(false)
					.defaultValue(org.jooq.impl.DSL.field("nextval('project_id_seq'::regclass)", org.jooq.impl.SQLDataType.INTEGER)), this,
			""
	);
	...
	public final TableField<JProjectRecord, Integer> PROJECT_CONFIGURATION_ID = createField(
			"project_configuration_id", org.jooq.impl.SQLDataType.INTEGER, this, "");
