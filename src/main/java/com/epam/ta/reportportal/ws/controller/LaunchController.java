...
public class LaunchController {
  ...
  public StartLaunchRS startLaunch(@PathVariable String projectName,
      @Parameter(description = "Start launch request body", required = true) @RequestBody @Validated @Valid StartLaunchRQ startLaunchRQ,
  ...
  public LaunchResource mergeLaunches(@PathVariable String projectName,
      @Parameter(description = "Merge launches request body", required = true) @RequestBody @Validated MergeLaunchesRQ mergeLaunchesRQ,
      @AuthenticationPrincipal ReportPortalUser user) {
  ...
  public void getLaunchReport(@PathVariable String projectName, @PathVariable Long launchId,
      @Parameter(schema = @Schema(allowableValues = {"pdf", "xls", "html"})) @RequestParam(value = "view", required = false, defaultValue = "pdf") String view,
