...
import com.epam.reportportal.core.project.settings.DeleteProjectSettingsHandler;
import com.epam.reportportal.core.project.settings.GetProjectSettingsHandler;
import com.epam.reportportal.core.project.settings.UpdateProjectSettingsHandler;
import com.epam.reportportal.core.project.settings.notification.CreateProjectNotificationHandler;
import com.epam.reportportal.core.project.settings.notification.DeleteProjectNotificationHandler;
import com.epam.reportportal.core.project.settings.notification.GetProjectNotificationsHandler;
import com.epam.reportportal.core.project.settings.notification.UpdateProjectNotificationHandler;
...
import com.epam.reportportal.model.project.config.ProjectSettingsResource;
...
/**
 * Projects settings controller. Provides resources for manipulation of various project settings items.
 *
...
public class ProjectSettingsController {
  ...
  public OperationCompletionRS updatePatternTemplate(@PathVariable String projectKey,
      ...
      @AuthenticationPrincipal ReportPortalUser user) {
    return updateHandler.updatePatternTemplate(id, normalizeId(projectKey), updatePatternTemplateRQ, user);
  }
