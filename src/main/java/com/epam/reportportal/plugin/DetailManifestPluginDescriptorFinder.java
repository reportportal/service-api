...
/**
 * Plugin descriptor finder that reads the plugin descriptor from the manifest file. This class implements the
 * {@link PluginDescriptorFinder} interface and provides methods to check if a plugin path is applicable, and to find
 * the plugin descriptor from the given path.
 *
