...
/**
 * Enum for {@link com.epam.reportportal.infrastructure.persistence.entity.item.history.TestItemHistory} retrieving type
 * resolving.
 *
...
public enum ItemHistoryBaselineEnum {
  ...
  /**
   * {@link ItemHistoryBaselineEnum} is resolved using {@link Predicate}, types ordered by `priority` field in ascending
   * order, first matched type is returned.
   *
