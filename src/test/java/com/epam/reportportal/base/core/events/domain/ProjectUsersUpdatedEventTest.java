...
import com.epam.reportportal.base.ws.rabbit.activity.converter.ProjectUsersUpdatedEventConverter;
import java.time.Instant;
import java.util.List;
import org.junit.jupiter.api.Test;

class ProjectUsersUpdatedEventTest {

  @Test
  void toActivity() {
    ProjectUsersUpdatedEvent event = new ProjectUsersUpdatedEvent(
        1L, "user", 3L, "My Project", 2L, List.of(10L), List.of(10L, 20L), EventAction.ASSIGN
    );
    ProjectUsersUpdatedEventConverter converter = new ProjectUsersUpdatedEventConverter();
  ...
  private static Activity expectedActivity(Instant createdAt) {
    ...
    activity.setAction(EventAction.ASSIGN);
    activity.setEventName("updateProjectUsers");
    ...
    activity.setObjectName("My Project");
    ActivityDetails details = new ActivityDetails();
    details.addHistoryField(HistoryField.of("users", "10", "10, 20"));
