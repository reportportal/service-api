...
public class JWidget extends TableImpl<JWidgetRecord> {
	...
	private static final long serialVersionUID = 350597784;
	 ...
	 */
	public final TableField<JWidgetRecord, Integer> ID = createField("id", org.jooq.impl.SQLDataType.INTEGER.nullable(false)
			.defaultValue(org.jooq.impl.DSL.field("nextval('widget_id_seq'::regclass)", org.jooq.impl.SQLDataType.INTEGER)), this, "");
