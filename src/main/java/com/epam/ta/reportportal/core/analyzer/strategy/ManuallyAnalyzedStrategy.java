 ...
 */
public class ManuallyAnalyzedStrategy implements AnalyzeItemsStrategy {

	private TestItemRepository testItemRepository;

	private ILogIndexer logIndexer;

	public ManuallyAnalyzedStrategy(TestItemRepository testItemRepository, ILogIndexer logIndexer) {
