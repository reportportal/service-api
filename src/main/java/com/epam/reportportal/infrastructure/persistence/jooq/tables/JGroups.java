...
public class JGroups extends TableImpl<JGroupsRecord> {
   ...
   */
  public final TableField<JGroupsRecord, Long> ID = createField(DSL.name("id"),
      SQLDataType.BIGINT.nullable(false).identity(true), this, "");

  /**
   * The column <code>public.groups.slug</code>.
   */
  public final TableField<JGroupsRecord, String> SLUG = createField(DSL.name("slug"),
      SQLDataType.VARCHAR(255).nullable(false), this, "");

  /**
   * The column <code>public.groups.name</code>.
   */
  public final TableField<JGroupsRecord, String> NAME = createField(DSL.name("name"),
      SQLDataType.VARCHAR(255).nullable(false), this, "");

  /**
   * The column <code>public.groups.created_by</code>.
   */
  public final TableField<JGroupsRecord, Long> CREATED_BY = createField(DSL.name("created_by"), SQLDataType.BIGINT,
      this, "");

  /**
   * The column <code>public.groups.created_at</code>.
   */
  public final TableField<JGroupsRecord, Instant> CREATED_AT = createField(DSL.name("created_at"),
      SQLDataType.LOCALDATETIME(6).nullable(false), this, "", new JooqInstantConverter());

  /**
   * The column <code>public.groups.updated_at</code>.
   */
  public final TableField<JGroupsRecord, Instant> UPDATED_AT = createField(DSL.name("updated_at"),
   ...
   */
  public final TableField<JGroupsRecord, java.util.UUID> UUID = createField(DSL.name("uuid"),
  ...
  public <O extends Record> JGroups(Table<O> path, ForeignKey<O, JGroupsRecord> childPath,
      InverseForeignKey<O, JGroupsRecord> parentPath) {
  ...
  public static class JGroupsPath extends JGroups implements Path<JGroupsRecord> {
    ...
    public <O extends Record> JGroupsPath(Table<O> path, ForeignKey<O, JGroupsRecord> childPath,
        InverseForeignKey<O, JGroupsRecord> parentPath) {
  ...
  public JGroupsProjectsPath groupsProjects() {
    if (_groupsProjects == null) {
      _groupsProjects = new JGroupsProjectsPath(this, null,
          Keys.GROUPS_PROJECTS__GROUPS_PROJECTS_GROUP_ID_FKEY.getInverseKey());
    }
