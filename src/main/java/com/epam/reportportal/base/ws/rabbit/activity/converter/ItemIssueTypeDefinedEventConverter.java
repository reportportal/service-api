...
/**
 * Converter for ItemIssueTypeDefinedEvent to Activity. System events are persisted with APPLICATION subject type.
 */
@Component
public class ItemIssueTypeDefinedEventConverter implements
  ...
  private Optional<HistoryField> processRelevantItem(
      com.epam.reportportal.base.model.analyzer.RelevantItemInfo relevantItemInfo) {
