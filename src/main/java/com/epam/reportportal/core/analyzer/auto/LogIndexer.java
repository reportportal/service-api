...
package com.epam.reportportal.core.analyzer.auto;
...
public interface LogIndexer {
  ...
  /**
   * Index logs with its level greater than
   * {@link com.epam.reportportal.infrastructure.persistence.entity.enums.LogLevel#ERROR} for all given test items
   * within launch
   *
   ...
   * @param ids   The {@link List} of the {@link com.epam.reportportal.infrastructure.persistence.entity.log.Log#id}
