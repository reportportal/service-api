...
public interface Queryable {
  ...
  /**
   * Build a map where key is {@link ConditionType} and value is a composite {@link Condition} that should be applied
   * either in {@link ConditionType#HAVING} or {@link ConditionType#WHERE} clause
   *
   * @return Resulted map
   */
