...
import com.epam.reportportal.core.filter.GetUserFilterHandler;
...
import com.epam.reportportal.ws.converter.converters.UserFilterConverter;
...
public class GetUserFilterHandlerImpl implements GetUserFilterHandler {
  ...
  @Override
  public UserFilterResource getUserFilter(Long id, MembershipDetails membershipDetails) {
    final UserFilter userFilter =
        filterRepository.findByIdAndProjectId(id, membershipDetails.getProjectId()).orElseThrow(
  ...
  @Override
  public com.epam.reportportal.model.Page<UserFilterResource> getUserFilters(String projectName, Pageable pageable,
  ...
  @Override
  public com.epam.reportportal.model.Page<OwnedEntityResource> getFiltersNames(
  ...
  @Override
  public List<UserFilter> getFiltersById(Long[] ids, MembershipDetails membershipDetails,
      ReportPortalUser user) {
    return filterRepository.findAllByIdInAndProjectId(
        Lists.newArrayList(ids), membershipDetails.getProjectId());
  }
}
