...
import static com.epam.reportportal.infrastructure.model.ValidationConstraints.MAX_LAUNCH_NAME_LENGTH;
import static com.epam.reportportal.infrastructure.persistence.commons.Preconditions.HAS_ANY_MODE;
...
import com.epam.reportportal.core.launch.cluster.GetClusterHandler;
import com.epam.reportportal.core.launch.export.LaunchExportService;
...
/**
 * Default implementation of {@link com.epam.reportportal.core.launch.GetLaunchHandler}
 *
...
public class GetLaunchHandlerImpl implements GetLaunchHandler {
  ...
  @Override
  public com.epam.reportportal.model.Page<LaunchResource> getProjectLaunches(
   ...
   */
  @Override
  public com.epam.reportportal.model.Page<LaunchResource> getDebugLaunches(
      MembershipDetails membershipDetails,
  ...
  @Override
  public com.epam.reportportal.model.Page<LaunchResource> getLatestLaunches(
      MembershipDetails membershipDetails,
      Filter filter, Pageable pageable) {
  ...
  public com.epam.reportportal.model.Page<ClusterInfoResource> getClusters(String launchId,
  ...
  private com.epam.reportportal.model.Page<LaunchResource> getLaunchResources(
      Page<Launch> launches) {
    final com.epam.reportportal.model.Page<LaunchResource> launchResourcePage =
