...
import com.epam.reportportal.infrastructure.persistence.jooq.tables.JActivity.JActivityPath;
import com.epam.reportportal.infrastructure.persistence.jooq.tables.JAttribute.JAttributePath;
import com.epam.reportportal.infrastructure.persistence.jooq.tables.JGroups.JGroupsPath;
import com.epam.reportportal.infrastructure.persistence.jooq.tables.JGroupsProjects.JGroupsProjectsPath;
import com.epam.reportportal.infrastructure.persistence.jooq.tables.JIntegration.JIntegrationPath;
import com.epam.reportportal.infrastructure.persistence.jooq.tables.JIssueType.JIssueTypePath;
import com.epam.reportportal.infrastructure.persistence.jooq.tables.JIssueTypeProject.JIssueTypeProjectPath;
import com.epam.reportportal.infrastructure.persistence.jooq.tables.JLaunch.JLaunchPath;
import com.epam.reportportal.infrastructure.persistence.jooq.tables.JLaunchNumber.JLaunchNumberPath;
...
import com.epam.reportportal.infrastructure.persistence.jooq.tables.JProjectAttribute.JProjectAttributePath;
import com.epam.reportportal.infrastructure.persistence.jooq.tables.JProjectUser.JProjectUserPath;
import com.epam.reportportal.infrastructure.persistence.jooq.tables.JSenderCase.JSenderCasePath;
import com.epam.reportportal.infrastructure.persistence.jooq.tables.JUserPreference.JUserPreferencePath;
...
public class JProject extends TableImpl<JProjectRecord> {
   ...
   */
  public final TableField<JProjectRecord, Long> ID = createField(DSL.name("id"),
      SQLDataType.BIGINT.nullable(false).identity(true), this, "");

  /**
   * The column <code>public.project.name</code>.
   */
  public final TableField<JProjectRecord, String> NAME = createField(DSL.name("name"),
      SQLDataType.VARCHAR.nullable(false), this, "");

  /**
   * The column <code>public.project.organization</code>.
   */
  public final TableField<JProjectRecord, String> ORGANIZATION = createField(DSL.name("organization"),
      SQLDataType.VARCHAR, this, "");

  /**
   * The column <code>public.project.created_at</code>.
   */
  public final TableField<JProjectRecord, Instant> CREATED_AT = createField(DSL.name("created_at"),
   ...
   */
  public final TableField<JProjectRecord, Long> ALLOCATED_STORAGE = createField(DSL.name("allocated_storage"),
      SQLDataType.BIGINT.nullable(false).defaultValue(DSL.field(DSL.raw("0"), SQLDataType.BIGINT)), this, "");

  /**
   * The column <code>public.project.organization_id</code>.
   */
  public final TableField<JProjectRecord, Long> ORGANIZATION_ID = createField(DSL.name("organization_id"),
   ...
   */
  public final TableField<JProjectRecord, Instant> UPDATED_AT = createField(DSL.name("updated_at"),
      SQLDataType.LOCALDATETIME(6).nullable(false).defaultValue(DSL.field(DSL.raw("now()"), SQLDataType.LOCALDATETIME)),
      this, "", new JooqInstantConverter());
  ...
  public <O extends Record> JProject(Table<O> path, ForeignKey<O, JProjectRecord> childPath,
      InverseForeignKey<O, JProjectRecord> parentPath) {
  ...
  public static class JProjectPath extends JProject implements Path<JProjectRecord> {
    ...
    public <O extends Record> JProjectPath(Table<O> path, ForeignKey<O, JProjectRecord> childPath,
        InverseForeignKey<O, JProjectRecord> parentPath) {
  ...
  /**
   * Get the implicit to-many join path to the <code>public.activity</code> table
   */
  ...
  public JGroupsProjectsPath groupsProjects() {
    if (_groupsProjects == null) {
      _groupsProjects = new JGroupsProjectsPath(this, null,
          Keys.GROUPS_PROJECTS__GROUPS_PROJECTS_PROJECT_ID_FKEY.getInverseKey());
    }
  ...
  /**
   * Get the implicit to-many join path to the <code>public.integration</code> table
   */
  ...
  public JIssueTypeProjectPath issueTypeProject() {
    if (_issueTypeProject == null) {
      _issueTypeProject = new JIssueTypeProjectPath(this, null,
          Keys.ISSUE_TYPE_PROJECT__ISSUE_TYPE_PROJECT_PROJECT_ID_FKEY.getInverseKey());
    }
  ...
  public JLaunchNumberPath launchNumber() {
    if (_launchNumber == null) {
      _launchNumber = new JLaunchNumberPath(this, null,
          Keys.LAUNCH_NUMBER__LAUNCH_NUMBER_PROJECT_ID_FKEY.getInverseKey());
    }
  ...
  /**
   * Get the implicit to-many join path to the <code>public.launch</code> table
   */
  ...
  public JPatternTemplatePath patternTemplate() {
    if (_patternTemplate == null) {
      _patternTemplate = new JPatternTemplatePath(this, null,
          Keys.PATTERN_TEMPLATE__PATTERN_TEMPLATE_PROJECT_ID_FKEY.getInverseKey());
    }
  ...
  public JProjectAttributePath projectAttribute() {
    if (_projectAttribute == null) {
      _projectAttribute = new JProjectAttributePath(this, null,
          Keys.PROJECT_ATTRIBUTE__PROJECT_ATTRIBUTE_PROJECT_ID_FKEY.getInverseKey());
    }
  ...
  /**
   * Get the implicit to-many join path to the <code>public.sender_case</code> table
   */
  ...
  public JOwnedEntityPath ownedEntity() {
    if (_ownedEntity == null) {
      _ownedEntity = new JOwnedEntityPath(this, null,
          Keys.OWNED_ENTITY__SHAREABLE_ENTITY_PROJECT_ID_FKEY.getInverseKey());
    }
  ...
  public JUserPreferencePath userPreference() {
    if (_userPreference == null) {
      _userPreference = new JUserPreferencePath(this, null,
          Keys.USER_PREFERENCE__USER_PREFERENCE_PROJECT_ID_FKEY.getInverseKey());
    }
  ...
  /**
   * Get the implicit many-to-many join path to the <code>public.groups</code> table
   */
  ...
  /**
   * Get the implicit many-to-many join path to the <code>public.users</code> table
   */
