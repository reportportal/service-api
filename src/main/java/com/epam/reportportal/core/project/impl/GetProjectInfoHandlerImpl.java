...
import static com.epam.reportportal.infrastructure.persistence.commons.EntityUtils.INSTANT_TO_TIMESTAMP;
...
import static com.epam.reportportal.infrastructure.persistence.commons.querygen.Condition.EQUALS;
import static com.epam.reportportal.infrastructure.persistence.commons.querygen.Condition.GREATER_THAN_OR_EQUALS;
import static com.epam.reportportal.infrastructure.persistence.commons.querygen.Condition.IN;
...
import static com.epam.reportportal.infrastructure.persistence.entity.activity.ActivityAction.DELETE_DEFECT;
import static com.epam.reportportal.infrastructure.persistence.entity.activity.ActivityAction.LINK_ISSUE;
import static com.epam.reportportal.infrastructure.persistence.entity.activity.ActivityAction.LINK_ISSUE_AA;
import static com.epam.reportportal.infrastructure.persistence.entity.activity.ActivityAction.UNLINK_ISSUE;
import static com.epam.reportportal.infrastructure.persistence.entity.activity.ActivityAction.UPDATE_DEFECT;
import static com.epam.reportportal.infrastructure.persistence.entity.activity.ActivityAction.UPDATE_ITEM;
import static com.epam.reportportal.infrastructure.persistence.entity.project.email.ProjectInfoWidget.CASES_STATISTIC;
import static com.epam.reportportal.infrastructure.persistence.entity.project.email.ProjectInfoWidget.INVESTIGATED;
import static com.epam.reportportal.infrastructure.persistence.entity.project.email.ProjectInfoWidget.ISSUES_CHART;
import static com.epam.reportportal.infrastructure.persistence.entity.project.email.ProjectInfoWidget.LAUNCHES_QUANTITY;
...
import static com.epam.reportportal.ws.converter.converters.ActivityConverter.TO_RESOURCE;
import static com.epam.reportportal.ws.converter.converters.ActivityConverter.TO_RESOURCE_WITH_USER;
import static java.util.Optional.ofNullable;
import static java.util.stream.Collectors.joining;
import static java.util.stream.Collectors.toList;
import static java.util.stream.Collectors.toMap;

import com.epam.reportportal.core.project.GetProjectInfoHandler;
...
import com.epam.reportportal.infrastructure.persistence.entity.project.email.ProjectInfoWidget;
import com.epam.reportportal.infrastructure.persistence.entity.user.User;
import com.epam.reportportal.infrastructure.rules.exception.ReportPortalException;
import com.epam.reportportal.model.project.LaunchesPerUser;
import com.epam.reportportal.model.project.ProjectInfoResource;
import com.epam.reportportal.reporting.Mode;
import com.epam.reportportal.ws.converter.PagedResourcesAssembler;
import com.epam.reportportal.ws.converter.converters.LaunchConverter;
import com.epam.reportportal.ws.converter.converters.ProjectSettingsConverter;
...
public class GetProjectInfoHandlerImpl implements GetProjectInfoHandler {
  ...
  @Override
  public com.epam.reportportal.model.Page<ProjectInfoResource> getAllProjectsInfo(
