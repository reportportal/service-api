...
public class GetClusterHandlerImpl implements GetClusterHandler {
  ...
  @Override
  public com.epam.reportportal.model.Page<ClusterInfoResource> getResources(Launch launch,
      Pageable pageable) {
  ...
  private com.epam.reportportal.model.Page<ClusterInfoResource> getClusterResources(
      Page<ClusterInfoResource> clusters,
      Long launchId) {
    final com.epam.reportportal.model.Page<ClusterInfoResource> clustersPage =
