...
package com.epam.reportportal.core.hierarchy;

import static com.epam.reportportal.core.item.impl.status.ToSkippedStatusChangingStrategy.SKIPPED_ISSUE_KEY;
...
import com.epam.reportportal.job.PageUtil;
