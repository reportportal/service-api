...
/**
 * Service for managing operations related to {@link Project} entities. Provides methods to retrieve
 * and manipulate project data within the ReportPortal system. This service handles basic CRUD
 * operations and project-specific business logic.
 *
...
public class ProjectService {
   ...
   * @param name      the new name for the project, must match pattern ^[A-Za-z0-9.'_\- ]+$ with
   ...
   * @param slug      the new slug for the project, must match pattern ^[a-z0-9]+(?:-[a-z0-9]+)*$
   *                  with length between 3 and 60 characters
   */
