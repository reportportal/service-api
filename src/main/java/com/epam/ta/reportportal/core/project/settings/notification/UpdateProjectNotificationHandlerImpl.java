...
public class UpdateProjectNotificationHandlerImpl implements UpdateProjectNotificationHandler {
	...
	public UpdateProjectNotificationHandlerImpl(SenderCaseRepository senderCaseRepository, MessageBus messageBus,
	...
	public OperationCompletionRS updateNotification(Project project, SenderCaseDTO updateNotificationRQ, ReportPortalUser user) {
		expect(updateNotificationRQ.getId(), Objects::nonNull).verify(ErrorType.BAD_REQUEST_ERROR, "Please specify notification Id");
