...
/**
 * Converter for ImportFinishedEvent to Activity.
 */
@Component
public class ImportFinishedEventConverter implements EventToActivityConverter<ImportFinishedEvent> {
  ...
  @Override
  public Class<ImportFinishedEvent> getEventClass() {
    return ImportFinishedEvent.class;
  }
}
