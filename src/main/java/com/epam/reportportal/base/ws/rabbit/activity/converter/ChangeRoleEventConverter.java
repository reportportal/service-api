...
import static com.epam.reportportal.base.infrastructure.persistence.entity.activity.ActivityAction.CHANGE_ROLE;
...
/**
 * Converter for ChangeRoleEvent to Activity.
 *
 */
@Component
public class ChangeRoleEventConverter implements EventToActivityConverter<ChangeRoleEvent> {
  ...
  public Activity convert(ChangeRoleEvent event) {
    return new ActivityBuilder()
        ...
        .addHistoryField("projectRole", event.getOldRole(), event.getNewRole())
        .get();
  }

  @Override
  public Class<ChangeRoleEvent> getEventClass() {
