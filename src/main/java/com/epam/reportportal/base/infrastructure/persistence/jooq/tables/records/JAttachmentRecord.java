...
public class JAttachmentRecord extends UpdatableRecordImpl<JAttachmentRecord> {
   ...
   */
  public JAttachmentRecord(Long id, String fileId, String thumbnailId, String contentType, Long projectId,
      Long launchId, Long itemId, Long fileSize, Instant creationDate, String fileName) {
    super(JAttachment.ATTACHMENT);
