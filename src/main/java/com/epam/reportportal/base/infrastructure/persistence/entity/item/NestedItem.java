...
/**
 * Entity for query {@link LogRepository#findNestedItems(Long, boolean, boolean, Queryable, Pageable)}, consists from
 * either {@link Log#id} or {@link TestItem#itemId} as {@link NestedItem#id} and {@link NestedItem#type} to identify
 * what kind of entity is it and either {@link Log#logLevel} or 0 in case if it is an item
 * <p>
