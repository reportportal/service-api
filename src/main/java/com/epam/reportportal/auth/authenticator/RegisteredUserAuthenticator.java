...
package com.epam.reportportal.auth.authenticator;

import static com.epam.reportportal.auth.UserRoleHierarchy.ROLE_REGISTERED;
...
public class RegisteredUserAuthenticator implements UserAuthenticator {
   ...
   * custom implementation {@link com.epam.reportportal.auth.acl.ReportPortalAclAuthorizationStrategyImpl} to permit
   * shared objects to the newly created user
   *
   * @param user {@link User}
   * @return {@link Authentication} with authenticated user with the role
   * {@link com.epam.reportportal.auth.UserRoleHierarchy#ROLE_REGISTERED}
   */
  @Override
