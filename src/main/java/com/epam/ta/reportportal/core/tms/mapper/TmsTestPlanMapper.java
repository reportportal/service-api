...
public abstract class TmsTestPlanMapper {
  ...
  /**
   * Duplicates a test plan with "-copy" postfix in the name.
   * Used for test plan duplication functionality.
   *
   * @param original The original test plan to duplicate.
   * @return A new test plan entity with copied fields and "-copy" postfix in name.
   */
  @Mapping(target = "id", ignore = true)
  @Mapping(target = "attributes", ignore = true)
  @Mapping(target = "milestones", ignore = true)
  ...
  public abstract TmsTestPlan duplicateTestPlan(TmsTestPlan original);
