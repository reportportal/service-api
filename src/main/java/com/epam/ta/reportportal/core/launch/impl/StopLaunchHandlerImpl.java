...
public class StopLaunchHandlerImpl implements StopLaunchHandler {
  ...
  public OperationCompletionRS stopLaunch(Long launchId, FinishExecutionRQ finishLaunchRQ,
    ...
    launch = new LaunchBuilder(launch).addDescription(
            ofNullable(finishLaunchRQ.getDescription()).orElse(ofNullable(launch.getDescription())
    ...
    messageBus.publishActivity(
        new LaunchFinishForcedEvent(TO_ACTIVITY_RESOURCE.apply(launch), user.getUserId(),
            user.getUsername()));
    eventPublisher.publishEvent(
        new LaunchFinishedEvent(launch, user.getUserId(), user.getUsername()));
    eventPublisher.publishEvent(
