...
public interface GetLogHandler {
   ...
   *
   * @param parentId          {@link com.epam.reportportal.infrastructure.persistence.entity.log.Log#testItem} ID or
   *                          {@link com.epam.reportportal.infrastructure.persistence.entity.item.TestItem#parentId} ID
   * @param membershipDetails {@link MembershipDetails}
   * @param params            Request params
   * @param queryable         {@link Queryable}
   * @param pageable          {@link Pageable}
   * @return The {@link Iterable} of {@link LogResource} and {@link com.epam.reportportal.model.NestedStepResource}
   * entities
   */
  ...
  Page<PagedLogResource> getLogsWithLocationBySearch(Long parentId,
      MembershipDetails membershipDetails, Map<String, String> params, Queryable queryable, Pageable pageable);
}
