...
import com.epam.reportportal.core.tms.mapper.TmsManualScenarioRequirementMapper;
import com.epam.reportportal.infrastructure.persistence.dao.tms.TmsManualScenarioRequirementRepository;
...
public class TmsManualScenarioRequirementServiceImpl implements
  ...
  public void createRequirements(TmsManualScenario tmsManualScenario,
    ...
    log.info("Created {} requirements for manual scenario: {}",
  ...
  public void updateRequirements(TmsManualScenario manualScenario,
    ...
    log.info("Updated requirements for manual scenario: {}", manualScenario.getId());
  }
  ...
  public void patchRequirements(TmsManualScenario existingManualScenario,
    ...
    log.info("Patched {} requirements for manual scenario: {}",
  ...
  public void deleteAllByTestCaseId(Long testCaseId) {
    ...
    log.info("Deleted all requirements for test case: {}", testCaseId);
  }
  ...
  public void deleteAllByTestCaseIds(List<Long> testCaseIds) {
    ...
    log.info("Deleted all requirements for {} test cases", testCaseIds.size());
  }
  ...
  public void deleteAllByTestFolderId(Long projectId, Long folderId) {
    ...
    log.info("Deleted all requirements for project: {} and folder: {}", projectId, folderId);
  }
