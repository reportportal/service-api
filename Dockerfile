...
ENV JAVA_OPTS="-Xmx1g -XX:+UseG1GC -XX:InitiatingHeapOccupancyPercent=70 -Djava.security.egd=file:/dev/./urandom -agentlib:jdwp=transport=dt_socket,server=y,suspend=n,address=*:5001" ARTIFACT=build/libs/service-api-5.8.1-exec.jar
VOLUME ["/tmp"]
EXPOSE 8080 5001
ENTRYPOINT ./start.sh