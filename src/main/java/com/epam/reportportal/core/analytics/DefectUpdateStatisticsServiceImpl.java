...
package com.epam.reportportal.core.analytics;

import static com.epam.reportportal.core.analytics.AnalyticsObjectType.DEFECT_UPDATE_STATISTICS;
...
import com.epam.reportportal.infrastructure.persistence.dao.AnalyticsDataRepository;
...
/**
 * DefectUpdateStatistics is an implementation of the AnalyticsStrategy interface. This class is responsible for
 * persisting the defect update statistics.
 */
@Component
