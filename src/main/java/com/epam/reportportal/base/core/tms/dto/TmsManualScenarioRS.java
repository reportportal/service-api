...
/**
 * Abstract base response DTO for manual scenario operations. Contains common information for all types of manual
 * scenarios. This class is extended by concrete implementations for different scenario types.
 */
@Data
@SuperBuilder
@NoArgsConstructor
