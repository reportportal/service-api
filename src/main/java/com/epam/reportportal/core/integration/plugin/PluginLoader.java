...
public interface PluginLoader {
   ...
   * @throws PluginRuntimeException if there is an issue in loading the plugin or the plugin is not found in the
   *                                specified path
   */
  ...
  /**
   * Validate the plugin with {@link com.epam.reportportal.extension.common.ExtensionPoint} on the presence of the
   * mandatory extension class/classes
   *
  ...
  /**
   * Save plugin in the {@link com.epam.reportportal.infrastructure.persistence.filesystem.DataStore}
   *
  ...
  /**
   * Copy plugin with resources from the {@link com.epam.reportportal.infrastructure.persistence.filesystem.DataStore}
  ...
  /**
   * Delete plugin file from the {@link com.epam.reportportal.infrastructure.persistence.filesystem.DataStore}
   *
   ...
   * {@link com.epam.reportportal.plugin.Pf4jPluginManager}
   *
