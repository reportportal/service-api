...
public abstract class PagedResourcesAssembler<T, R> extends ResourceAssembler<T, R> {
  ...
  public static <T> Function<Page<T>, com.epam.reportportal.model.Page<T>> pageConverter() {
    return page -> new com.epam.reportportal.model.Page<>(page.getContent(),
        new com.epam.reportportal.model.Page.PageMetadata(page.getSize(),
  ...
  public static <T, R> Function<Page<T>, com.epam.reportportal.model.Page<R>> pageConverter(
  ...
  public static <T, R> Function<Page<T>, com.epam.reportportal.model.Page<R>> pageMultiConverter(
  ...
  /**
   * Creates {@link com.epam.reportportal.model.Page} from {@link Page} DB query result
   *
   ...
   */
  @Deprecated
  public com.epam.reportportal.model.Page<R> toPagedResources(Page<T> content) {
    Preconditions.checkNotNull(content, "Content should be null");

    return new com.epam.reportportal.model.Page<>(toResources(content),
        new com.epam.reportportal.model.Page.PageMetadata(content.getSize(),
