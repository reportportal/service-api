package com.epam.reportportal.core.tms.service.factory;

import com.epam.reportportal.core.tms.dto.TmsManualScenarioType;
import com.epam.reportportal.core.tms.service.TmsManualScenarioImplService;
...
public class TmsManualScenarioImplServiceFactory {
  ...
  public TmsManualScenarioImplService getTmsManualScenarioService(
      com.epam.reportportal.infrastructure.persistence.entity.tms.enums.TmsManualScenarioType type) {
