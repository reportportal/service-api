...
public class DeleteIntegrationHandlerImpl implements DeleteIntegrationHandler {
	...
	public OperationCompletionRS deleteIntegration(Long integrationId, ReportPortalUser.ProjectDetails projectDetails,
		...
		messageBus.publishActivity(new IntegrationDeletedEvent(integration, user.getUserId()));
	...
	public OperationCompletionRS deleteProjectIntegrations(ReportPortalUser.ProjectDetails projectDetails, ReportPortalUser user) {
		...
		integrations.forEach(integration -> messageBus.publishActivity(new IntegrationDeletedEvent(integration, user.getUserId())));
