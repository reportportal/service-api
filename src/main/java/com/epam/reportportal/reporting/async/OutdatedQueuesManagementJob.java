...
package com.epam.reportportal.reporting.async;

import static com.epam.reportportal.reporting.async.config.ReportingTopologyConfiguration.DEFAULT_QUEUE_ROUTING_KEY;
import static com.epam.reportportal.reporting.async.config.ReportingTopologyConfiguration.REPORTING_EXCHANGE;
import static com.epam.reportportal.reporting.async.config.ReportingTopologyConfiguration.REPORTING_QUEUE_PREFIX;
