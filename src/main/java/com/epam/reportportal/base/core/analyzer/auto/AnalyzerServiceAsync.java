...
package com.epam.reportportal.base.core.analyzer.auto;
...
/**
 * Non-blocking analyzer entry points returning futures.
 *
...
public interface AnalyzerServiceAsync {
  ...
  /**
   * Analyze history to find similar issues and updates items if some were found Indexes investigated issues as well.
   *
