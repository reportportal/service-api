...
LABEL version="4.3.11"
LABEL description="EPAM Report portal. Main API Service"

ENV APP_FILE service-api-4.3.11
ENV APP_DOWNLOAD_URL https://dl.bintray.com/epam/reportportal/com/epam/reportportal/service-api/4.3.11/$APP_FILE.jar
