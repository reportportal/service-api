...
public class JTestItemResults extends TableImpl<JTestItemResultsRecord> {
   ...
   */
  public final TableField<JTestItemResultsRecord, Long> RESULT_ID = createField(DSL.name("result_id"),
      SQLDataType.BIGINT.nullable(false), this, "");

  /**
   * The column <code>public.test_item_results.status</code>.
   */
  public final TableField<JTestItemResultsRecord, JStatusEnum> STATUS = createField(DSL.name("status"),
   ...
   */
  public final TableField<JTestItemResultsRecord, Instant> END_TIME = createField(DSL.name("end_time"),
      SQLDataType.LOCALDATETIME(6), this, "", new JooqInstantConverter());

  /**
   * The column <code>public.test_item_results.duration</code>.
   */
  public final TableField<JTestItemResultsRecord, Double> DURATION = createField(DSL.name("duration"),
      SQLDataType.DOUBLE, this, "");
  ...
  public <O extends Record> JTestItemResults(Table<O> path, ForeignKey<O, JTestItemResultsRecord> childPath,
      InverseForeignKey<O, JTestItemResultsRecord> parentPath) {
  ...
  public static class JTestItemResultsPath extends JTestItemResults implements Path<JTestItemResultsRecord> {
    ...
    public <O extends Record> JTestItemResultsPath(Table<O> path, ForeignKey<O, JTestItemResultsRecord> childPath,
        InverseForeignKey<O, JTestItemResultsRecord> parentPath) {
