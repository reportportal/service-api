...
public interface IntegrationRepositoryCustom extends FilterableRepository<Integration> {
   ...
   * {@link com.epam.reportportal.infrastructure.persistence.entity.integration.IntegrationType#id} IN provided
   * integration type IDs
   *
   * @param projectId          {@link com.epam.reportportal.infrastructure.persistence.entity.project.Project#id} of the
   *                           {@link Integration}
  ...
  /**
   * Retrieve integrations with
   * {@link com.epam.reportportal.infrastructure.persistence.entity.integration.IntegrationType#id} NOT IN provided
   * integration type IDs
   *
   * @param integrationTypeIds The {@link List} of the
   *                           {@link
