...
import static com.epam.reportportal.core.user.impl.CreateUserHandlerImpl.BID_TYPE;
...
import static com.epam.reportportal.model.settings.SettingsKeyConstants.SERVER_USERS_SSO;
import static com.epam.reportportal.util.DateTimeProvider.instantNow;
