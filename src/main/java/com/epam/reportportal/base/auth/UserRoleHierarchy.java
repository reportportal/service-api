...
package com.epam.reportportal.base.auth;
...
/**
 * UserRoleHierarchy processor. Actually, hierarchy is pretty simple: role in {@link UserRole} has more rights than the
 * following one. So, Administrator is more privileged than User.
 *
