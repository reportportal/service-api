...
public abstract class TmsMilestoneMapper {
  ...
  protected TmsMilestoneType mapType(
      com.epam.reportportal.infrastructure.persistence.entity.tms.enums.TmsMilestoneType type) {
   ...
   * @return entity enum
   */
  protected com.epam.reportportal.infrastructure.persistence.entity.tms.enums.TmsMilestoneType mapType(
      TmsMilestoneType type) {
    return type != null
        ? com.epam.reportportal.infrastructure.persistence.entity.tms.enums.TmsMilestoneType.valueOf(
        type.name()) : null;
  }
  ...
  protected TmsMilestoneStatus mapStatus(
      com.epam.reportportal.infrastructure.persistence.entity.tms.enums.TmsMilestoneStatus status) {
  ...
  protected com.epam.reportportal.infrastructure.persistence.entity.tms.enums.TmsMilestoneStatus mapStatusWithDefault(
      TmsMilestoneStatus status) {
    return status != null
        ? com.epam.reportportal.infrastructure.persistence.entity.tms.enums.TmsMilestoneStatus.valueOf(
        status.name())
        : com.epam.reportportal.infrastructure.persistence.entity.tms.enums.TmsMilestoneStatus.SCHEDULED;
  }
   ...
   */
  @Named("mapStatus")
  protected com.epam.reportportal.infrastructure.persistence.entity.tms.enums.TmsMilestoneStatus mapStatus(
      TmsMilestoneStatus status) {
    return status != null
        ? com.epam.reportportal.infrastructure.persistence.entity.tms.enums.TmsMilestoneStatus.valueOf(
        status.name()) : null;
