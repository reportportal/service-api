...
public class JLogRecord extends UpdatableRecordImpl<JLogRecord> {
     ...
     */
    public JLogRecord(Long id, String uuid, Instant logTime, String logMessage, Long itemId, Long launchId, Instant lastModified, Integer logLevel, Long attachmentId, Long projectId, Long clusterId) {
        super(JLog.LOG);
