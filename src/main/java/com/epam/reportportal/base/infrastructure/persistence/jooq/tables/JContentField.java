...
public class JContentField extends TableImpl<JContentFieldRecord> {
  ...
  public <O extends Record> JContentField(Table<O> path, ForeignKey<O, JContentFieldRecord> childPath,
      InverseForeignKey<O, JContentFieldRecord> parentPath) {
  ...
  public static class JContentFieldPath extends JContentField implements Path<JContentFieldRecord> {
    ...
    public <O extends Record> JContentFieldPath(Table<O> path, ForeignKey<O, JContentFieldRecord> childPath,
        InverseForeignKey<O, JContentFieldRecord> parentPath) {
