...
values (1, 'uuid', 1, 'owner', 'test launch', 'desc', now(), null, 1, now(), 'DEFAULT', 'FAILED', false);
...
VALUES (2, 'not passed', null, 'notPassed', 10, '{"options": {}}'),
       (3, 'not passed', null, 'notPassed', 10, '{"options": {}}');
