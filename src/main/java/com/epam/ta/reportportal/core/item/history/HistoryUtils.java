...
class HistoryUtils {
	...
	public static final FilterCondition STATUS_CONDITION = new FilterCondition(
			Condition.IN, false, new StringBuilder(Status.PASSED.toString()).append(Condition.VALUES_SEPARATOR)
					.append(Status.FAILED.toString()).append(Condition.VALUES_SEPARATOR).append(Status.STOPPED.toString()).toString(),
			"status");
