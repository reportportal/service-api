 ...
 */
public class MarkLaunchAsImportantEvent extends AbstractEvent implements ActivityEvent {

  private LaunchActivityResource launchActivityResource;

  public MarkLaunchAsImportantEvent() {
  }

  public MarkLaunchAsImportantEvent(LaunchActivityResource launchActivityResource, Long userId,
      String userLogin) {
  ...
  public Activity toActivity() {
    return new ActivityBuilder()
        ...
        .addEventName(ActivityAction.MARK_LAUNCH_AS_IMPORTANT.getValue())
