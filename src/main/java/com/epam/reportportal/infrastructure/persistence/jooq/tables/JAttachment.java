...
public class JAttachment extends TableImpl<JAttachmentRecord> {
   ...
   */
  public final TableField<JAttachmentRecord, Long> ID = createField(DSL.name("id"),
      SQLDataType.BIGINT.nullable(false).identity(true), this, "");

  /**
   * The column <code>public.attachment.file_id</code>.
   */
  public final TableField<JAttachmentRecord, String> FILE_ID = createField(DSL.name("file_id"),
      SQLDataType.CLOB.nullable(false), this, "");

  /**
   * The column <code>public.attachment.thumbnail_id</code>.
   */
  public final TableField<JAttachmentRecord, String> THUMBNAIL_ID = createField(DSL.name("thumbnail_id"),
      SQLDataType.CLOB, this, "");

  /**
   * The column <code>public.attachment.content_type</code>.
   */
  public final TableField<JAttachmentRecord, String> CONTENT_TYPE = createField(DSL.name("content_type"),
      SQLDataType.CLOB, this, "");

  /**
   * The column <code>public.attachment.project_id</code>.
   */
  public final TableField<JAttachmentRecord, Long> PROJECT_ID = createField(DSL.name("project_id"), SQLDataType.BIGINT,
      this, "");

  /**
   * The column <code>public.attachment.launch_id</code>.
   */
  public final TableField<JAttachmentRecord, Long> LAUNCH_ID = createField(DSL.name("launch_id"), SQLDataType.BIGINT,
      this, "");
   ...
   */
  public final TableField<JAttachmentRecord, Long> FILE_SIZE = createField(DSL.name("file_size"),
   ...
   */
  public final TableField<JAttachmentRecord, Instant> CREATION_DATE = createField(DSL.name("creation_date"),
      SQLDataType.LOCALDATETIME(6).nullable(false), this, "", new JooqInstantConverter());

  /**
   * The column <code>public.attachment.file_name</code>.
   */
  public final TableField<JAttachmentRecord, String> FILE_NAME = createField(DSL.name("file_name"),
  ...
  public <O extends Record> JAttachment(Table<O> path, ForeignKey<O, JAttachmentRecord> childPath,
      InverseForeignKey<O, JAttachmentRecord> parentPath) {
  ...
  public static class JAttachmentPath extends JAttachment implements Path<JAttachmentRecord> {
    ...
    public <O extends Record> JAttachmentPath(Table<O> path, ForeignKey<O, JAttachmentRecord> childPath,
        InverseForeignKey<O, JAttachmentRecord> parentPath) {
  ...
  public List<Index> getIndexes() {
    return Arrays.asList(Indexes.ATT_ITEM_IDX, Indexes.ATT_LAUNCH_IDX, Indexes.ATT_PROJECT_IDX,
        Indexes.ATTACHMENT_PROJECT_ID_CREATION_TIME_IDX);
  }
