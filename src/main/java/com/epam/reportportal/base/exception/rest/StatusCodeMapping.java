...
public class StatusCodeMapping {
  ...
  private static final Map<ErrorType, HttpStatus> MAPPING = new HashMap<>() {
...

    {
      ...
      // that cannot run here (400), the operator has something to configure or undo (409), the
      // registry itself is at fault (502/503).
      ...
      put(ErrorType.UPSA_USER_DENIED, HttpStatus.FORBIDDEN);
