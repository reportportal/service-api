...
package com.epam.reportportal.core.widget.content;
...
public interface BuildFilterStrategy {
   ...
   * @return Map of filters and sorts where the key is the {@link Filter} and the value is the corresponding
   * {@link Sort} for the given widget
   */
