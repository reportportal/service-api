...
LABEL version="3.3.0-BETA-8"
LABEL description="EPAM Report portal. Main API Service"

ENV APP_FILE service-api-3.3.0-BETA-8
ENV APP_DOWNLOAD_URL https://dl.bintray.com/epam/reportportal/com/epam/reportportal/service-api/3.3.0-BETA-8/$APP_FILE.jar
